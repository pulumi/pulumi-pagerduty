...
replace (
	github.com/PagerDuty/terraform-provider-pagerduty => github.com/pulumi/terraform-provider-pagerduty v1.9.6-0.20220829130032-4d0efd7df477
...
require (
	...
	github.com/heimweh/go-pagerduty v0.0.0-20220817230727-d04840835460 // indirect
