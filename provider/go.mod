...
require (
	...
	github.com/heimweh/go-pagerduty v0.0.0-20220527195341-4e587aa9b58e // indirect
...
replace (
	github.com/PagerDuty/terraform-provider-pagerduty => github.com/pulumi/terraform-provider-pagerduty v1.9.6-0.20220803124052-21191dec3311
