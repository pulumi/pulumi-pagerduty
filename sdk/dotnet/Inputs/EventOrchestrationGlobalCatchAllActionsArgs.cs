...
namespace Pulumi.Pagerduty.Inputs
{
    ...
    public sealed class EventOrchestrationGlobalCatchAllActionsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("extractions")]
        private InputList<Inputs.EventOrchestrationGlobalCatchAllActionsExtractionArgs>? _extractions;

        /// <summary>
        /// Replace any CEF field or Custom Details object field using custom variables.
        /// </summary>
        public InputList<Inputs.EventOrchestrationGlobalCatchAllActionsExtractionArgs> Extractions
        {
            get => _extractions ?? (_extractions = new InputList<Inputs.EventOrchestrationGlobalCatchAllActionsExtractionArgs>());
            set => _extractions = value;
        }

        [Input("incidentCustomFieldUpdates")]
        private InputList<Inputs.EventOrchestrationGlobalCatchAllActionsIncidentCustomFieldUpdateArgs>? _incidentCustomFieldUpdates;

        /// <summary>
        /// Assign a custom field to the resulting incident.
        /// </summary>
        public InputList<Inputs.EventOrchestrationGlobalCatchAllActionsIncidentCustomFieldUpdateArgs> IncidentCustomFieldUpdates
        {
            get => _incidentCustomFieldUpdates ?? (_incidentCustomFieldUpdates = new InputList<Inputs.EventOrchestrationGlobalCatchAllActionsIncidentCustomFieldUpdateArgs>());
        ...
        [Input("variables")]
        private InputList<Inputs.EventOrchestrationGlobalCatchAllActionsVariableArgs>? _variables;

        /// <summary>
        /// Populate variables from event payloads and use those variables in other event actions.
        /// </summary>
        public InputList<Inputs.EventOrchestrationGlobalCatchAllActionsVariableArgs> Variables
        {
            get => _variables ?? (_variables = new InputList<Inputs.EventOrchestrationGlobalCatchAllActionsVariableArgs>());
            set => _variables = value;
        }

        public EventOrchestrationGlobalCatchAllActionsArgs()
        {
        }
        public static new EventOrchestrationGlobalCatchAllActionsArgs Empty => new EventOrchestrationGlobalCatchAllActionsArgs();
    }
}
