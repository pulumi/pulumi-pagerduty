...
namespace Pulumi.Pagerduty.Inputs
{
    ...
    public sealed class EventOrchestrationGlobalSetRuleActionsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.EventOrchestrationGlobalSetRuleActionsAutomationActionGetArgs>? AutomationAction { get; set; }
        ...
        [Input("extractions")]
        private InputList<Inputs.EventOrchestrationGlobalSetRuleActionsExtractionGetArgs>? _extractions;

        /// <summary>
        /// Replace any CEF field or Custom Details object field using custom variables.
        /// </summary>
        public InputList<Inputs.EventOrchestrationGlobalSetRuleActionsExtractionGetArgs> Extractions
        {
            get => _extractions ?? (_extractions = new InputList<Inputs.EventOrchestrationGlobalSetRuleActionsExtractionGetArgs>());
        ...
        [Input("variables")]
        private InputList<Inputs.EventOrchestrationGlobalSetRuleActionsVariableGetArgs>? _variables;

        /// <summary>
        /// Populate variables from event payloads and use those variables in other event actions.
        /// </summary>
        public InputList<Inputs.EventOrchestrationGlobalSetRuleActionsVariableGetArgs> Variables
        {
            get => _variables ?? (_variables = new InputList<Inputs.EventOrchestrationGlobalSetRuleActionsVariableGetArgs>());
            set => _variables = value;
        }

        public EventOrchestrationGlobalSetRuleActionsGetArgs()
        {
        }
        public static new EventOrchestrationGlobalSetRuleActionsGetArgs Empty => new EventOrchestrationGlobalSetRuleActionsGetArgs();
    }
}
