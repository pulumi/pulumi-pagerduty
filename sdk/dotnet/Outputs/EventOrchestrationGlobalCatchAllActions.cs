...
namespace Pulumi.Pagerduty.Outputs
{
    ...
    [OutputType]
    public sealed class EventOrchestrationGlobalCatchAllActions
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.EventOrchestrationGlobalCatchAllActionsVariable> Variables;

        [OutputConstructor]
        private EventOrchestrationGlobalCatchAllActions(
            string? annotate,

            Outputs.EventOrchestrationGlobalCatchAllActionsAutomationAction? automationAction,
            ...
            ImmutableArray<Outputs.EventOrchestrationGlobalCatchAllActionsVariable> variables)
        {
            Annotate = annotate;
