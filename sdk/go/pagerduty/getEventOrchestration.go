...
type LookupEventOrchestrationArgs struct {
	...
	Integrations []GetEventOrchestrationIntegrationType `pulumi:"integrations"`
...
type LookupEventOrchestrationOutputArgs struct {
	// An integration for the Event Orchestration.
	Integrations GetEventOrchestrationIntegrationTypeArrayInput `pulumi:"integrations"`
	// The name of the Global Event orchestration to find in the PagerDuty API.
...
// An integration for the Event Orchestration.
func (o LookupEventOrchestrationResultOutput) Integrations() GetEventOrchestrationIntegrationTypeArrayOutput {
	return o.ApplyT(func(v LookupEventOrchestrationResult) []GetEventOrchestrationIntegrationType { return v.Integrations }).(GetEventOrchestrationIntegrationTypeArrayOutput)
}
