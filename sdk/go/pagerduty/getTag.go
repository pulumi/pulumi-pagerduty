...
//				return err
//			}
//			devops, err := pagerduty.GetTag(ctx, &pagerduty.LookupTagArgs{
//				Label: "devops",
//			}, nil)
//			if err != nil {
//				return err
...
//				TagId:      pulumi.String(pulumi.String(devops.Id)),
//				EntityId:   pulumi.String(pulumi.String(me.Id)),
...
func LookupTagOutput(ctx *pulumi.Context, args LookupTagOutputArgs, opts ...pulumi.InvokeOption) LookupTagResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTagResultOutput, error) {
			...
			return ctx.InvokeOutput("pagerduty:index/getTag:getTag", args, LookupTagResultOutput{}, options).(LookupTagResultOutput), nil
