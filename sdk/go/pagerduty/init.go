...
func init() {
	...
	pulumi.RegisterResourceModule(
		"pagerduty",
		"index/serviceCustomField",
		&module{version},
	)
	pulumi.RegisterResourceModule(
		"pagerduty",
		"index/serviceCustomFieldValue",
		&module{version},
	)
	pulumi.RegisterResourceModule(
		"pagerduty",
