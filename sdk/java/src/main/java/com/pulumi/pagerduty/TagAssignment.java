...
public class TagAssignment extends com.pulumi.resources.CustomResource {
     ...
     */
    public TagAssignment(java.lang.String name) {
     ...
     */
    public TagAssignment(java.lang.String name, TagAssignmentArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TagAssignment(java.lang.String name, TagAssignmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pagerduty:index/tagAssignment:TagAssignment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TagAssignment(java.lang.String name, Output<java.lang.String> id, @Nullable TagAssignmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pagerduty:index/tagAssignment:TagAssignment", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TagAssignment get(java.lang.String name, Output<java.lang.String> id, @Nullable TagAssignmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
