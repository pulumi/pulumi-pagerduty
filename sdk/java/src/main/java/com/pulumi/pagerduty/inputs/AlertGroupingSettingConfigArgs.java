...
public final class AlertGroupingSettingConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final AlertGroupingSettingConfigArgs Empty = new AlertGroupingSettingConfigArgs();
    ...
    private AlertGroupingSettingConfigArgs() {}
    ...
    public static Builder builder(AlertGroupingSettingConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlertGroupingSettingConfigArgs();
        }

        public Builder(AlertGroupingSettingConfigArgs defaults) {
            $ = new AlertGroupingSettingConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param timeout The duration in seconds within which to automatically group incoming alerts. This setting is only required and applies when `type` is set to `time`. To continue grouping alerts until the incident is resolved leave this value unset or set it to `null`.
         * 
         * @return builder
         * 
         */
        ...
        public AlertGroupingSettingConfigArgs build() {
            return $;
        }
    }
