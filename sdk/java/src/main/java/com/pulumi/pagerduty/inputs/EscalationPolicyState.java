...
public final class EscalationPolicyState extends com.pulumi.resources.ResourceArgs {

    public static final EscalationPolicyState Empty = new EscalationPolicyState();
     ...
     */
    @Import(name="rules")
    private @Nullable Output<List<EscalationPolicyRuleArgs>> rules;

    /**
     * @return An Escalation rule block. Escalation rules documented below.
     * 
     */
    public Optional<Output<List<EscalationPolicyRuleArgs>>> rules() {
    ...
    private EscalationPolicyState() {}

    private EscalationPolicyState(EscalationPolicyState $) {
    ...
    public static Builder builder(EscalationPolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EscalationPolicyState();
        }

        public Builder(EscalationPolicyState defaults) {
            $ = new EscalationPolicyState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder rules(@Nullable Output<List<EscalationPolicyRuleArgs>> rules) {
            $.rules = rules;
            return this;
        }
        ...
        public EscalationPolicyState build() {
