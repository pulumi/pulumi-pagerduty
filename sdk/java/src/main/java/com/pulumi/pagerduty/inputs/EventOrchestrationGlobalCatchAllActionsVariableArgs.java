...
public final class EventOrchestrationGlobalCatchAllActionsVariableArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public EventOrchestrationGlobalCatchAllActionsVariableArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationGlobalCatchAllActionsVariableArgs", "name");
            }
            if ($.path == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationGlobalCatchAllActionsVariableArgs", "path");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationGlobalCatchAllActionsVariableArgs", "type");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationGlobalCatchAllActionsVariableArgs", "value");
            }
            return $;
        }
    }
