...
public final class EventOrchestrationServiceCatchAllActionsExtractionArgs extends com.pulumi.resources.ResourceArgs {

    public static final EventOrchestrationServiceCatchAllActionsExtractionArgs Empty = new EventOrchestrationServiceCatchAllActionsExtractionArgs();
    ...
    private EventOrchestrationServiceCatchAllActionsExtractionArgs() {}

    private EventOrchestrationServiceCatchAllActionsExtractionArgs(EventOrchestrationServiceCatchAllActionsExtractionArgs $) {
        this.regex = $.regex;
        this.source = $.source;
        this.target = $.target;
    ...
    public static Builder builder(EventOrchestrationServiceCatchAllActionsExtractionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EventOrchestrationServiceCatchAllActionsExtractionArgs();
        }

        public Builder(EventOrchestrationServiceCatchAllActionsExtractionArgs defaults) {
            $ = new EventOrchestrationServiceCatchAllActionsExtractionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EventOrchestrationServiceCatchAllActionsExtractionArgs build() {
            if ($.target == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationServiceCatchAllActionsExtractionArgs", "target");
            }
            return $;
        }
    }
