...
public final class EventOrchestrationServiceSetRuleActionsVariableArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public EventOrchestrationServiceSetRuleActionsVariableArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationServiceSetRuleActionsVariableArgs", "name");
            }
            if ($.path == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationServiceSetRuleActionsVariableArgs", "path");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationServiceSetRuleActionsVariableArgs", "type");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationServiceSetRuleActionsVariableArgs", "value");
            }
            return $;
        }
    }
