...
public final class EventOrchestrationUnroutedSetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EventOrchestrationUnroutedSetArgs() {}

    private EventOrchestrationUnroutedSetArgs(EventOrchestrationUnroutedSetArgs $) {
        this.id = $.id;
        this.rules = $.rules;
    }
    ...
    public static Builder builder(EventOrchestrationUnroutedSetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EventOrchestrationUnroutedSetArgs();
        }

        public Builder(EventOrchestrationUnroutedSetArgs defaults) {
            $ = new EventOrchestrationUnroutedSetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EventOrchestrationUnroutedSetArgs build() {
            if ($.id == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationUnroutedSetArgs", "id");
            }
            return $;
        }
    }
