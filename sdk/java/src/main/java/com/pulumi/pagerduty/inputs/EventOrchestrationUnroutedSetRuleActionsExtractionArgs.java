...
public final class EventOrchestrationUnroutedSetRuleActionsExtractionArgs extends com.pulumi.resources.ResourceArgs {

    public static final EventOrchestrationUnroutedSetRuleActionsExtractionArgs Empty = new EventOrchestrationUnroutedSetRuleActionsExtractionArgs();
    ...
    private EventOrchestrationUnroutedSetRuleActionsExtractionArgs() {}

    private EventOrchestrationUnroutedSetRuleActionsExtractionArgs(EventOrchestrationUnroutedSetRuleActionsExtractionArgs $) {
        this.regex = $.regex;
        this.source = $.source;
        this.target = $.target;
    ...
    public static Builder builder(EventOrchestrationUnroutedSetRuleActionsExtractionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EventOrchestrationUnroutedSetRuleActionsExtractionArgs();
        }

        public Builder(EventOrchestrationUnroutedSetRuleActionsExtractionArgs defaults) {
            $ = new EventOrchestrationUnroutedSetRuleActionsExtractionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EventOrchestrationUnroutedSetRuleActionsExtractionArgs build() {
            if ($.target == null) {
                throw new MissingRequiredPropertyException("EventOrchestrationUnroutedSetRuleActionsExtractionArgs", "target");
            }
            return $;
        }
    }
