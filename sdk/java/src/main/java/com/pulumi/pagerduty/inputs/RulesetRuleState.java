...
public final class RulesetRuleState extends com.pulumi.resources.ResourceArgs {

    public static final RulesetRuleState Empty = new RulesetRuleState();
    ...
    private RulesetRuleState() {}

    private RulesetRuleState(RulesetRuleState $) {
    ...
    public static Builder builder(RulesetRuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RulesetRuleState();
        }

        public Builder(RulesetRuleState defaults) {
            $ = new RulesetRuleState(Objects.requireNonNull(defaults));
        }
