...
public final class EventOrchestrationGlobalSetRuleActionsAutomationActionParameter {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("EventOrchestrationGlobalSetRuleActionsAutomationActionParameter", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("EventOrchestrationGlobalSetRuleActionsAutomationActionParameter", "value");
            }
            this.value = value;
            return this;
        }
        public EventOrchestrationGlobalSetRuleActionsAutomationActionParameter build() {
            final var _resultValue = new EventOrchestrationGlobalSetRuleActionsAutomationActionParameter();
