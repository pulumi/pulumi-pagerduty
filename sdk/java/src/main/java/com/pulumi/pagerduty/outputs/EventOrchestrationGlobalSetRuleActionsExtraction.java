...
@CustomType
public final class EventOrchestrationGlobalSetRuleActionsExtraction {
    /**
    ...
    private EventOrchestrationGlobalSetRuleActionsExtraction() {}
    /**
     * @return A [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) that will be matched against field specified via the `source` argument. If the regex contains one or more capture groups, their values will be extracted and appended together. If it contains no capture groups, the whole match is used. This field can be ignored for `template` based extractions.
     * 
     */
    ...
    public static Builder builder(EventOrchestrationGlobalSetRuleActionsExtraction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String template;
        public Builder() {}
        public Builder(EventOrchestrationGlobalSetRuleActionsExtraction defaults) {
        ...
        public Builder target(String target) {
            if (target == null) {
              throw new MissingRequiredPropertyException("EventOrchestrationGlobalSetRuleActionsExtraction", "target");
            }
            this.target = target;
            return this;
        }
        ...
        public EventOrchestrationGlobalSetRuleActionsExtraction build() {
            final var _resultValue = new EventOrchestrationGlobalSetRuleActionsExtraction();
