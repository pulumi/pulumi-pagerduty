...
public final class EventOrchestrationServiceCatchAllActions {
     ...
     * 
     */
    private final @Nullable EventOrchestrationServiceCatchAllActionsAutomationAction automationAction;
    /**
     ...
     * 
     */
    private final @Nullable List<EventOrchestrationServiceCatchAllActionsExtraction> extractions;
    /**
     ...
     * 
     */
    private final @Nullable EventOrchestrationServiceCatchAllActionsPagerdutyAutomationAction pagerdutyAutomationAction;
     ...
     * 
     */
    private final @Nullable List<EventOrchestrationServiceCatchAllActionsVariable> variables;

    @CustomType.Constructor
    private EventOrchestrationServiceCatchAllActions(
        @CustomType.Parameter("annotate") @Nullable String annotate,
        @CustomType.Parameter("automationAction") @Nullable EventOrchestrationServiceCatchAllActionsAutomationAction automationAction,
        @CustomType.Parameter("eventAction") @Nullable String eventAction,
        @CustomType.Parameter("extractions") @Nullable List<EventOrchestrationServiceCatchAllActionsExtraction> extractions,
        @CustomType.Parameter("pagerdutyAutomationAction") @Nullable EventOrchestrationServiceCatchAllActionsPagerdutyAutomationAction pagerdutyAutomationAction,
        ...
        @CustomType.Parameter("variables") @Nullable List<EventOrchestrationServiceCatchAllActionsVariable> variables) {
    ...
    public static final class Builder {
        ...
        public Builder variables(EventOrchestrationServiceCatchAllActionsVariable... variables) {
            ...
            return new EventOrchestrationServiceCatchAllActions(annotate, automationAction, eventAction, extractions, pagerdutyAutomationAction, priority, routeTo, severity, suppress, suspend, variables);
        }
    }
}
