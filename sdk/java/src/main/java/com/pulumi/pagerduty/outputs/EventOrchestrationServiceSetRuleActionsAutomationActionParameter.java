...
@CustomType
public final class EventOrchestrationServiceSetRuleActionsAutomationActionParameter {
    /**
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("EventOrchestrationServiceSetRuleActionsAutomationActionParameter", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("EventOrchestrationServiceSetRuleActionsAutomationActionParameter", "value");
            }
            this.value = value;
            return this;
        }
