...
public final class EventOrchestrationServiceSetRuleActionsVariable {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("EventOrchestrationServiceSetRuleActionsVariable", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("EventOrchestrationServiceSetRuleActionsVariable", "path");
            }
            this.path = path;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("EventOrchestrationServiceSetRuleActionsVariable", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("EventOrchestrationServiceSetRuleActionsVariable", "value");
            }
            this.value = value;
            return this;
        }
