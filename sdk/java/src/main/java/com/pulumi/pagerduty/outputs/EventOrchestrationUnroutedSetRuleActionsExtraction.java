...
public final class EventOrchestrationUnroutedSetRuleActionsExtraction {
    ...
    public static final class Builder {
        ...
        public Builder target(String target) {
            if (target == null) {
              throw new MissingRequiredPropertyException("EventOrchestrationUnroutedSetRuleActionsExtraction", "target");
            }
            this.target = target;
            return this;
        }
        ...
        public EventOrchestrationUnroutedSetRuleActionsExtraction build() {
            final var _resultValue = new EventOrchestrationUnroutedSetRuleActionsExtraction();
