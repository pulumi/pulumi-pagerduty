...
public final class GetEventOrchestrationIntegrationResult {
    ...
    public static final class Builder {
        ...
        public Builder eventOrchestration(String eventOrchestration) {
            this.eventOrchestration = Objects.requireNonNull(eventOrchestration);
            return this;
        }
        @CustomType.Setter
        ...
        public GetEventOrchestrationIntegrationResult build() {
            final var o = new GetEventOrchestrationIntegrationResult();
            o.eventOrchestration = eventOrchestration;
            o.id = id;
            o.label = label;
