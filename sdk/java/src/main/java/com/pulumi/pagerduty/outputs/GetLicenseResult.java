    ...
    public static final class Builder {
        ...
        public Builder allocationsAvailable(Integer allocationsAvailable) {
            if (allocationsAvailable == null) {
              throw new MissingRequiredPropertyException("GetLicenseResult", "allocationsAvailable");
            }
        ...
        public Builder currentValue(Integer currentValue) {
            if (currentValue == null) {
              throw new MissingRequiredPropertyException("GetLicenseResult", "currentValue");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetLicenseResult", "description");
            }
        ...
        public Builder htmlUrl(String htmlUrl) {
            if (htmlUrl == null) {
              throw new MissingRequiredPropertyException("GetLicenseResult", "htmlUrl");
            }
        ...
        public Builder roleGroup(String roleGroup) {
            if (roleGroup == null) {
              throw new MissingRequiredPropertyException("GetLicenseResult", "roleGroup");
            }
        ...
        public Builder self(String self) {
            if (self == null) {
              throw new MissingRequiredPropertyException("GetLicenseResult", "self");
            }
            this.self = self;
            return this;
        }
        ...
        public Builder summary(String summary) {
            if (summary == null) {
              throw new MissingRequiredPropertyException("GetLicenseResult", "summary");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetLicenseResult", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder validRoles(List<String> validRoles) {
            if (validRoles == null) {
              throw new MissingRequiredPropertyException("GetLicenseResult", "validRoles");
            }
