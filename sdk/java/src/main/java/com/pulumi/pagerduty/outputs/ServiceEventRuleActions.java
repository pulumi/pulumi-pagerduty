...
public final class ServiceEventRuleActions {
     ...
     * 
     */
    private final @Nullable List<ServiceEventRuleActionsAnnotate> annotates;
    /**
     * @return An object with a single `value` field. The value sets whether the resulting alert status is `trigger` or `resolve`.
     * 
     */
    private final @Nullable List<ServiceEventRuleActionsEventAction> eventActions;
    /**
     ...
     * 
     */
    private final @Nullable List<ServiceEventRuleActionsExtraction> extractions;
    /**
     * @return The ID of the priority applied to the event.
     * 
     */
    private final @Nullable List<ServiceEventRuleActionsPriority> priorities;
    /**
     ...
     * 
     */
    private final @Nullable List<ServiceEventRuleActionsSeverity> severities;
    /**
     ...
     * 
     */
    private final @Nullable List<ServiceEventRuleActionsSuppress> suppresses;
    /**
     ...
     * 
     */
    private final @Nullable List<ServiceEventRuleActionsSuspend> suspends;

    @CustomType.Constructor
    private ServiceEventRuleActions(
        @CustomType.Parameter("annotates") @Nullable List<ServiceEventRuleActionsAnnotate> annotates,
        @CustomType.Parameter("eventActions") @Nullable List<ServiceEventRuleActionsEventAction> eventActions,
        @CustomType.Parameter("extractions") @Nullable List<ServiceEventRuleActionsExtraction> extractions,
        @CustomType.Parameter("priorities") @Nullable List<ServiceEventRuleActionsPriority> priorities,
        @CustomType.Parameter("severities") @Nullable List<ServiceEventRuleActionsSeverity> severities,
        @CustomType.Parameter("suppresses") @Nullable List<ServiceEventRuleActionsSuppress> suppresses,
        @CustomType.Parameter("suspends") @Nullable List<ServiceEventRuleActionsSuspend> suspends) {
    ...
    public static final class Builder {
        ...
        public Builder suspends(ServiceEventRuleActionsSuspend... suspends) {
            ...
            return new ServiceEventRuleActions(annotates, eventActions, extractions, priorities, severities, suppresses, suspends);
        }
    }
}
