...
if not MYPY:
    class AlertGroupingSettingConfigArgsDict(TypedDict):
        aggregate: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        time_window: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AlertGroupingSettingConfigArgs:
    def __init__(__self__, *,
                 aggregate: Optional[pulumi.Input[builtins.str]] = None,
                 fields: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 time_window: Optional[pulumi.Input[builtins.int]] = None,
                 timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] aggregate: One of `any` or `all`. This setting is only required and applies when `type` is set to `content_based` or `content_based_intelligent`. Group alerts based on one or all of `fields` value(s).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fields: Alerts will be grouped together if the content of these fields match. This setting is only required and applies when `type` is set to `content_based` or `content_based_intelligent`.
        :param pulumi.Input[builtins.int] time_window: The maximum amount of time allowed between Alerts. This setting applies only when `type` is set to `intelligent`, `content_based`, `content_based_intelligent`. Value must be between `300` and `3600` or exactly `86400` (86400 is supported only for `content_based` alert grouping). Any Alerts arriving greater than `time_window` seconds apart will not be grouped together. This is a rolling time window and is counted from the most recently grouped alert. The window is extended every time a new alert is added to the group, up to 24 hours. To use the recommended time window leave this value unset or set it to `null`.
        :param pulumi.Input[builtins.int] timeout: The duration in seconds within which to automatically group incoming alerts. This setting is only required and applies when `type` is set to `time`. To continue grouping alerts until the incident is resolved leave this value unset or set it to `null`.
        """
    ...
    @property
    @pulumi.getter
    def aggregate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        One of `any` or `all`. This setting is only required and applies when `type` is set to `content_based` or `content_based_intelligent`. Group alerts based on one or all of `fields` value(s).
        """
    ...
    @aggregate.setter
    def aggregate(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_window(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum amount of time allowed between Alerts. This setting applies only when `type` is set to `intelligent`, `content_based`, `content_based_intelligent`. Value must be between `300` and `3600` or exactly `86400` (86400 is supported only for `content_based` alert grouping). Any Alerts arriving greater than `time_window` seconds apart will not be grouped together. This is a rolling time window and is counted from the most recently grouped alert. The window is extended every time a new alert is added to the group, up to 24 hours. To use the recommended time window leave this value unset or set it to `null`.
        """
    ...
    @time_window.setter
    def time_window(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AutomationActionsActionActionDataReferenceArgsDict(TypedDict):
        invocation_command: NotRequired[pulumi.Input[builtins.str]]
        """
        The command to execute the script with.
        """
        process_automation_job_arguments: NotRequired[pulumi.Input[builtins.str]]
        """
        The arguments to pass to the Process Automation job execution.
        """
        process_automation_job_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The ID of the Process Automation job to execute.
        """
        process_automation_node_filter: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AutomationActionsActionActionDataReferenceArgs:
    def __init__(__self__, *,
                 invocation_command: Optional[pulumi.Input[builtins.str]] = None,
                 process_automation_job_arguments: Optional[pulumi.Input[builtins.str]] = None,
                 process_automation_job_id: Optional[pulumi.Input[builtins.str]] = None,
                 process_automation_node_filter: Optional[pulumi.Input[builtins.str]] = None,
                 script: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] invocation_command: The command to execute the script with.
        :param pulumi.Input[builtins.str] process_automation_job_arguments: The arguments to pass to the Process Automation job execution.
        :param pulumi.Input[builtins.str] process_automation_job_id: The ID of the Process Automation job to execute.
        :param pulumi.Input[builtins.str] process_automation_node_filter: The expression that filters on which nodes a Process Automation Job executes [Learn more](https://docs.rundeck.com/docs/manual/05-nodes.html#node-filtering).
        :param pulumi.Input[builtins.str] script: Body of the script to be executed on the Runner. Max length is 16777215 characters.
        """
    ...
    def invocation_command(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The command to execute the script with.
        """
    ...
    def invocation_command(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "invocation_command", value)

    @property
    @pulumi.getter(name="processAutomationJobArguments")
    def process_automation_job_arguments(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The arguments to pass to the Process Automation job execution.
        """
    ...
    def process_automation_job_arguments(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "process_automation_job_arguments", value)

    @property
    @pulumi.getter(name="processAutomationJobId")
    def process_automation_job_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Process Automation job to execute.
        """
    ...
    def process_automation_job_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "process_automation_job_id", value)

    @property
    @pulumi.getter(name="processAutomationNodeFilter")
    def process_automation_node_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The expression that filters on which nodes a Process Automation Job executes [Learn more](https://docs.rundeck.com/docs/manual/05-nodes.html#node-filtering).
        """
    ...
    def process_automation_node_filter(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EscalationPolicyRuleArgsDict(TypedDict):
        escalation_delay_in_minutes: pulumi.Input[builtins.int]
        """
...
class EscalationPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] escalation_delay_in_minutes: The number of minutes before an unacknowledged incident escalates away from this rule.
        ...
        :param pulumi.Input[builtins.str] id: The ID of the escalation policy.
        """
    ...
    def escalation_delay_in_minutes(self) -> pulumi.Input[builtins.int]:
        """
        The number of minutes before an unacknowledged incident escalates away from this rule.
        """
    ...
    def escalation_delay_in_minutes(self, value: pulumi.Input[builtins.int]):
...
class EscalationPolicyRuleEscalationRuleAssignmentStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Can be `round_robin` or `assign_to_everyone`.
        """
        if type is not None:
...
class EscalationPolicyRuleTargetArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] id: A target ID
        :param pulumi.Input[builtins.str] type: Can be `user_reference` or `schedule_reference`. Defaults to `user_reference`. For multiple users as example, repeat the target.
        """
        pulumi.set(__self__, "id", id)
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class EventOrchestrationGlobalCacheVariableConditionArgs:
    def __init__(__self__, *,
                 expression: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] expression: A [PCL condition](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview) string.
        """
...
if not MYPY:
    class EventOrchestrationGlobalCacheVariableConfigurationArgsDict(TypedDict):
        ...
        """
        ttl_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class EventOrchestrationGlobalCacheVariableConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 ttl_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] type: The [type of value](https://support.pagerduty.com/docs/event-orchestration-variables) to store into the Cache Variable. Can be one of: `recent_value`, `trigger_event_count` or `external_data`.
        :param pulumi.Input[builtins.str] data_type: The type of data that will eventually be set for the Cache Variable via an API request. This field is only used when type is `external_data`
        :param pulumi.Input[builtins.str] regex: A [RE2 regular expression][4] that will be matched against the field specified via the `source` argument. This field is only used when `type` is `recent_value`
        :param pulumi.Input[builtins.str] source: The path to the event field where the `regex` will be applied to extract a value. You can use any valid [PCL path](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview#paths). This field is only used when `type` is `recent_value`
        :param pulumi.Input[builtins.int] ttl_seconds: The number of seconds indicating how long to count incoming trigger events for. This field is only used when `type` is `trigger_event_count` or `external_data`
        """
        pulumi.set(__self__, "type", type)
    ...
    def ttl_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of seconds indicating how long to count incoming trigger events for. This field is only used when `type` is `trigger_event_count` or `external_data`
        """
    ...
    @ttl_seconds.setter
    def ttl_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class EventOrchestrationGlobalCatchAllActionsArgsDict(TypedDict):
        annotate: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        drop_event: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        escalation_policy: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        event_action: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        route_to: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        suppress: NotRequired[pulumi.Input[builtins.bool]]
        """
        Set whether the resulting alert is suppressed. Suppressed alerts will not trigger an incident.
        """
        suspend: NotRequired[pulumi.Input[builtins.int]]
        """
...
class EventOrchestrationGlobalCatchAllActionsArgs:
    def __init__(__self__, *,
                 annotate: Optional[pulumi.Input[builtins.str]] = None,
                 automation_action: Optional[pulumi.Input['EventOrchestrationGlobalCatchAllActionsAutomationActionArgs']] = None,
                 drop_event: Optional[pulumi.Input[builtins.bool]] = None,
                 escalation_policy: Optional[pulumi.Input[builtins.str]] = None,
                 event_action: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 route_to: Optional[pulumi.Input[builtins.str]] = None,
                 severity: Optional[pulumi.Input[builtins.str]] = None,
                 suppress: Optional[pulumi.Input[builtins.bool]] = None,
                 suspend: Optional[pulumi.Input[builtins.int]] = None,
                 variables: Optional[pulumi.Input[Sequence[pulumi.Input['EventOrchestrationGlobalCatchAllActionsVariableArgs']]]] = None):
        """
        :param pulumi.Input[builtins.str] annotate: Add this text as a note on the resulting incident.
        ...
        :param pulumi.Input[builtins.bool] drop_event: When true, this event will be dropped. Dropped events will not trigger or resolve an alert or an incident. Dropped events will not be evaluated against router rules.
        :param pulumi.Input[builtins.str] escalation_policy: The ID of the Escalation Policy you want to assign incidents to. Event rules with this action will override the Escalation Policy already set on a Service's settings, with what is configured by this action.
        :param pulumi.Input[builtins.str] event_action: sets whether the resulting alert status is trigger or resolve. Allowed values are: `trigger`, `resolve`
        ...
        :param pulumi.Input[builtins.str] priority: The ID of the priority you want to set on resulting incident. Consider using the `get_priority` data source.
        :param pulumi.Input[builtins.str] route_to: The ID of a Set from this Global Orchestration whose rules you also want to use with events that match this rule.
        :param pulumi.Input[builtins.str] severity: sets Severity of the resulting alert. Allowed values are: `info`, `error`, `warning`, `critical`
        :param pulumi.Input[builtins.bool] suppress: Set whether the resulting alert is suppressed. Suppressed alerts will not trigger an incident.
        :param pulumi.Input[builtins.int] suspend: The number of seconds to suspend the resulting alert before triggering. This effectively pauses incident notifications. If a `resolve` event arrives before the alert triggers then PagerDuty won't create an incident for this alert.
    ...
    @property
    @pulumi.getter
    def annotate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Add this text as a note on the resulting incident.
        """
    ...
    @annotate.setter
    def annotate(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def drop_event(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When true, this event will be dropped. Dropped events will not trigger or resolve an alert or an incident. Dropped events will not be evaluated against router rules.
        """
    ...
    @drop_event.setter
    def drop_event(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "drop_event", value)

    @property
    @pulumi.getter(name="escalationPolicy")
    def escalation_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Escalation Policy you want to assign incidents to. Event rules with this action will override the Escalation Policy already set on a Service's settings, with what is configured by this action.
        """
    ...
    def escalation_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "escalation_policy", value)

    @property
    @pulumi.getter(name="eventAction")
    def event_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        sets whether the resulting alert status is trigger or resolve. Allowed values are: `trigger`, `resolve`
        """
    ...
    @event_action.setter
    def event_action(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def route_to(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of a Set from this Global Orchestration whose rules you also want to use with events that match this rule.
        """
    ...
    @route_to.setter
    def route_to(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def suppress(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Set whether the resulting alert is suppressed. Suppressed alerts will not trigger an incident.
        """
    ...
    @suppress.setter
    def suppress(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "suppress", value)

    @property
    @pulumi.getter
    def suspend(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of seconds to suspend the resulting alert before triggering. This effectively pauses incident notifications. If a `resolve` event arrives before the alert triggers then PagerDuty won't create an incident for this alert.
        """
    ...
    @suspend.setter
    def suspend(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class EventOrchestrationGlobalCatchAllActionsAutomationActionArgsDict(TypedDict):
        ...
        """
        auto_send: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        trigger_types: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EventOrchestrationGlobalCatchAllActionsAutomationActionArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 url: pulumi.Input[builtins.str],
                 auto_send: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 trigger_types: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: Name of this Webhook.
        :param pulumi.Input[builtins.str] url: The API endpoint where PagerDuty's servers will send the webhook request.
        :param pulumi.Input[builtins.bool] auto_send: When true, PagerDuty's servers will automatically send this webhook request as soon as the resulting incident or alert is created. When false, your incident responder will be able to manually trigger the Webhook via the PagerDuty website and mobile app.
        ...
        :param pulumi.Input[builtins.str] trigger_types: The Webhook will be associated (or automatically triggered, if `auto_send` is `true`) with the incident or alert, whenever an alert reaches the specified state. Allowed values are: `["alert_triggered"]`, `["alert_suspended"]`, `["alert_suppressed"]`. NOTE: `auto_send` must be `true` for trigger types of `["alert_suspended"]` and `["alert_suppressed"]`
        """
    ...
    def auto_send(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When true, PagerDuty's servers will automatically send this webhook request as soon as the resulting incident or alert is created. When false, your incident responder will be able to manually trigger the Webhook via the PagerDuty website and mobile app.
        """
    ...
    @auto_send.setter
    def auto_send(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def trigger_types(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Webhook will be associated (or automatically triggered, if `auto_send` is `true`) with the incident or alert, whenever an alert reaches the specified state. Allowed values are: `["alert_triggered"]`, `["alert_suspended"]`, `["alert_suppressed"]`. NOTE: `auto_send` must be `true` for trigger types of `["alert_suspended"]` and `["alert_suppressed"]`
        """
    ...
    def trigger_types(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EventOrchestrationGlobalCatchAllActionsAutomationActionHeaderArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Name to identify the header
        :param pulumi.Input[builtins.str] value: Value of this header
        """
...
class EventOrchestrationGlobalCatchAllActionsAutomationActionParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Name to identify the parameter
        :param pulumi.Input[builtins.str] value: Value of this parameter
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class EventOrchestrationGlobalCatchAllActionsExtractionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] target: The PagerDuty Common Event Format [PD-CEF](https://support.pagerduty.com/docs/pd-cef) field that will be set with the value from the `template` or based on `regex` and `source` fields.
        :param pulumi.Input[builtins.str] regex: A [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) that will be matched against field specified via the `source` argument. If the regex contains one or more capture groups, their values will be extracted and appended together. If it contains no capture groups, the whole match is used. This field can be ignored for `template` based extractions.
        :param pulumi.Input[builtins.str] source: The path to the event field where the `regex` will be applied to extract a value. You can use any valid [PCL path](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview#paths) like `event.summary` and you can reference previously-defined variables using a path like `variables.hostname`. This field can be ignored for `template` based extractions.
        :param pulumi.Input[builtins.str] template: A string that will be used to populate the `target` field. You can reference variables or event data within your template using double curly braces. For example:
               * Use variables named `ip` and `subnet` with a template like: `{{variables.ip}}/{{variables.subnet}}`
               * Combine the event severity & summary with template like: `{{event.severity}}:{{event.summary}}`
        """
...
class EventOrchestrationGlobalCatchAllActionsIncidentCustomFieldUpdateArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: The custom field id
        :param pulumi.Input[builtins.str] value: The value to assign to this custom field
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "value", value)
...
class EventOrchestrationGlobalCatchAllActionsVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] path: Path to a field in an event, in dot-notation. This supports both PagerDuty Common Event Format [PD-CEF](https://support.pagerduty.com/docs/pd-cef) and non-CEF fields. Eg: Use `event.summary` for the `summary` CEF field. Use `raw_event.fieldname` to read from the original event `fieldname` data. You can use any valid [PCL path](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview#paths).
        :param pulumi.Input[builtins.str] type: Only `regex` is supported
        :param pulumi.Input[builtins.str] value: The Regex expression to match against. Must use valid [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) syntax.
        """
        pulumi.set(__self__, "name", name)
...
class EventOrchestrationGlobalSetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The ID of this set of rules. Rules in other sets can route events into this set using the rule's `route_to` property.
        """
        pulumi.set(__self__, "id", id)
...
class EventOrchestrationGlobalSetRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] disabled: Indicates whether the rule is disabled and would therefore not be evaluated.
        :param pulumi.Input[builtins.str] id: The ID of the rule within the set.
        :param pulumi.Input[builtins.str] label: A description of this rule's purpose.
        """
        pulumi.set(__self__, "actions", actions)
...
class EventOrchestrationIntegrationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: ID of the integration
...
class EventOrchestrationIntegrationParameterArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] routing_key: Routing key that routes to this Orchestration.
        :param pulumi.Input[builtins.str] type: Type of the routing key. `global` is the default type.
        """
...
if not MYPY:
    class EventOrchestrationRouterCatchAllActionsArgsDict(TypedDict):
        route_to: pulumi.Input[builtins.str]
        """
...
class EventOrchestrationRouterCatchAllActionsArgs:
    def __init__(__self__, *,
                 route_to: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] route_to: Defines where an alert will be sent if doesn't match any rules. Can either be the ID of a Service _or_ the string `"unrouted"` to send events to the Unrouted Orchestration.
        """
        pulumi.set(__self__, "route_to", route_to)

    @property
    @pulumi.getter(name="routeTo")
    def route_to(self) -> pulumi.Input[builtins.str]:
        """
        Defines where an alert will be sent if doesn't match any rules. Can either be the ID of a Service _or_ the string `"unrouted"` to send events to the Unrouted Orchestration.
        """
        return pulumi.get(self, "route_to")
    ...
    @route_to.setter
    def route_to(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "route_to", value)
...
class EventOrchestrationRouterSetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: ID of the `start` set. Router supports only one set and it's id has to be `start`
        """
        pulumi.set(__self__, "id", id)
        if rules is not None:
            pulumi.set(__self__, "rules", rules)
...
class EventOrchestrationRouterSetRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] disabled: Indicates whether the rule is disabled and would therefore not be evaluated.
        :param pulumi.Input[builtins.str] id: The ID of the rule within the `start` set.
        :param pulumi.Input[builtins.str] label: A description of this rule's purpose.
        """
        pulumi.set(__self__, "actions", actions)
        if conditions is not None:
...
if not MYPY:
    class EventOrchestrationRouterSetRuleActionsDynamicRouteToArgsDict(TypedDict):
        lookup_by: pulumi.Input[builtins.str]
        """
...
class EventOrchestrationRouterSetRuleActionsDynamicRouteToArgs:
    def __init__(__self__, *,
                 ...
                 source: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] lookup_by: Indicates whether the extracted value from the source is a service's name or ID. Allowed values are: `service_name`, `service_id`
               
               If an event has a value at the specified `source`, and if the `regex` successfully matches the value, and if the matching portion is valid Service ID or Name, then the event will be routed to that service. Otherwise the event will be checked against any subsequent router rules.
        :param pulumi.Input[builtins.str] regex: The regular expression, used to extract a value from the source field. Must use valid [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) syntax.
        :param pulumi.Input[builtins.str] source: The path to a field in an event.
        """
    ...
    def lookup_by(self) -> pulumi.Input[builtins.str]:
        """
        Indicates whether the extracted value from the source is a service's name or ID. Allowed values are: `service_name`, `service_id`
    ...
    @lookup_by.setter
    def lookup_by(self, value: pulumi.Input[builtins.str]):
...
class EventOrchestrationServiceCatchAllActionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['EventOrchestrationServiceCatchAllActionsPagerdutyAutomationActionArgs'] pagerduty_automation_action: Configure a [Process Automation](https://support.pagerduty.com/docs/event-orchestration#process-automation) to be run for certain alert states.
        :param pulumi.Input[builtins.str] priority: The ID of the priority you want to set on resulting incident. Consider using the `get_priority` data source.
        :param pulumi.Input[builtins.str] route_to: The ID of a Set from this Service Orchestration whose rules you also want to use with events that match this rule.
        :param pulumi.Input[builtins.str] severity: sets Severity of the resulting alert. Allowed values are: `info`, `error`, `warning`, `critical`
        :param pulumi.Input[builtins.bool] suppress: Set whether the resulting alert is suppressed. Suppressed alerts will not trigger an incident.
        :param pulumi.Input[builtins.int] suspend: The number of seconds to suspend the resulting alert before triggering. This effectively pauses incident notifications. If a `resolve` event arrives before the alert triggers then PagerDuty won't create an incident for this alert.
...
class EventOrchestrationServiceCatchAllActionsPagerdutyAutomationActionArgs:
    def __init__(__self__, *,
                 ...
                 trigger_types: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] action_id: Id of the Process Automation action to be triggered.
        :param pulumi.Input[builtins.str] trigger_types: The Automation Action will be triggered whenever an alert reaches the specified state. Allowed values are: `["alert_triggered"]`, `["alert_suspended"]`, `["alert_suppressed"]`
        """
...
class EventOrchestrationServiceSetRuleActionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['EventOrchestrationServiceSetRuleActionsPagerdutyAutomationActionArgs'] pagerduty_automation_action: Configure a [Process Automation](https://support.pagerduty.com/docs/event-orchestration#process-automation) to be run for certain alert states.
        :param pulumi.Input[builtins.str] priority: The ID of the priority you want to set on resulting incident. Consider using the `get_priority` data source.
        :param pulumi.Input[builtins.str] route_to: The ID of a Set from this Service Orchestration whose rules you also want to use with events that match this rule.
        :param pulumi.Input[builtins.str] severity: sets Severity of the resulting alert. Allowed values are: `info`, `error`, `warning`, `critical`
        :param pulumi.Input[builtins.bool] suppress: Set whether the resulting alert is suppressed. Suppressed alerts will not trigger an incident.
...
class EventOrchestrationUnroutedCatchAllActionsVariableArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the variable
        :param pulumi.Input[builtins.str] path: Path to a field in an event, in dot-notation. This supports both [PD-CEF](https://support.pagerduty.com/docs/pd-cef) and non-CEF fields. Eg: Use `event.summary` for the `summary` CEF field. Use `raw_event.fieldname` to read from the original event `fieldname` data.
        :param pulumi.Input[builtins.str] type: Only `regex` is supported
        :param pulumi.Input[builtins.str] value: The Regex expression to match against. Must use valid [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) syntax.
        """
        pulumi.set(__self__, "name", name)
...
class EventOrchestrationUnroutedSetRuleActionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] route_to: The ID of a Set from this Unrouted Orchestration whose rules you also want to use with events that match this rule.
        :param pulumi.Input[builtins.str] severity: sets Severity of the resulting alert. Allowed values are: `info`, `error`, `warning`, `critical`
...
class IncidentWorkflowStepArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: The action id for the workflow step, including the version. A list of actions available can be retrieved using the [PagerDuty API](https://developer.pagerduty.com/api-reference/aa192a25fac39-list-actions).
        :param pulumi.Input[builtins.str] name: The name of the workflow step.
        :param pulumi.Input[builtins.str] id: The ID of the incident workflow.
...
class IncidentWorkflowStepInlineStepsInputArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the input.
...
if not MYPY:
    class IncidentWorkflowStepInlineStepsInputStepInputArgsDict(TypedDict):
        ...
        """
        generated: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class IncidentWorkflowStepInlineStepsInputStepInputArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the input.
        :param pulumi.Input[builtins.str] value: The value of the input.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class IncidentWorkflowTriggerPermissionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] restricted: If `true`, indicates that the Trigger can only be started by authorized Users. If `false` (default), any user can start this Trigger. Applicable only to `manual`-type triggers.
        :param pulumi.Input[builtins.str] team_id: The ID of the Team whose members can manually start this Trigger. Required and allowed only if `restricted` is `true`.
        """
...
class JiraCloudAccountMappingRuleConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] service: [Updating can cause a resource replacement] The ID of the linked PagerDuty service.
...
if not MYPY:
    class JiraCloudAccountMappingRuleConfigJiraArgsDict(TypedDict):
        autocreate_jql: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        create_issue_on_incident_trigger: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        sync_notes_user: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JiraCloudAccountMappingRuleConfigJiraArgs:
    def __init__(__self__, *,
                 autocreate_jql: Optional[pulumi.Input[builtins.str]] = None,
                 create_issue_on_incident_trigger: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 sync_notes_user: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] autocreate_jql: JQL query to automatically create PagerDuty incidents when matching Jira issues are created. Leave empty to disable this feature.
        :param pulumi.Input[builtins.bool] create_issue_on_incident_trigger: When enabled, automatically creates a Jira issue whenever a PagerDuty incident is triggered.
        ...
        :param pulumi.Input[builtins.str] sync_notes_user: ID of the PagerDuty user for syncing notes and comments between Jira issues and PagerDuty incidents. If not provided, note synchronization is disabled.
        """
    ...
    def autocreate_jql(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        JQL query to automatically create PagerDuty incidents when matching Jira issues are created. Leave empty to disable this feature.
        """
    ...
    def autocreate_jql(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "autocreate_jql", value)

    @property
    @pulumi.getter(name="createIssueOnIncidentTrigger")
    def create_issue_on_incident_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled, automatically creates a Jira issue whenever a PagerDuty incident is triggered.
        """
    ...
    def create_issue_on_incident_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def sync_notes_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the PagerDuty user for syncing notes and comments between Jira issues and PagerDuty incidents. If not provided, note synchronization is disabled.
        """
...
if not MYPY:
    class JiraCloudAccountMappingRuleConfigJiraCustomFieldArgsDict(TypedDict):
        ...
        """
        source_incident_field: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JiraCloudAccountMappingRuleConfigJiraCustomFieldArgs:
    def __init__(__self__, *,
                 ...
                 target_issue_field_name: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 source_incident_field: Optional[pulumi.Input[builtins.str]] = None,
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] target_issue_field: The unique identifier key of the Jira field that will be set.
        :param pulumi.Input[builtins.str] target_issue_field_name: The human-readable name of the Jira field.
        :param pulumi.Input[builtins.str] type: The type of the value that will be set; one of `attribute`, `const` or `jira_value`.
        :param pulumi.Input[builtins.str] source_incident_field: The PagerDuty incident field from which the value will be extracted (only applicable if `type` is `attribute`); one of `incident_number`, `incident_title`, `incident_description`, `incident_status`, `incident_created_at`, `incident_service`, `incident_escalation_policy`, `incident_impacted_services`, `incident_html_url`, `incident_assignees`, `incident_acknowledgers`, `incident_last_status_change_at`, `incident_last_status_change_by`, `incident_urgency` or `incident_priority`.
        :param pulumi.Input[builtins.str] value: The value to be set for the Jira field (only applicable if `type` is `const` or `jira_value`). It must be set as a JSON string.
        """
    ...
    def target_issue_field(self) -> pulumi.Input[builtins.str]:
        """
        The unique identifier key of the Jira field that will be set.
        """
    ...
    def target_issue_field(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_issue_field", value)

    @property
    @pulumi.getter(name="targetIssueFieldName")
    def target_issue_field_name(self) -> pulumi.Input[builtins.str]:
        """
        The human-readable name of the Jira field.
        """
    ...
    def target_issue_field_name(self, value: pulumi.Input[builtins.str]):
    ...
    def source_incident_field(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The PagerDuty incident field from which the value will be extracted (only applicable if `type` is `attribute`); one of `incident_number`, `incident_title`, `incident_description`, `incident_status`, `incident_created_at`, `incident_service`, `incident_escalation_policy`, `incident_impacted_services`, `incident_html_url`, `incident_assignees`, `incident_acknowledgers`, `incident_last_status_change_at`, `incident_last_status_change_by`, `incident_urgency` or `incident_priority`.
        """
    ...
    def source_incident_field(self, value: Optional[pulumi.Input[builtins.str]]):
...
class JiraCloudAccountMappingRuleConfigJiraIssueTypeArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: Unique identifier for the Jira issue type.
        :param pulumi.Input[builtins.str] name: The name of the Jira issue type.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class JiraCloudAccountMappingRuleConfigJiraPriorityArgsDict(TypedDict):
        jira_id: pulumi.Input[builtins.str]
        """
        The ID of the Jira priority.
        """
        pagerduty_id: pulumi.Input[builtins.str]
        """
...
class JiraCloudAccountMappingRuleConfigJiraPriorityArgs:
    def __init__(__self__, *,
                 ...
                 pagerduty_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] jira_id: The ID of the Jira priority.
        :param pulumi.Input[builtins.str] pagerduty_id: The ID of the PagerDuty priority.
        """
    ...
    def jira_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the Jira priority.
        """
    ...
    @jira_id.setter
    def jira_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "jira_id", value)

    @property
    @pulumi.getter(name="pagerdutyId")
    def pagerduty_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the PagerDuty priority.
        """
    ...
    @pagerduty_id.setter
    def pagerduty_id(self, value: pulumi.Input[builtins.str]):
...
class JiraCloudAccountMappingRuleConfigJiraProjectArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: Unique identifier for the Jira project.
        :param pulumi.Input[builtins.str] key: The short key name of the Jira project.
        :param pulumi.Input[builtins.str] name: The name of the Jira project.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "name", name)
...
class JiraCloudAccountMappingRuleConfigJiraStatusMappingAcknowledgedArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: Unique identifier for the Jira status.
        :param pulumi.Input[builtins.str] name: Name of the Jira status.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if name is not None:
...
if not MYPY:
    class ProviderUseAppOauthScopedTokenArgsDict(TypedDict):
        pd_client_id: NotRequired[pulumi.Input[builtins.str]]
        pd_client_secret: NotRequired[pulumi.Input[builtins.str]]
        pd_subdomain: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class ProviderUseAppOauthScopedTokenArgs:
    def __init__(__self__, *,
                 pd_client_id: Optional[pulumi.Input[builtins.str]] = None,
                 pd_client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 pd_subdomain: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def pd_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "pd_client_id")

    @pd_client_id.setter
    def pd_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pd_client_id", value)

    @property
    @pulumi.getter(name="pdClientSecret")
    def pd_client_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "pd_client_secret")

    @pd_client_secret.setter
    def pd_client_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pd_client_secret", value)

    @property
    @pulumi.getter(name="pdSubdomain")
    def pd_subdomain(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "pd_subdomain")

    @pd_subdomain.setter
    def pd_subdomain(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ResponsePlayResponderArgsDict(TypedDict):
        ...
        """
        num_loops: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of times the escalation policy will repeat after reaching the end of its escalation.
        """
        on_call_handoff_notifications: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ResponsePlayResponderArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 num_loops: Optional[pulumi.Input[builtins.int]] = None,
                 on_call_handoff_notifications: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] description: Description of escalation policy
        :param pulumi.Input[Sequence[pulumi.Input['ResponsePlayResponderEscalationRuleArgs']]] escalation_rules: The escalation rules
        :param pulumi.Input[builtins.str] id: ID of the user defined as the responder
        :param pulumi.Input[builtins.str] name: Name of the escalation policy
        :param pulumi.Input[builtins.int] num_loops: The number of times the escalation policy will repeat after reaching the end of its escalation.
        :param pulumi.Input[builtins.str] on_call_handoff_notifications: Determines how on call handoff notifications will be sent for users on the escalation policy. Defaults to "if_has_services". Could be "if_has_services", "always
        ...
        :param pulumi.Input[builtins.str] type: Should be set as `escalation_policy` for escalation policy responders.
        """
    ...
    def num_loops(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of times the escalation policy will repeat after reaching the end of its escalation.
        """
    ...
    @num_loops.setter
    def num_loops(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "num_loops", value)

    @property
    @pulumi.getter(name="onCallHandoffNotifications")
    def on_call_handoff_notifications(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines how on call handoff notifications will be sent for users on the escalation policy. Defaults to "if_has_services". Could be "if_has_services", "always
        """
    ...
    def on_call_handoff_notifications(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ResponsePlayResponderEscalationRuleArgsDict(TypedDict):
        ...
        """
        escalation_delay_in_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of minutes before an unacknowledged incident escalates away from this rule.
        """
        id: NotRequired[pulumi.Input[builtins.str]]
...
class ResponsePlayResponderEscalationRuleArgs:
    def __init__(__self__, *,
                 ...
                 escalation_delay_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] escalation_delay_in_minutes: The number of minutes before an unacknowledged incident escalates away from this rule.
        :param pulumi.Input[builtins.str] id: The ID of the response play.
        """
        pulumi.set(__self__, "targets", targets)
    ...
    @property
    @pulumi.getter(name="escalationDelayInMinutes")
    def escalation_delay_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of minutes before an unacknowledged incident escalates away from this rule.
        """
        return pulumi.get(self, "escalation_delay_in_minutes")
    ...
    @escalation_delay_in_minutes.setter
    def escalation_delay_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "escalation_delay_in_minutes", value)
...
class ResponsePlayResponderEscalationRuleTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The ID of the response play.
        :param pulumi.Input[builtins.str] type: Type of object of the target. Supported types are `user_reference`, `schedule_reference`.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if type is not None:
...
class ResponsePlayResponderServiceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The ID of the response play.
        :param pulumi.Input[builtins.str] type: A string that determines the schema of the object. If not set, the default value is "response_play".
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if type is not None:
...
class RulesetRuleActionsAnnotateArgs:
    def __init__(__self__, *,
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] value: Boolean value that indicates if the alert should be suppressed before the indicated threshold values are met.
        """
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class RulesetRuleActionsExtractionArgs:
    def __init__(__self__, *,
                 ...
                 template: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] regex: The conditions that need to be met for the extraction to happen. Must use valid [RE2 regular expression syntax](https://github.com/google/re2/wiki/Syntax).
               
               *- **OR** -*
        :param pulumi.Input[builtins.str] source: Field where the data is being copied from. Must be a [PagerDuty Common Event Format (PD-CEF)](https://support.pagerduty.com/docs/pd-cef) field.
        :param pulumi.Input[builtins.str] target: Field where the data is being copied to. Must be a [PagerDuty Common Event Format (PD-CEF)](https://support.pagerduty.com/docs/pd-cef) field.
               
               *NOTE: A rule can have multiple `extraction` objects attributed to it.*
        :param pulumi.Input[builtins.str] template: A customized field message. This can also include variables extracted from the payload by using string interpolation.
        """
        if regex is not None:
            pulumi.set(__self__, "regex", regex)
        if source is not None:
...
if not MYPY:
    class RulesetRuleActionsSuppressArgsDict(TypedDict):
        threshold_time_amount: NotRequired[pulumi.Input[builtins.int]]
        """
        The number value of the `threshold_time_unit` before an incident is created. Must be greater than 0.
        """
        threshold_time_unit: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RulesetRuleActionsSuppressArgs:
    def __init__(__self__, *,
                 threshold_time_amount: Optional[pulumi.Input[builtins.int]] = None,
                 threshold_time_unit: Optional[pulumi.Input[builtins.str]] = None,
                 threshold_value: Optional[pulumi.Input[builtins.int]] = None,
                 value: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.int] threshold_time_amount: The number value of the `threshold_time_unit` before an incident is created. Must be greater than 0.
        :param pulumi.Input[builtins.str] threshold_time_unit: The `seconds`,`minutes`, or `hours` the `threshold_time_amount` should be measured.
        :param pulumi.Input[builtins.int] threshold_value: The number of alerts that should be suppressed. Must be greater than 0.
        :param pulumi.Input[builtins.bool] value: Boolean value that indicates if the alert should be suppressed before the indicated threshold values are met.
        """
    ...
    def threshold_time_amount(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number value of the `threshold_time_unit` before an incident is created. Must be greater than 0.
        """
    ...
    def threshold_time_amount(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "threshold_time_amount", value)

    @property
    @pulumi.getter(name="thresholdTimeUnit")
    def threshold_time_unit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The `seconds`,`minutes`, or `hours` the `threshold_time_amount` should be measured.
        """
    ...
    def threshold_time_unit(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RulesetRuleActionsSuspendArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] value: Boolean value that indicates if the alert should be suppressed before the indicated threshold values are met.
        """
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class RulesetRuleConditionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: Operator to combine sub-conditions. Can be `and` or `or`.
...
class RulesetRuleConditionsSubconditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: Type of operator to apply to the sub-condition. Can be `exists`,`nexists`,`equals`,`nequals`,`contains`,`ncontains`,`matches`, or `nmatches`.
...
class RulesetRuleTimeFrameActiveBetweenArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] start_time: A Unix timestamp in milliseconds which is combined with the `timezone` to determine the time this rule will start on each specified `weekday`. Note that the _date_ of the timestamp you specify does **not** matter, except that it lets you determine whether daylight saving time is in effect so that you use the correct UTC offset for the timezone you specify. In practice, you may want to use the `time_static` resource to generate this value, as demonstrated in the `resource.pagerduty_ruleset_rule.foo` code example at the top of this page. To generate this timestamp manually, if you want your rule to apply starting at 9:30am in the `America/New_York` timezone, use your programing language of choice to determine a Unix timestamp that represents 9:30am in that timezone, like [1554989400000](https://www.epochconverter.com/timezones?q=1554989400000&tz=America%2FNew_York).
        """
...
if not MYPY:
    class RulesetRuleTimeFrameScheduledWeeklyArgsDict(TypedDict):
        ...
        """
        weekdays: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
...
class RulesetRuleTimeFrameScheduledWeeklyArgs:
    def __init__(__self__, *,
                 ...
                 weekdays: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None):
        """
        :param pulumi.Input[builtins.int] duration: Length of time the schedule will be active in milliseconds. For example `duration = 2 * 60 * 60 * 1000` if you want your rule to apply for 2 hours, from the specified `start_time`.
        :param pulumi.Input[builtins.int] start_time: A Unix timestamp in milliseconds which is combined with the `timezone` to determine the time this rule will start on each specified `weekday`. Note that the _date_ of the timestamp you specify does **not** matter, except that it lets you determine whether daylight saving time is in effect so that you use the correct UTC offset for the timezone you specify. In practice, you may want to use the `time_static` resource to generate this value, as demonstrated in the `resource.pagerduty_ruleset_rule.foo` code example at the top of this page. To generate this timestamp manually, if you want your rule to apply starting at 9:30am in the `America/New_York` timezone, use your programing language of choice to determine a Unix timestamp that represents 9:30am in that timezone, like [1554989400000](https://www.epochconverter.com/timezones?q=1554989400000&tz=America%2FNew_York).
        :param pulumi.Input[builtins.str] timezone: [The name of the timezone](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) for the given schedule, which will be used to determine UTC offset including adjustment for daylight saving time. For example: `timezone = "America/Toronto"`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] weekdays: An integer array representing which days during the week the rule executes. For example `weekdays = [1,3,7]` would execute on Monday, Wednesday and Sunday.
        """
    ...
    @property
    @pulumi.getter
    def weekdays(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        An integer array representing which days during the week the rule executes. For example `weekdays = [1,3,7]` would execute on Monday, Wednesday and Sunday.
        """
    ...
    @weekdays.setter
    def weekdays(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
...
class RulesetTeamArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: The ID of the ruleset.
        """
        pulumi.set(__self__, "id", id)
...
if not MYPY:
    class ScheduleFinalScheduleArgsDict(TypedDict):
        ...
        """
        rendered_coverage_percentage: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class ScheduleFinalScheduleArgs:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 rendered_coverage_percentage: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def rendered_coverage_percentage(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "rendered_coverage_percentage")

    @rendered_coverage_percentage.setter
    def rendered_coverage_percentage(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rendered_coverage_percentage", value)


if not MYPY:
    class ScheduleLayerArgsDict(TypedDict):
        rotation_turn_length_seconds: pulumi.Input[builtins.int]
        """
        The duration of each on-call shift in `seconds`.
        """
        rotation_virtual_start: pulumi.Input[builtins.str]
        """
...
class ScheduleLayerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] rotation_turn_length_seconds: The duration of each on-call shift in `seconds`.
        :param pulumi.Input[builtins.str] rotation_virtual_start: The effective start time of the schedule layer. This can be before the start time of the schedule.
        :param pulumi.Input[builtins.str] start: The start time of the schedule layer.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users: The ordered list of users on this layer. The position of the user on the list determines their order in the layer.
        :param pulumi.Input[builtins.str] end: The end time of the schedule layer. If not specified, the layer does not end.
        :param pulumi.Input[builtins.str] id: The ID of the schedule.
        :param pulumi.Input[builtins.str] name: The name of the schedule layer.
    ...
    def rotation_turn_length_seconds(self) -> pulumi.Input[builtins.int]:
        """
        The duration of each on-call shift in `seconds`.
        """
    ...
    def rotation_turn_length_seconds(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "rotation_turn_length_seconds", value)

    @property
    @pulumi.getter(name="rotationVirtualStart")
    def rotation_virtual_start(self) -> pulumi.Input[builtins.str]:
        """
        The effective start time of the schedule layer. This can be before the start time of the schedule.
        """
    ...
    def rotation_virtual_start(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ScheduleLayerRestrictionArgsDict(TypedDict):
        duration_seconds: pulumi.Input[builtins.int]
        """
        The duration of the restriction in `seconds`.
        """
        start_time_of_day: pulumi.Input[builtins.str]
        """
        ...
        """
        start_day_of_week: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ScheduleLayerRestrictionArgs:
    def __init__(__self__, *,
                 ...
                 start_time_of_day: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 start_day_of_week: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] duration_seconds: The duration of the restriction in `seconds`.
        :param pulumi.Input[builtins.str] start_time_of_day: The start time in `HH:mm:ss` format.
        :param pulumi.Input[builtins.str] type: Can be `daily_restriction` or `weekly_restriction`.
        :param pulumi.Input[builtins.int] start_day_of_week: Number of the day when restriction starts. From 1 to 7 where 1 is Monday and 7 is Sunday.
        """
    ...
    def duration_seconds(self) -> pulumi.Input[builtins.int]:
        """
        The duration of the restriction in `seconds`.
        """
    ...
    def duration_seconds(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "duration_seconds", value)

    @property
    @pulumi.getter(name="startTimeOfDay")
    def start_time_of_day(self) -> pulumi.Input[builtins.str]:
        """
        The start time in `HH:mm:ss` format.
        """
    ...
    def start_time_of_day(self, value: pulumi.Input[builtins.str]):
    ...
    def start_day_of_week(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of the day when restriction starts. From 1 to 7 where 1 is Monday and 7 is Sunday.
        """
    ...
    def start_day_of_week(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ServiceAlertGroupingParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of alert grouping; one of `intelligent`, `time` or `content_based`.
        """
...
class ServiceAlertGroupingParametersConfigArgs:
    def __init__(__self__, *,
                 ...
                 timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] aggregate: One of `any` or `all`. This setting applies only when `type` is set to `content_based`. Group alerts based on one or all of `fields` value(s).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fields: Alerts will be grouped together if the content of these fields match. This setting applies only when `type` is set to `content_based`.
        :param pulumi.Input[builtins.int] time_window: The maximum amount of time allowed between Alerts. This setting applies only when `type` is set to `intelligent` or `content_based`. Value must be between `300` and `3600` or exactly `86400` (86400 is supported only for `content_based` alert grouping). Any Alerts arriving greater than `time_window` seconds apart will not be grouped together. This is a rolling time window and is counted from the most recently grouped alert. The window is extended every time a new alert is added to the group, up to 24 hours.
        :param pulumi.Input[builtins.int] timeout: The duration in minutes within which to automatically group incoming alerts. This setting applies only when `type` is set to `time`. To continue grouping alerts until the incident is resolved, set this value to `0`.
        """
        if aggregate is not None:
            pulumi.set(__self__, "aggregate", aggregate)
        if fields is not None:
...
class ServiceAutoPauseNotificationsParametersArgs:
    def __init__(__self__, *,
                 ...
                 timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Indicates whether alerts should be automatically suspended when identified as transient.  If not passed in, will default to 'false'.
        :param pulumi.Input[builtins.int] timeout: Indicates in seconds how long alerts should be suspended before triggering. Allowed values: `120`, `180`, `300`, `600`, `900` if `enabled` is `true`. Must be omitted or set to `null` if `enabled` is `false`.
        """
...
class ServiceDependencyDependencyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Can be `business_service`,  `service`, `business_service_reference` or `technical_service_reference`.
        """
...
class ServiceDependencyDependencyDependentServiceArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: The ID of the service dependency.
        :param pulumi.Input[builtins.str] type: Can be `business_service`,  `service`, `business_service_reference` or `technical_service_reference`.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
class ServiceEventRuleActionsSuppressArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.int] threshold_time_amount: The number value of the `threshold_time_unit` before an incident is created.
        :param pulumi.Input[builtins.str] threshold_time_unit: The `seconds`,`minutes`, or `hours` the `threshold_time_amount` should be measured.
        :param pulumi.Input[builtins.int] threshold_value: The number of alerts that should be suppressed.
        :param pulumi.Input[builtins.bool] value: Boolean value that indicates if the alert should be suppressed before the indicated threshold values are met.
        """
        if threshold_time_amount is not None:
            pulumi.set(__self__, "threshold_time_amount", threshold_time_amount)
...
class ServiceEventRuleConditionsSubconditionParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] path: Path to a field in an event, in dot-notation. For Event Rules on a Service, this will have to be a [PD-CEF field](https://support.pagerduty.com/docs/pd-cef).
        """
        if path is not None:
            pulumi.set(__self__, "path", path)
        if value is not None:
...
class ServiceEventRuleTimeFrameActiveBetweenArgs:
    def __init__(__self__, *,
                 ...
                 start_time: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] end_time: Ending of the scheduled time when the rule should execute.  Unix timestamp in milliseconds.
        :param pulumi.Input[builtins.int] start_time: Beginning of the scheduled time when the rule should execute.  Unix timestamp in milliseconds.
        """
        if end_time is not None:
            pulumi.set(__self__, "end_time", end_time)
        if start_time is not None:
...
class ServiceEventRuleTimeFrameScheduledWeeklyArgs:
    def __init__(__self__, *,
                 ...
                 weekdays: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None):
        """
        :param pulumi.Input[builtins.int] duration: Length of time the schedule will be active.  Unix timestamp in milliseconds.
        :param pulumi.Input[builtins.int] start_time: Time when the schedule will start. Unix timestamp in milliseconds. For example, if you have a rule with a `start_time` of `0` and a `duration` of `60,000` then that rule would be active from `00:00` to `00:01`. If the `start_time` was `3,600,000` the it would be active starting at `01:00`.
        :param pulumi.Input[builtins.str] timezone: Timezone for the given schedule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] weekdays: An integer array representing which days during the week the rule executes. For example `weekdays = [1,3,7]` would execute on Monday, Wednesday and Sunday.
        """
        if duration is not None:
            pulumi.set(__self__, "duration", duration)
...
class ServiceEventRuleVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Type of operation to populate the variable. Usually `regex`.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if parameters is not None:
...
if not MYPY:
    class ServiceIncidentUrgencyRuleArgsDict(TypedDict):
        ...
        """
        urgency: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceIncidentUrgencyRuleArgs:
    def __init__(__self__, *,
                 ...
                 urgency: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The type of incident urgency: `constant` or `use_support_hours` (when depending on specific support hours; see `support_hours`).
        ...
        :param pulumi.Input[builtins.str] urgency: The urgency: `low` Notify responders (does not escalate), `high` (follows escalation rules) or `severity_based` Set's the urgency of the incident based on the severity set by the triggering monitoring tool.
        """
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def urgency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The urgency: `low` Notify responders (does not escalate), `high` (follows escalation rules) or `severity_based` Set's the urgency of the incident based on the severity set by the triggering monitoring tool.
        """
    ...
    @urgency.setter
    def urgency(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServiceIncidentUrgencyRuleDuringSupportHoursArgs:
    def __init__(__self__, *,
                 ...
                 urgency: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The type of object. The value returned will be `service`. Can be used for passing to a service dependency.
        :param pulumi.Input[builtins.str] urgency: The urgency: `low` Notify responders (does not escalate), `high` (follows escalation rules) or `severity_based` Set's the urgency of the incident based on the severity set by the triggering monitoring tool.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
if not MYPY:
    class ServiceIntegrationEmailFilterArgsDict(TypedDict):
        body_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        Can be `always`, `match` or `no-match`.
        """
        body_regex: NotRequired[pulumi.Input[builtins.str]]
        """
        Should be a valid regex or `null`
        """
        from_email_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        Can be `always`, `match` or `no-match`.
        """
        from_email_regex: NotRequired[pulumi.Input[builtins.str]]
        """
        Should be a valid regex or `null`
        """
        id: NotRequired[pulumi.Input[builtins.str]]
        ...
        """
        subject_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        Can be `always`, `match` or `no-match`.
        """
        subject_regex: NotRequired[pulumi.Input[builtins.str]]
        """
        Should be a valid regex or `null`
        """
elif False:
...
class ServiceIntegrationEmailFilterArgs:
    def __init__(__self__, *,
                 body_mode: Optional[pulumi.Input[builtins.str]] = None,
                 body_regex: Optional[pulumi.Input[builtins.str]] = None,
                 from_email_mode: Optional[pulumi.Input[builtins.str]] = None,
                 from_email_regex: Optional[pulumi.Input[builtins.str]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 subject_mode: Optional[pulumi.Input[builtins.str]] = None,
                 subject_regex: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] body_mode: Can be `always`, `match` or `no-match`.
        :param pulumi.Input[builtins.str] body_regex: Should be a valid regex or `null`
        :param pulumi.Input[builtins.str] from_email_mode: Can be `always`, `match` or `no-match`.
        :param pulumi.Input[builtins.str] from_email_regex: Should be a valid regex or `null`
        :param pulumi.Input[builtins.str] id: The ID of the service integration.
        :param pulumi.Input[builtins.str] subject_mode: Can be `always`, `match` or `no-match`.
        :param pulumi.Input[builtins.str] subject_regex: Should be a valid regex or `null`
        """
    ...
    def body_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Can be `always`, `match` or `no-match`.
        """
    ...
    @body_mode.setter
    def body_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "body_mode", value)

    @property
    @pulumi.getter(name="bodyRegex")
    def body_regex(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Should be a valid regex or `null`
        """
    ...
    @body_regex.setter
    def body_regex(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "body_regex", value)

    @property
    @pulumi.getter(name="fromEmailMode")
    def from_email_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Can be `always`, `match` or `no-match`.
        """
    ...
    def from_email_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "from_email_mode", value)

    @property
    @pulumi.getter(name="fromEmailRegex")
    def from_email_regex(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Should be a valid regex or `null`
        """
    ...
    def from_email_regex(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subject_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Can be `always`, `match` or `no-match`.
        """
    ...
    @subject_mode.setter
    def subject_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "subject_mode", value)

    @property
    @pulumi.getter(name="subjectRegex")
    def subject_regex(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Should be a valid regex or `null`
        """
    ...
    def subject_regex(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServiceIntegrationEmailParserArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: Can be `resolve` or `trigger`.
        :param pulumi.Input[builtins.int] id: The ID of the service integration.
        """
        pulumi.set(__self__, "action", action)
...
class ServiceIntegrationEmailParserMatchPredicateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Can be `any` or `all`.
        """
        pulumi.set(__self__, "type", type)
...
if not MYPY:
    class ServiceIntegrationEmailParserMatchPredicatePredicateArgsDict(TypedDict):
        ...
        """
        part: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceIntegrationEmailParserMatchPredicatePredicateArgs:
    def __init__(__self__, *,
                 ...
                 part: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] type: Can be `contains`, `exactly`, `regex` or `not`. If type is `not` predicate should contain child predicate with all parameters.
        :param pulumi.Input[builtins.str] matcher: Predicate value or valid regex.
        :param pulumi.Input[builtins.str] part: Can be `subject`, `body` or `from_addresses`.
        """
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def part(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Can be `subject`, `body` or `from_addresses`.
        """
    ...
    @part.setter
    def part(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ServiceIntegrationEmailParserMatchPredicatePredicatePredicateArgsDict(TypedDict):
        ...
        Predicate value or valid regex.
        """
        part: pulumi.Input[builtins.str]
        """
        Can be `subject`, `body` or `from_addresses`.
        """
        type: pulumi.Input[builtins.str]
...
class ServiceIntegrationEmailParserMatchPredicatePredicatePredicateArgs:
    ...
    @property
    @pulumi.getter
    def part(self) -> pulumi.Input[builtins.str]:
        """
        Can be `subject`, `body` or `from_addresses`.
        """
        return pulumi.get(self, "part")
    ...
    @part.setter
    def part(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "part", value)
...
if not MYPY:
    class ServiceIntegrationEmailParserValueExtractorArgsDict(TypedDict):
        ...
        **Note:** You can use the `get_vendor` data source to locate the appropriate vendor ID.
        """
        starts_after: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class ServiceIntegrationEmailParserValueExtractorArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str],
                 value_name: pulumi.Input[builtins.str],
                 ends_before: Optional[pulumi.Input[builtins.str]] = None,
                 regex: Optional[pulumi.Input[builtins.str]] = None,
                 starts_after: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] part: Can be `subject` or `body`.
        :param pulumi.Input[builtins.str] type: Can be `between`, `entire` or `regex`.
        :param pulumi.Input[builtins.str] value_name: First value extractor should have name `incident_key` other value extractors should contain custom names.
        :param pulumi.Input[builtins.str] regex: If `type` has value `regex` this value should contain valid regex.
    ...
    def value_name(self) -> pulumi.Input[builtins.str]:
        """
        First value extractor should have name `incident_key` other value extractors should contain custom names.
        """
    ...
    @value_name.setter
    def value_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "value_name", value)

    @property
    @pulumi.getter(name="endsBefore")
    def ends_before(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ends_before")

    @ends_before.setter
    def ends_before(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def starts_after(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "starts_after")

    @starts_after.setter
    def starts_after(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ServiceScheduledActionArgsDict(TypedDict):
        ...
        """
        to_urgency: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceScheduledActionArgs:
    def __init__(__self__, *,
                 ...
                 to_urgency: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] to_urgency: The urgency to change to: `low` (does not escalate), or `high` (follows escalation rules).
        :param pulumi.Input[builtins.str] type: The type of scheduled action. Currently, this must be set to `urgency_change`.
        """
        if ats is not None:
    ...
    def to_urgency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The urgency to change to: `low` (does not escalate), or `high` (follows escalation rules).
        """
    ...
    @to_urgency.setter
    def to_urgency(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServiceScheduledActionAtArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: Designates either the start or the end of the scheduled action. Can be `support_hours_start` or `support_hours_end`.
               ...
               ```
        :param pulumi.Input[builtins.str] type: The type of time specification. Currently, this must be set to `named_time`.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if type is not None:
...
if not MYPY:
    class ServiceSupportHoursArgsDict(TypedDict):
        days_of_weeks: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
...
class ServiceSupportHoursArgs:
    def __init__(__self__, *,
                 days_of_weeks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 end_time: Optional[pulumi.Input[builtins.str]] = None,
                 start_time: Optional[pulumi.Input[builtins.str]] = None,
                 time_zone: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] days_of_weeks: Array of days of week as integers. `1` to `7`, `1` being
               Monday and `7` being Sunday.
        :param pulumi.Input[builtins.str] end_time: The support hours' ending time of day.
        :param pulumi.Input[builtins.str] start_time: The support hours' starting time of day.
        :param pulumi.Input[builtins.str] time_zone: The time zone for the support hours.
        :param pulumi.Input[builtins.str] type: The type of support hours. Can be `fixed_time_per_day`.
        """
    ...
    def days_of_weeks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        Array of days of week as integers. `1` to `7`, `1` being
        Monday and `7` being Sunday.
        """
    ...
    def days_of_weeks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
...
if not MYPY:
    class SlackConnectionConfigArgsDict(TypedDict):
        ...
        - `incident.reopened`
        """
        priorities: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class SlackConnectionConfigArgs:
    def __init__(__self__, *,
                 events: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 priorities: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 urgency: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: A list of strings to filter events by PagerDuty event type. `"incident.triggered"` is required. The follow event types are also possible:
               - `incident.acknowledged`
               - `incident.escalated`
               - `incident.resolved`
               - `incident.reassigned`
               ...
               - `incident.status_update_published`
               - `incident.reopened`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] priorities: Allows you to filter events by priority. Needs to be an array of PagerDuty priority IDs. Available through get_priority data source.
               - When omitted or set to an empty array (`[]`) in the configuration for a Slack Connection, its default behavior is to set `priorities` to `No Priority` value.
               - When set to `["*"]` its corresponding value for `priorities` in Slack Connection's configuration will be `Any Priority`.
        :param pulumi.Input[builtins.str] urgency: Allows you to filter events by urgency. Either `high`, `low` or `null` for Any urgency. Default is `null`.
        """
    ...
    @property
    @pulumi.getter
    def priorities(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Allows you to filter events by priority. Needs to be an array of PagerDuty priority IDs. Available through get_priority data source.
        - When omitted or set to an empty array (`[]`) in the configuration for a Slack Connection, its default behavior is to set `priorities` to `No Priority` value.
        - When set to `["*"]` its corresponding value for `priorities` in Slack Connection's configuration will be `Any Priority`.
    ...
    @priorities.setter
    def priorities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "priorities", value)
...
class UserHandoffNotificationRuleContactMethodArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: The ID of the contact method.
        :param pulumi.Input[builtins.str] type: The type of the contact method. May be (`email_contact_method`, `email_contact_method_reference`, `phone_contact_method`, `phone_contact_method_reference`, `push_notification_contact_method`, `push_notification_contact_method_reference`, `sms_contact_method`, `sms_contact_method_reference`).
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
if not MYPY:
    class WebhookSubscriptionDeliveryMethodArgsDict(TypedDict):
        ...
        """
        temporarily_disabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class WebhookSubscriptionDeliveryMethodArgs:
    def __init__(__self__, *,
                 ...
                 temporarily_disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] temporarily_disabled: Whether this webhook subscription is temporarily disabled. Becomes true if the delivery method URL is repeatedly rejected by the server.
        :param pulumi.Input[builtins.str] type: Indicates the type of the delivery method. Allowed and default value: `http_delivery_method`.
        :param pulumi.Input[builtins.str] url: The destination URL for webhook delivery.
        """
    ...
    def temporarily_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this webhook subscription is temporarily disabled. Becomes true if the delivery method URL is repeatedly rejected by the server.
        """
    ...
    def temporarily_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WebhookSubscriptionFilterArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The type of object being used as the filter. Allowed values are `account_reference`, `service_reference`, and `team_reference`.
        :param pulumi.Input[builtins.str] id: The id of the object being used as the filter. This field is required for all filter types except account_reference.
        """
        pulumi.set(__self__, "type", type)
        if id is not None:
            pulumi.set(__self__, "id", id)
...
if not MYPY:
    class GetAlertGroupingSettingConfigArgsDict(TypedDict):
        ...
        """
        aggregate: NotRequired[builtins.str]
        """
        One of `any` or `all`. This setting is only required and applies when `type` is set to `content_based` or `content_based_intelligent`. Group alerts based on one or all of `fields` value(s).
        """
        fields: NotRequired[Sequence[builtins.str]]
        """
        Alerts will be grouped together if the content of these fields match. This setting is only required and applies when `type` is set to `content_based` or `content_based_intelligent`.
        """
elif False:
...
class GetAlertGroupingSettingConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param builtins.int time_window: The maximum amount of time allowed between Alerts. This setting applies only when `type` is set to `intelligent`, `content_based`, `content_based_intelligent`. Value must be between `300` and `3600` or exactly `86400` (86400 is supported only for `content_based` alert grouping). Any Alerts arriving greater than `time_window` seconds apart will not be grouped together. This is a rolling time window and is counted from the most recently grouped alert. The window is extended every time a new alert is added to the group, up to 24 hours. To use the recommended time window leave this value unset or set it to `null`.
        :param builtins.int timeout: The duration in minutes within which to automatically group incoming alerts. This setting is only required and applies when `type` is set to `time`. To continue grouping alerts until the incident is resolved leave this value unset or set it to `null`.
        :param builtins.str aggregate: One of `any` or `all`. This setting is only required and applies when `type` is set to `content_based` or `content_based_intelligent`. Group alerts based on one or all of `fields` value(s).
        :param Sequence[builtins.str] fields: Alerts will be grouped together if the content of these fields match. This setting is only required and applies when `type` is set to `content_based` or `content_based_intelligent`.
        """
        pulumi.set(__self__, "time_window", time_window)
        pulumi.set(__self__, "timeout", timeout)
        if aggregate is not None:
    ...
    @time_window.setter
    def time_window(self, value: builtins.int):
        pulumi.set(self, "time_window", value)
    ...
    @property
    @pulumi.getter
    def aggregate(self) -> Optional[builtins.str]:
        """
        One of `any` or `all`. This setting is only required and applies when `type` is set to `content_based` or `content_based_intelligent`. Group alerts based on one or all of `fields` value(s).
        """
        return pulumi.get(self, "aggregate")
    ...
    @aggregate.setter
    def aggregate(self, value: Optional[builtins.str]):
        pulumi.set(self, "aggregate", value)
    ...
    @fields.setter
    def fields(self, value: Optional[Sequence[builtins.str]]):
        pulumi.set(self, "fields", value)
...
class GetEventOrchestrationIntegrationDetailArgs:
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: ID of the integration
    ...
    @label.setter
    def label(self, value: builtins.str):
        pulumi.set(self, "label", value)
...
class GetEventOrchestrationIntegrationDetailParameterArgs:
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str routing_key: Routing key that routes to this Orchestration.
        :param builtins.str type: Type of the routing key. `global` is the default type.
        """
        pulumi.set(__self__, "routing_key", routing_key)
        pulumi.set(__self__, "type", type)
    ...
    @routing_key.setter
    def routing_key(self, value: builtins.str):
        pulumi.set(self, "routing_key", value)
