...
class AlertGroupingSettingConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] iag_fields: An array of strings which represent the iag fields with which to intelligently group against.  This setting applies only when `type` is set to `intelligent`. Default: ["summary"].
        :param pulumi.Input[_builtins.int] time_window: The maximum amount of time allowed between Alerts. This setting applies only when `type` is set to `intelligent`, `content_based`, `content_based_intelligent`. Value must be between `300` and `3600` or exactly `86400` (86400 is supported only for `content_based` alert grouping). Any Alerts arriving greater than `time_window` seconds apart will not be grouped together. This is a rolling time window and is counted from the most recently grouped alert. The window is extended every time a new alert is added to the group, up to 24 hours. To use the recommended time window leave this value unset or set it to `null`.
        :param pulumi.Input[_builtins.int] timeout: The duration in seconds within which to automatically group incoming alerts. This setting is only required and applies when `type` is set to `time`. To continue grouping alerts until the incident is resolved leave this value unset or set it to `null`.
        """
...
class AutomationActionsActionActionDataReferenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] process_automation_job_id: The ID of the Process Automation job to execute.
        :param pulumi.Input[_builtins.str] process_automation_node_filter: The expression that filters on which nodes a Process Automation Job executes [Learn more](https://docs.rundeck.com/docs/manual/05-nodes.html#node-filtering).
        :param pulumi.Input[_builtins.str] script: Body of the script to be executed on the Runner. Max length is 16777215 characters.
        """
...
class EscalationPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: The ID of the escalation policy.
        """
    ...
    def escalation_delay_in_minutes(self) -> pulumi.Input[_builtins.int]:
        """
        The number of minutes before an unacknowledged incident escalates away from this rule.
        """
    ...
    def escalation_delay_in_minutes(self, value: pulumi.Input[_builtins.int]):
...
class EventOrchestrationGlobalCacheVariableConditionArgs:
    def __init__(__self__, *,
                 expression: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] expression: A [PCL condition](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview) string.
        """
...
class EventOrchestrationGlobalCacheVariableConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] regex: A [RE2 regular expression][4] that will be matched against the field specified via the `source` argument. This field is only used when `type` is `recent_value`
        :param pulumi.Input[_builtins.str] source: The path to the event field where the `regex` will be applied to extract a value. You can use any valid [PCL path](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview#paths). This field is only used when `type` is `recent_value`
        :param pulumi.Input[_builtins.int] ttl_seconds: The number of seconds indicating how long to count incoming trigger events for. This field is only used when `type` is `trigger_event_count` or `external_data`
        """
        pulumi.set(__self__, "type", type)
...
class EventOrchestrationGlobalCatchAllActionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] drop_event: When true, this event will be dropped. Dropped events will not trigger or resolve an alert or an incident. Dropped events will not be evaluated against router rules.
        :param pulumi.Input[_builtins.str] escalation_policy: The ID of the Escalation Policy you want to assign incidents to. Event rules with this action will override the Escalation Policy already set on a Service's settings, with what is configured by this action.
        ...
        :param pulumi.Input[_builtins.str] priority: The ID of the priority you want to set on resulting incident. Consider using the `get_priority` data source.
        :param pulumi.Input[_builtins.str] route_to: The ID of a Set from this Global Orchestration whose rules you also want to use with events that match this rule.
        :param pulumi.Input[_builtins.str] severity: sets Severity of the resulting alert. Allowed values are: `info`, `error`, `warning`, `critical`
        :param pulumi.Input[_builtins.bool] suppress: Set whether the resulting alert is suppressed. Suppressed alerts will not trigger an incident.
        :param pulumi.Input[_builtins.int] suspend: The number of seconds to suspend the resulting alert before triggering. This effectively pauses incident notifications. If a `resolve` event arrives before the alert triggers then PagerDuty won't create an incident for this alert.
...
class EventOrchestrationGlobalCatchAllActionsAutomationActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] auto_send: When true, PagerDuty's servers will automatically send this webhook request as soon as the resulting incident or alert is created. When false, your incident responder will be able to manually trigger the Webhook via the PagerDuty website and mobile app.
        ...
        :param pulumi.Input[_builtins.str] trigger_types: The Webhook will be associated (or automatically triggered, if `auto_send` is `true`) with the incident or alert, whenever an alert reaches the specified state. Allowed values are: `["alert_triggered"]`, `["alert_suspended"]`, `["alert_suppressed"]`. NOTE: `auto_send` must be `true` for trigger types of `["alert_suspended"]` and `["alert_suppressed"]`
        """
...
class EventOrchestrationGlobalCatchAllActionsAutomationActionHeaderArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] key: Name to identify the header
        :param pulumi.Input[_builtins.str] value: Value of this header
        """
...
class EventOrchestrationGlobalCatchAllActionsAutomationActionParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] key: Name to identify the parameter
        :param pulumi.Input[_builtins.str] value: Value of this parameter
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class EventOrchestrationGlobalCatchAllActionsExtractionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source: The path to the event field where the `regex` will be applied to extract a value. You can use any valid [PCL path](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview#paths) like `event.summary` and you can reference previously-defined variables using a path like `variables.hostname`. This field can be ignored for `template` based extractions.
        :param pulumi.Input[_builtins.str] template: A string that will be used to populate the `target` field. You can reference variables or event data within your template using double curly braces. For example:
               * Use variables named `ip` and `subnet` with a template like: `{{variables.ip}}/{{variables.subnet}}`
               * Combine the event severity & summary with template like: `{{event.severity}}:{{event.summary}}`
        """
...
class EventOrchestrationGlobalCatchAllActionsIncidentCustomFieldUpdateArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: The custom field id
        :param pulumi.Input[_builtins.str] value: The value to assign to this custom field
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "value", value)
...
class EventOrchestrationGlobalCatchAllActionsVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] path: Path to a field in an event, in dot-notation. This supports both PagerDuty Common Event Format [PD-CEF](https://support.pagerduty.com/docs/pd-cef) and non-CEF fields. Eg: Use `event.summary` for the `summary` CEF field. Use `raw_event.fieldname` to read from the original event `fieldname` data. You can use any valid [PCL path](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview#paths).
        :param pulumi.Input[_builtins.str] type: Only `regex` is supported
        :param pulumi.Input[_builtins.str] value: The Regex expression to match against. Must use valid [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) syntax.
        """
        pulumi.set(__self__, "name", name)
...
class EventOrchestrationGlobalSetRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: The ID of the rule within the set.
        :param pulumi.Input[_builtins.str] label: A description of this rule's purpose.
        """
        pulumi.set(__self__, "actions", actions)
...
class EventOrchestrationRouterCatchAllActionsArgsDict(TypedDict):
    route_to: pulumi.Input[_builtins.str]
    """
...
class EventOrchestrationRouterCatchAllActionsArgs:
    def __init__(__self__, *,
                 route_to: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] route_to: Defines where an alert will be sent if doesn't match any rules. Can either be the ID of a Service _or_ the string `"unrouted"` to send events to the Unrouted Orchestration.
        """
        pulumi.set(__self__, "route_to", route_to)

    @_builtins.property
    @pulumi.getter(name="routeTo")
    def route_to(self) -> pulumi.Input[_builtins.str]:
        """
        Defines where an alert will be sent if doesn't match any rules. Can either be the ID of a Service _or_ the string `"unrouted"` to send events to the Unrouted Orchestration.
        """
        return pulumi.get(self, "route_to")
    ...
    @route_to.setter
    def route_to(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "route_to", value)
...
class EventOrchestrationRouterSetRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] disabled: Indicates whether the rule is disabled and would therefore not be evaluated.
        :param pulumi.Input[_builtins.str] id: The ID of the rule within the `start` set.
        :param pulumi.Input[_builtins.str] label: A description of this rule's purpose.
        """
        pulumi.set(__self__, "actions", actions)
        if conditions is not None:
...
class EventOrchestrationRouterSetRuleActionsDynamicRouteToArgsDict(TypedDict):
    lookup_by: pulumi.Input[_builtins.str]
    """
...
class EventOrchestrationRouterSetRuleActionsDynamicRouteToArgs:
    def __init__(__self__, *,
                 ...
                 source: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] lookup_by: Indicates whether the extracted value from the source is a service's name or ID. Allowed values are: `service_name`, `service_id`
               
               If an event has a value at the specified `source`, and if the `regex` successfully matches the value, and if the matching portion is valid Service ID or Name, then the event will be routed to that service. Otherwise the event will be checked against any subsequent router rules.
        :param pulumi.Input[_builtins.str] regex: The regular expression, used to extract a value from the source field. Must use valid [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) syntax.
        :param pulumi.Input[_builtins.str] source: The path to a field in an event.
        """
    ...
    def lookup_by(self) -> pulumi.Input[_builtins.str]:
        """
        Indicates whether the extracted value from the source is a service's name or ID. Allowed values are: `service_name`, `service_id`
    ...
    @lookup_by.setter
    def lookup_by(self, value: pulumi.Input[_builtins.str]):
...
class EventOrchestrationServiceCatchAllActionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] priority: The ID of the priority you want to set on resulting incident. Consider using the `get_priority` data source.
        :param pulumi.Input[_builtins.str] route_to: The ID of a Set from this Service Orchestration whose rules you also want to use with events that match this rule.
        :param pulumi.Input[_builtins.str] severity: sets Severity of the resulting alert. Allowed values are: `info`, `error`, `warning`, `critical`
        :param pulumi.Input[_builtins.bool] suppress: Set whether the resulting alert is suppressed. Suppressed alerts will not trigger an incident.
        :param pulumi.Input[_builtins.int] suspend: The number of seconds to suspend the resulting alert before triggering. This effectively pauses incident notifications. If a `resolve` event arrives before the alert triggers then PagerDuty won't create an incident for this alert.
...
class EventOrchestrationUnroutedCatchAllActionsVariableArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] name: The name of the variable
        :param pulumi.Input[_builtins.str] path: Path to a field in an event, in dot-notation. This supports both [PD-CEF](https://support.pagerduty.com/docs/pd-cef) and non-CEF fields. Eg: Use `event.summary` for the `summary` CEF field. Use `raw_event.fieldname` to read from the original event `fieldname` data.
        :param pulumi.Input[_builtins.str] type: Only `regex` is supported
        :param pulumi.Input[_builtins.str] value: The Regex expression to match against. Must use valid [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) syntax.
        """
        pulumi.set(__self__, "name", name)
...
class EventOrchestrationUnroutedSetRuleActionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] route_to: The ID of a Set from this Unrouted Orchestration whose rules you also want to use with events that match this rule.
        :param pulumi.Input[_builtins.str] severity: sets Severity of the resulting alert. Allowed values are: `info`, `error`, `warning`, `critical`
...
class IncidentWorkflowStepArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: The ID of the incident workflow.
...
class JiraCloudAccountMappingRuleConfigJiraArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] sync_notes_user: ID of the PagerDuty user for syncing notes and comments between Jira issues and PagerDuty incidents. If not provided, note synchronization is disabled.
        """
...
class JiraCloudAccountMappingRuleConfigJiraCustomFieldArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The type of the value that will be set; one of `attribute`, `const` or `jira_value`.
        :param pulumi.Input[_builtins.str] source_incident_field: The PagerDuty incident field from which the value will be extracted (only applicable if `type` is `attribute`); one of `incident_number`, `incident_title`, `incident_description`, `incident_status`, `incident_created_at`, `incident_service`, `incident_escalation_policy`, `incident_impacted_services`, `incident_html_url`, `incident_assignees`, `incident_acknowledgers`, `incident_last_status_change_at`, `incident_last_status_change_by`, `incident_urgency` or `incident_priority`.
        :param pulumi.Input[_builtins.str] value: The value to be set for the Jira field (only applicable if `type` is `const` or `jira_value`). It must be set as a JSON string.
        """
    ...
    def target_issue_field(self) -> pulumi.Input[_builtins.str]:
        """
        The unique identifier key of the Jira field that will be set.
        """
    ...
    def target_issue_field(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "target_issue_field", value)

    @_builtins.property
    @pulumi.getter(name="targetIssueFieldName")
    def target_issue_field_name(self) -> pulumi.Input[_builtins.str]:
        """
        The human-readable name of the Jira field.
        """
    ...
    def target_issue_field_name(self, value: pulumi.Input[_builtins.str]):
...
class JiraCloudAccountMappingRuleConfigJiraIssueTypeArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: Unique identifier for the Jira issue type.
        :param pulumi.Input[_builtins.str] name: The name of the Jira issue type.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class JiraCloudAccountMappingRuleConfigJiraPriorityArgsDict(TypedDict):
    jira_id: pulumi.Input[_builtins.str]
    """
    The ID of the Jira priority.
    """
    pagerduty_id: pulumi.Input[_builtins.str]
    """
...
class JiraCloudAccountMappingRuleConfigJiraPriorityArgs:
    def __init__(__self__, *,
                 ...
                 pagerduty_id: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] jira_id: The ID of the Jira priority.
        :param pulumi.Input[_builtins.str] pagerduty_id: The ID of the PagerDuty priority.
        """
    ...
    def jira_id(self) -> pulumi.Input[_builtins.str]:
        """
        The ID of the Jira priority.
        """
    ...
    @jira_id.setter
    def jira_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "jira_id", value)

    @_builtins.property
    @pulumi.getter(name="pagerdutyId")
    def pagerduty_id(self) -> pulumi.Input[_builtins.str]:
        """
        The ID of the PagerDuty priority.
        """
    ...
    @pagerduty_id.setter
    def pagerduty_id(self, value: pulumi.Input[_builtins.str]):
...
class JiraCloudAccountMappingRuleConfigJiraProjectArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: Unique identifier for the Jira project.
        :param pulumi.Input[_builtins.str] key: The short key name of the Jira project.
        :param pulumi.Input[_builtins.str] name: The name of the Jira project.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "name", name)
...
class ResponsePlayResponderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: ID of the user defined as the responder
        :param pulumi.Input[_builtins.str] name: Name of the escalation policy
        ...
        :param pulumi.Input[_builtins.str] on_call_handoff_notifications: Determines how on call handoff notifications will be sent for users on the escalation policy. Defaults to "if_has_services". Could be "if_has_services", "always
        ...
        :param pulumi.Input[_builtins.str] type: Should be set as `escalation_policy` for escalation policy responders.
        """
...
class RulesetRuleActionsExtractionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] regex: The conditions that need to be met for the extraction to happen. Must use valid [RE2 regular expression syntax](https://github.com/google/re2/wiki/Syntax).
               ...
               *- **OR** -*
        :param pulumi.Input[_builtins.str] source: Field where the data is being copied from. Must be a [PagerDuty Common Event Format (PD-CEF)](https://support.pagerduty.com/docs/pd-cef) field.
        :param pulumi.Input[_builtins.str] target: Field where the data is being copied to. Must be a [PagerDuty Common Event Format (PD-CEF)](https://support.pagerduty.com/docs/pd-cef) field.
               
               *NOTE: A rule can have multiple `extraction` objects attributed to it.*
        :param pulumi.Input[_builtins.str] template: A customized field message. This can also include variables extracted from the payload by using string interpolation.
        """
        if regex is not None:
            pulumi.set(__self__, "regex", regex)
        if source is not None:
...
class RulesetRuleActionsSuppressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] threshold_value: The number of alerts that should be suppressed. Must be greater than 0.
        :param pulumi.Input[_builtins.bool] value: Boolean value that indicates if the alert should be suppressed before the indicated threshold values are met.
        """
...
class RulesetRuleTimeFrameScheduledWeeklyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] start_time: A Unix timestamp in milliseconds which is combined with the `timezone` to determine the time this rule will start on each specified `weekday`. Note that the _date_ of the timestamp you specify does **not** matter, except that it lets you determine whether daylight saving time is in effect so that you use the correct UTC offset for the timezone you specify. In practice, you may want to use the `time_static` resource to generate this value, as demonstrated in the `resource.pagerduty_ruleset_rule.foo` code example at the top of this page. To generate this timestamp manually, if you want your rule to apply starting at 9:30am in the `America/New_York` timezone, use your programing language of choice to determine a Unix timestamp that represents 9:30am in that timezone, like [1554989400000](https://www.epochconverter.com/timezones?q=1554989400000&tz=America%2FNew_York).
        :param pulumi.Input[_builtins.str] timezone: [The name of the timezone](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) for the given schedule, which will be used to determine UTC offset including adjustment for daylight saving time. For example: `timezone = "America/Toronto"`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] weekdays: An integer array representing which days during the week the rule executes. For example `weekdays = [1,3,7]` would execute on Monday, Wednesday and Sunday.
        """
...
class RulesetTeamArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: The ID of the ruleset.
        """
        pulumi.set(__self__, "id", id)
...
class ScheduleLayerArgsDict(TypedDict):
    rotation_turn_length_seconds: pulumi.Input[_builtins.int]
    """
...
class ScheduleLayerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] start: The start time of the schedule layer.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] users: The ordered list of users on this layer. The position of the user on the list determines their order in the layer.
        :param pulumi.Input[_builtins.str] end: The end time of the schedule layer. If not specified, the layer does not end.
        :param pulumi.Input[_builtins.str] id: The ID of the schedule.
        :param pulumi.Input[_builtins.str] name: The name of the schedule layer.
    ...
    def rotation_turn_length_seconds(self) -> pulumi.Input[_builtins.int]:
        """
        The duration of each on-call shift in `seconds`.
        """
    ...
    def rotation_turn_length_seconds(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "rotation_turn_length_seconds", value)

    @_builtins.property
    @pulumi.getter(name="rotationVirtualStart")
    def rotation_virtual_start(self) -> pulumi.Input[_builtins.str]:
        """
        The effective start time of the schedule layer. This can be before the start time of the schedule.
        """
    ...
    def rotation_virtual_start(self, value: pulumi.Input[_builtins.str]):
...
class ScheduleLayerRestrictionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Can be `daily_restriction` or `weekly_restriction`.
        :param pulumi.Input[_builtins.int] start_day_of_week: Number of the day when restriction starts. From 1 to 7 where 1 is Monday and 7 is Sunday.
        """
    ...
    def start_time_of_day(self) -> pulumi.Input[_builtins.str]:
        """
        The start time in `HH:mm:ss` format.
        """
    ...
    def start_time_of_day(self, value: pulumi.Input[_builtins.str]):
...
class ServiceAlertGroupingParametersConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] time_window: The maximum amount of time allowed between Alerts. This setting applies only when `type` is set to `intelligent` or `content_based`. Value must be between `300` and `3600` or exactly `86400` (86400 is supported only for `content_based` alert grouping). Any Alerts arriving greater than `time_window` seconds apart will not be grouped together. This is a rolling time window and is counted from the most recently grouped alert. The window is extended every time a new alert is added to the group, up to 24 hours.
        :param pulumi.Input[_builtins.int] timeout: The duration in minutes within which to automatically group incoming alerts. This setting applies only when `type` is set to `time`. To continue grouping alerts until the incident is resolved, set this value to `0`.
        """
        if aggregate is not None:
            pulumi.set(__self__, "aggregate", aggregate)
        if fields is not None:
...
class ServiceCustomFieldFieldOptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: The ID of the service custom field.
        """
        pulumi.set(__self__, "data_type", data_type)
        pulumi.set(__self__, "value", value)
        if id is not None:
...
class ServiceCustomFieldValueCustomFieldArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: The ID of the custom field. Either `id` or `name` must be provided.
        :param pulumi.Input[_builtins.str] name: The name of the custom field. Either `id` or `name` must be provided.
        :param pulumi.Input[_builtins.str] value: The value to set for the custom field. Must be provided as a JSON-encoded string matching the field's data type. Use the `jsonencode()` function to ensure proper formatting.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class ServiceDependencyDependencyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Can be `business_service`,  `service`, `business_service_reference` or `technical_service_reference`.
        """
...
class ServiceDependencyDependencyDependentServiceArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: The ID of the service dependency.
        :param pulumi.Input[_builtins.str] type: Can be `business_service`,  `service`, `business_service_reference` or `technical_service_reference`.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
class ServiceEventRuleActionsSuppressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] threshold_time_unit: The `seconds`,`minutes`, or `hours` the `threshold_time_amount` should be measured.
        :param pulumi.Input[_builtins.int] threshold_value: The number of alerts that should be suppressed.
        :param pulumi.Input[_builtins.bool] value: Boolean value that indicates if the alert should be suppressed before the indicated threshold values are met.
        """
        if threshold_time_amount is not None:
            pulumi.set(__self__, "threshold_time_amount", threshold_time_amount)
...
class ServiceEventRuleTimeFrameScheduledWeeklyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] timezone: Timezone for the given schedule.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] weekdays: An integer array representing which days during the week the rule executes. For example `weekdays = [1,3,7]` would execute on Monday, Wednesday and Sunday.
        """
        if duration is not None:
            pulumi.set(__self__, "duration", duration)
...
class ServiceEventRuleVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Type of operation to populate the variable. Usually `regex`.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if parameters is not None:
...
class ServiceIntegrationEmailFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] from_email_mode: Can be `always`, `match` or `no-match`.
        :param pulumi.Input[_builtins.str] from_email_regex: Should be a valid regex or `null`
        :param pulumi.Input[_builtins.str] id: The ID of the service integration.
        :param pulumi.Input[_builtins.str] subject_mode: Can be `always`, `match` or `no-match`.
        :param pulumi.Input[_builtins.str] subject_regex: Should be a valid regex or `null`
        """
...
class ServiceIntegrationEmailParserMatchPredicatePredicateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] part: Can be `subject`, `body` or `from_addresses`.
        """
        pulumi.set(__self__, "type", type)
...
class ServiceIntegrationEmailParserMatchPredicatePredicatePredicateArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def part(self) -> pulumi.Input[_builtins.str]:
        """
        Can be `subject`, `body` or `from_addresses`.
        """
        return pulumi.get(self, "part")
    ...
    @part.setter
    def part(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "part", value)
...
class ServiceIntegrationEmailParserValueExtractorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] value_name: First value extractor should have name `incident_key` other value extractors should contain custom names.
        :param pulumi.Input[_builtins.str] regex: If `type` has value `regex` this value should contain valid regex.
    ...
    def value_name(self) -> pulumi.Input[_builtins.str]:
        """
        First value extractor should have name `incident_key` other value extractors should contain custom names.
        """
    ...
    @value_name.setter
    def value_name(self, value: pulumi.Input[_builtins.str]):
...
class ServiceScheduledActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The type of scheduled action. Currently, this must be set to `urgency_change`.
        """
        if ats is not None:
...
class ServiceScheduledActionAtArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Designates either the start or the end of the scheduled action. Can be `support_hours_start` or `support_hours_end`.
               ...
               ```
        :param pulumi.Input[_builtins.str] type: The type of time specification. Currently, this must be set to `named_time`.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if type is not None:
...
class ServiceSupportHoursArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] days_of_weeks: Array of days of week as integers. `1` to `7`, `1` being
               Monday and `7` being Sunday.
        :param pulumi.Input[_builtins.str] end_time: The support hours' ending time of day.
        :param pulumi.Input[_builtins.str] start_time: The support hours' starting time of day.
        :param pulumi.Input[_builtins.str] time_zone: The time zone for the support hours.
        :param pulumi.Input[_builtins.str] type: The type of support hours. Can be `fixed_time_per_day`.
        """
...
class SlackConnectionConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] events: A list of strings to filter events by PagerDuty event type. `"incident.triggered"` is required. The follow event types are also possible:
               ...
               - `incident.status_update_published`
               - `incident.reopened`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] priorities: Allows you to filter events by priority. Needs to be an array of PagerDuty priority IDs. Available through get_priority data source.
               - When omitted or set to an empty array (`[]`) in the configuration for a Slack Connection, its default behavior is to set `priorities` to `No Priority` value.
               - When set to `["*"]` its corresponding value for `priorities` in Slack Connection's configuration will be `Any Priority`.
        :param pulumi.Input[_builtins.str] urgency: Allows you to filter events by urgency. Either `high`, `low` or `null` for Any urgency. Default is `null`.
        """
        pulumi.set(__self__, "events", events)
        if priorities is not None:
            pulumi.set(__self__, "priorities", priorities)
...
class UserHandoffNotificationRuleContactMethodArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: The ID of the contact method.
        :param pulumi.Input[_builtins.str] type: The type of the contact method. May be (`email_contact_method`, `email_contact_method_reference`, `phone_contact_method`, `phone_contact_method_reference`, `push_notification_contact_method`, `push_notification_contact_method_reference`, `sms_contact_method`, `sms_contact_method_reference`).
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
class WebhookSubscriptionDeliveryMethodArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Indicates the type of the delivery method. Allowed and default value: `http_delivery_method`.
        :param pulumi.Input[_builtins.str] url: The destination URL for webhook delivery.
        """
...
class GetAlertGroupingSettingConfigArgs:
    ...
    @aggregate.setter
    def aggregate(self, value: _builtins.str):
        pulumi.set(self, "aggregate", value)
    ...
    @fields.setter
    def fields(self, value: Sequence[_builtins.str]):
        pulumi.set(self, "fields", value)
    ...
    @iag_fields.setter
    def iag_fields(self, value: Sequence[_builtins.str]):
        pulumi.set(self, "iag_fields", value)
    ...
    @time_window.setter
    def time_window(self, value: _builtins.int):
        pulumi.set(self, "time_window", value)
...
class GetEventOrchestrationIntegrationDetailParameterArgs:
    ...
    @routing_key.setter
    def routing_key(self, value: _builtins.str):
        pulumi.set(self, "routing_key", value)
