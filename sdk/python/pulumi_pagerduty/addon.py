...
class AddonArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] src: The source URL to display in a frame in the PagerDuty UI. `HTTPS` is required.
        :param pulumi.Input[builtins.str] name: The name of the add-on.
        """
...
class Addon(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            src: Optional[pulumi.Input[builtins.str]] = None) -> 'Addon':
        """
    ...
    @property
    @pulumi.getter
    def src(self) -> pulumi.Output[builtins.str]:
        """
        The source URL to display in a frame in the PagerDuty UI. `HTTPS` is required.
        """
        return pulumi.get(self, "src")
