...
class AlertGroupingSettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] services: [Updating can cause a resource replacement] The list IDs of services associated to this setting.
        :param pulumi.Input[builtins.str] type: The type of alert grouping; one of `intelligent`, `time`, `content_based` or  `content_based_intelligent`.
        :param pulumi.Input['AlertGroupingSettingConfigArgs'] config: The set of values used for configuration.
        :param pulumi.Input[builtins.str] description: A human-friendly text to describe and identify this alert grouping setting.
        :param pulumi.Input[builtins.str] name: The name for the alert groupig settings.
        """
...
class AlertGroupingSetting(pulumi.CustomResource):
    ...
    pulumi_type = "pagerduty:index/alertGroupingSetting:AlertGroupingSetting"
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            services: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'AlertGroupingSetting':
        """
