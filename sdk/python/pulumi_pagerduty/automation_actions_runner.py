...
class AutomationActionsRunnerArgs:
    def __init__(__self__, *,
                 ...
                 runbook_api_key: Optional[pulumi.Input[builtins.str]] = None,
                 runbook_base_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AutomationActionsRunner resource.
        :param pulumi.Input[builtins.str] runner_type: The type of runner. The only allowed values is `runbook`.
        :param pulumi.Input[builtins.str] description: The description of the runner. Max length is 1024 characters.
        :param pulumi.Input[builtins.str] last_seen: (Optional) The last time runner has been seen. Represented as an ISO 8601 timestamp.
        :param pulumi.Input[builtins.str] name: The name of the runner. Max length is 255 characters.
        :param pulumi.Input[builtins.str] runbook_api_key: The unique User API Token created in Runbook Automation.
        :param pulumi.Input[builtins.str] runbook_base_uri: The subdomain for your Runbook Automation Instance.
        """
    ...
    def runbook_api_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def runbook_api_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "runbook_api_key", value)

    @property
    @pulumi.getter(name="runbookBaseUri")
    def runbook_base_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def runbook_base_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AutomationActionsRunnerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] creation_time: The time runner was created. Represented as an ISO 8601 timestamp.
        :param pulumi.Input[builtins.str] description: The description of the runner. Max length is 1024 characters.
        :param pulumi.Input[builtins.str] last_seen: (Optional) The last time runner has been seen. Represented as an ISO 8601 timestamp.
        :param pulumi.Input[builtins.str] name: The name of the runner. Max length is 255 characters.
        :param pulumi.Input[builtins.str] runbook_api_key: The unique User API Token created in Runbook Automation.
        :param pulumi.Input[builtins.str] runbook_base_uri: The subdomain for your Runbook Automation Instance.
        :param pulumi.Input[builtins.str] runner_type: The type of runner. The only allowed values is `runbook`.
        :param pulumi.Input[builtins.str] type: The type of object. The value returned will be `runner`.
        """
...
class AutomationActionsRunner(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            runbook_base_uri: Optional[pulumi.Input[builtins.str]] = None,
            runner_type: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'AutomationActionsRunner':
        """
    ...
    @property
    @pulumi.getter(name="lastSeen")
    def last_seen(self) -> pulumi.Output[builtins.str]:
        """
        (Optional) The last time runner has been seen. Represented as an ISO 8601 timestamp.
        """
        return pulumi.get(self, "last_seen")
    ...
    @property
    @pulumi.getter(name="runbookApiKey")
    def runbook_api_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The unique User API Token created in Runbook Automation.
        """
        return pulumi.get(self, "runbook_api_key")
    ...
    @property
    @pulumi.getter(name="runbookBaseUri")
    def runbook_base_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The subdomain for your Runbook Automation Instance.
        """
        return pulumi.get(self, "runbook_base_uri")
