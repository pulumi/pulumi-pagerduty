...
class AutomationActionsRunnerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the runner. Max length is 255 characters.
        :param pulumi.Input[_builtins.str] runbook_api_key: The unique User API Token created in Runbook Automation.
        :param pulumi.Input[_builtins.str] runbook_base_uri: The subdomain for your Runbook Automation Instance.
        """
...
class _AutomationActionsRunnerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] runbook_base_uri: The subdomain for your Runbook Automation Instance.
        :param pulumi.Input[_builtins.str] runner_type: The type of runner. The only allowed values is `runbook`.
        :param pulumi.Input[_builtins.str] type: The type of object. The value returned will be `runner`.
        """
...
class AutomationActionsRunner(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="runbookApiKey")
    def runbook_api_key(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The unique User API Token created in Runbook Automation.
        """
        return pulumi.get(self, "runbook_api_key")
    ...
    @_builtins.property
    @pulumi.getter(name="runbookBaseUri")
    def runbook_base_uri(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The subdomain for your Runbook Automation Instance.
        """
        return pulumi.get(self, "runbook_base_uri")
