...
class AutomationActionsRunnerTeamAssociationArgs:
    def __init__(__self__, *,
                 runner_id: pulumi.Input[builtins.str],
                 team_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a AutomationActionsRunnerTeamAssociation resource.
        :param pulumi.Input[builtins.str] runner_id: Id of the runner.
        :param pulumi.Input[builtins.str] team_id: Id of the team associated with the runner.
        """
    ...
    def runner_id(self) -> pulumi.Input[builtins.str]:
        """
        Id of the runner.
        """
    ...
    @runner_id.setter
    def runner_id(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("pagerduty:index/automationActionsRunnerTeamAssociation:AutomationActionsRunnerTeamAssociation")
class AutomationActionsRunnerTeamAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            runner_id: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AutomationActionsRunnerTeamAssociation':
        """
    ...
    @property
    @pulumi.getter(name="runnerId")
    def runner_id(self) -> pulumi.Output[builtins.str]:
        """
        Id of the runner.
        """
        return pulumi.get(self, "runner_id")
