...
class BusinessServiceSubscriberArgs:
    def __init__(__self__, *,
                 business_service_id: pulumi.Input[builtins.str],
                 subscriber_id: pulumi.Input[builtins.str],
                 subscriber_type: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a BusinessServiceSubscriber resource.
        :param pulumi.Input[builtins.str] business_service_id: The ID of the business service to subscribe to.
        :param pulumi.Input[builtins.str] subscriber_id: The ID of the subscriber entity.
        :param pulumi.Input[builtins.str] subscriber_type: Type of subscriber entity in the subscriber assignment. Possible values can be `user` and `team`.
        """
    ...
    def business_service_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def business_service_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "business_service_id", value)

    @property
    @pulumi.getter(name="subscriberId")
    def subscriber_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def subscriber_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "subscriber_id", value)

    @property
    @pulumi.getter(name="subscriberType")
    def subscriber_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def subscriber_type(self, value: pulumi.Input[builtins.str]):
...
class _BusinessServiceSubscriberState:
    def __init__(__self__, *,
                 business_service_id: Optional[pulumi.Input[builtins.str]] = None,
                 subscriber_id: Optional[pulumi.Input[builtins.str]] = None,
                 subscriber_type: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="businessServiceId")
    def business_service_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the business service to subscribe to.
        """
        return pulumi.get(self, "business_service_id")
    ...
    @business_service_id.setter
    def business_service_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "business_service_id", value)

    @property
    @pulumi.getter(name="subscriberId")
    def subscriber_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the subscriber entity.
        """
        return pulumi.get(self, "subscriber_id")
    ...
    @subscriber_id.setter
    def subscriber_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "subscriber_id", value)

    @property
    @pulumi.getter(name="subscriberType")
    def subscriber_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Type of subscriber entity in the subscriber assignment. Possible values can be `user` and `team`.
        """
        return pulumi.get(self, "subscriber_type")
    ...
    @subscriber_type.setter
    def subscriber_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "subscriber_type", value)
...
class BusinessServiceSubscriber(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            business_service_id: Optional[pulumi.Input[builtins.str]] = None,
            subscriber_id: Optional[pulumi.Input[builtins.str]] = None,
            subscriber_type: Optional[pulumi.Input[builtins.str]] = None) -> 'BusinessServiceSubscriber':
        """
    ...
    @property
    @pulumi.getter(name="businessServiceId")
    def business_service_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the business service to subscribe to.
        """
        return pulumi.get(self, "business_service_id")
    ...
    @property
    @pulumi.getter(name="subscriberId")
    def subscriber_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the subscriber entity.
        """
        return pulumi.get(self, "subscriber_id")
    ...
    @property
    @pulumi.getter(name="subscriberType")
    def subscriber_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of subscriber entity in the subscriber assignment. Possible values can be `user` and `team`.
        """
        return pulumi.get(self, "subscriber_type")
