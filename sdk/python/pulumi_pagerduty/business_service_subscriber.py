...
class BusinessServiceSubscriberArgs:
    def __init__(__self__, *,
                 business_service_id: pulumi.Input[_builtins.str],
    ...
    def business_service_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def business_service_id(self, value: pulumi.Input[_builtins.str]):
    ...
    def subscriber_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def subscriber_type(self, value: pulumi.Input[_builtins.str]):
...
class BusinessServiceSubscriber(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="businessServiceId")
    def business_service_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the business service to subscribe to.
        """
        return pulumi.get(self, "business_service_id")
    ...
    @_builtins.property
    @pulumi.getter(name="subscriberType")
    def subscriber_type(self) -> pulumi.Output[_builtins.str]:
        """
        Type of subscriber entity in the subscriber assignment. Possible values can be `user` and `team`.
        """
        return pulumi.get(self, "subscriber_type")
