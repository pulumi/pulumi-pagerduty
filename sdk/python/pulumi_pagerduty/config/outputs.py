...
class UseAppOauthScopedToken(dict):
    def __init__(__self__, *,
                 pd_client_id: Optional[builtins.str] = None,
                 pd_client_secret: Optional[builtins.str] = None,
                 pd_subdomain: Optional[builtins.str] = None):
