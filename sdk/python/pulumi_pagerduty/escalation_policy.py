...
class EscalationPolicyArgs:
    def __init__(__self__, *,
                 ...
                 teams: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] description: A human-friendly description of the escalation policy.
               If not set, a placeholder of "Managed by Pulumi" will be set.
        :param pulumi.Input[builtins.str] name: The name of the escalation policy.
        ...
        :param pulumi.Input[builtins.str] teams: Team associated with the policy (Only 1 team can be assigned to an Escalation Policy). Account must have the `teams` ability to use this parameter.
        """
    ...
    @property
    @pulumi.getter
    def teams(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @teams.setter
    def teams(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EscalationPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            num_loops: Optional[pulumi.Input[builtins.int]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EscalationPolicyRuleArgs', 'EscalationPolicyRuleArgsDict']]]]] = None,
            teams: Optional[pulumi.Input[builtins.str]] = None) -> 'EscalationPolicy':
        """
    ...
    @property
    @pulumi.getter(name="numLoops")
    def num_loops(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of times the escalation policy will repeat after reaching the end of its escalation.
        """
        return pulumi.get(self, "num_loops")
    ...
    @property
    @pulumi.getter
    def teams(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Team associated with the policy (Only 1 team can be assigned to an Escalation Policy). Account must have the `teams` ability to use this parameter.
        """
        return pulumi.get(self, "teams")
