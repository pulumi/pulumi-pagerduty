...
class EventOrchestrationIntegrationInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] event_orchestration: ID of the Event Orchestration to which this Integration belongs to. If value is changed, current Integration is associated with a newly provided ID.
        :param pulumi.Input[builtins.str] label: Name/description of the Integration.
        """
...
class EventOrchestrationIntegration(pulumi.CustomResource):
    ...
    pulumi_type = "pagerduty:index/eventOrchestrationIntegration:EventOrchestrationIntegration"
