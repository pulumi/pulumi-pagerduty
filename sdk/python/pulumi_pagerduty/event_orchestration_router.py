...
class EventOrchestrationRouterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] event_orchestration: ID of the Event Orchestration to which the Router belongs.
...
class EventOrchestrationRouter(pulumi.CustomResource):
    ...
    pulumi_type = "pagerduty:index/eventOrchestrationRouter:EventOrchestrationRouter"
