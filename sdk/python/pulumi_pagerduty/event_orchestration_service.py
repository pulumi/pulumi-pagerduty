...
class EventOrchestrationServiceArgs:
    def __init__(__self__, *,
                 ...
                 enable_event_orchestration_for_service: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] service: ID of the Service to which this Service Orchestration belongs to.
        ...
        :param pulumi.Input[builtins.bool] enable_event_orchestration_for_service: Opt-in/out for switching the Service to [Service Orchestrations](https://support.pagerduty.com/docs/event-orchestration#service-orchestrations).
        """
    ...
    def enable_event_orchestration_for_service(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_event_orchestration_for_service(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("pagerduty:index/eventOrchestrationService:EventOrchestrationService")
class EventOrchestrationService(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableEventOrchestrationForService")
    def enable_event_orchestration_for_service(self) -> pulumi.Output[builtins.bool]:
        """
        Opt-in/out for switching the Service to [Service Orchestrations](https://support.pagerduty.com/docs/event-orchestration#service-orchestrations).
        """
        return pulumi.get(self, "enable_event_orchestration_for_service")
