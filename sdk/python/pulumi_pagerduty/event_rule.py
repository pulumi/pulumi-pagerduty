...
class EventRuleArgs:
    def __init__(__self__, *,
                 action_json: pulumi.Input[builtins.str],
                 condition_json: pulumi.Input[builtins.str],
                 advanced_condition_json: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EventRule resource.
        :param pulumi.Input[builtins.str] action_json: A list of one or more actions for each rule. Each action within the list is itself a list.
        :param pulumi.Input[builtins.str] condition_json: Contains a list of conditions. The first field in the list is `and` or `or`, followed by a list of operators and values.
        :param pulumi.Input[builtins.str] advanced_condition_json: Contains a list of specific conditions including `active-between`,`scheduled-weekly`, and `frequency-over`. The first element in the list is the label for the condition, followed by a list of values for the specific condition. For more details on these conditions see [Advanced Condition](https://developer.pagerduty.com/docs/rest-api-v2/global-event-rules-api/#advanced-condition-parameter) in the PagerDuty API documentation.
        """
    ...
    def action_json(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @action_json.setter
    def action_json(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "action_json", value)

    @property
    @pulumi.getter(name="conditionJson")
    def condition_json(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def condition_json(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "condition_json", value)

    @property
    @pulumi.getter(name="advancedConditionJson")
    def advanced_condition_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def advanced_condition_json(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EventRuleState:
    def __init__(__self__, *,
                 action_json: Optional[pulumi.Input[builtins.str]] = None,
                 advanced_condition_json: Optional[pulumi.Input[builtins.str]] = None,
                 catch_all: Optional[pulumi.Input[builtins.bool]] = None,
                 condition_json: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering EventRule resources.
        :param pulumi.Input[builtins.str] action_json: A list of one or more actions for each rule. Each action within the list is itself a list.
        :param pulumi.Input[builtins.str] advanced_condition_json: Contains a list of specific conditions including `active-between`,`scheduled-weekly`, and `frequency-over`. The first element in the list is the label for the condition, followed by a list of values for the specific condition. For more details on these conditions see [Advanced Condition](https://developer.pagerduty.com/docs/rest-api-v2/global-event-rules-api/#advanced-condition-parameter) in the PagerDuty API documentation.
        :param pulumi.Input[builtins.bool] catch_all: A boolean that indicates whether the rule is a catch-all for the account. This field is read-only through the PagerDuty API.
        :param pulumi.Input[builtins.str] condition_json: Contains a list of conditions. The first field in the list is `and` or `or`, followed by a list of operators and values.
        """
    ...
    @property
    @pulumi.getter(name="actionJson")
    def action_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A list of one or more actions for each rule. Each action within the list is itself a list.
        """
        return pulumi.get(self, "action_json")
    ...
    @action_json.setter
    def action_json(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "action_json", value)
    ...
    def catch_all(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @catch_all.setter
    def catch_all(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class EventRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            advanced_condition_json: Optional[pulumi.Input[builtins.str]] = None,
            catch_all: Optional[pulumi.Input[builtins.bool]] = None,
            condition_json: Optional[pulumi.Input[builtins.str]] = None) -> 'EventRule':
        """
    ...
    @property
    @pulumi.getter(name="actionJson")
    def action_json(self) -> pulumi.Output[builtins.str]:
        """
        A list of one or more actions for each rule. Each action within the list is itself a list.
        """
        return pulumi.get(self, "action_json")
    ...
    @property
    @pulumi.getter(name="advancedConditionJson")
    def advanced_condition_json(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Contains a list of specific conditions including `active-between`,`scheduled-weekly`, and `frequency-over`. The first element in the list is the label for the condition, followed by a list of values for the specific condition. For more details on these conditions see [Advanced Condition](https://developer.pagerduty.com/docs/rest-api-v2/global-event-rules-api/#advanced-condition-parameter) in the PagerDuty API documentation.
        """
        return pulumi.get(self, "advanced_condition_json")
    ...
    @property
    @pulumi.getter(name="catchAll")
    def catch_all(self) -> pulumi.Output[builtins.bool]:
        """
        A boolean that indicates whether the rule is a catch-all for the account. This field is read-only through the PagerDuty API.
        """
        return pulumi.get(self, "catch_all")
    ...
    @property
    @pulumi.getter(name="conditionJson")
    def condition_json(self) -> pulumi.Output[builtins.str]:
        """
        Contains a list of conditions. The first field in the list is `and` or `or`, followed by a list of operators and values.
        """
        return pulumi.get(self, "condition_json")
