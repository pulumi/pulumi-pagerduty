...
class GetAutomationActionsActionResult:
    ...
    def allow_invocation_from_event_orchestration(self) -> builtins.bool:
        """
    ...
    def allow_invocation_manually(self) -> builtins.bool:
        """
    ...
    def map_to_all_services(self) -> builtins.bool:
        """
    ...
    def only_invocable_on_unresolved_incidents(self) -> builtins.bool:
        """
...
def get_automation_actions_action(action_classification: Optional[builtins.str] = None,
                                  allow_invocation_from_event_orchestration: Optional[builtins.bool] = None,
                                  allow_invocation_manually: Optional[builtins.bool] = None,
                                  creation_time: Optional[builtins.str] = None,
                                  description: Optional[builtins.str] = None,
                                  id: Optional[builtins.str] = None,
                                  map_to_all_services: Optional[builtins.bool] = None,
                                  modify_time: Optional[builtins.str] = None,
                                  only_invocable_on_unresolved_incidents: Optional[builtins.bool] = None,
                                  runner_id: Optional[builtins.str] = None,
                                  runner_type: Optional[builtins.str] = None,
    ...
    :param builtins.str action_classification: (Optional) The category of the action. The only allowed values are `diagnostic` and `remediation`.
    :param builtins.bool allow_invocation_from_event_orchestration: (Optional) Whether or not the action can be invoked automatically from a PagerDuty Event Orchestration.
    :param builtins.bool allow_invocation_manually: (Optional) Whether or not the action can be invoked manually by a user on the PagerDuty website.
    :param builtins.str creation_time: The time action was created. Represented as an ISO 8601 timestamp.
    :param builtins.str description: (Optional) The description of the action.
    :param builtins.str id: The id of the automation actions action in the PagerDuty API.
    :param builtins.bool map_to_all_services: (Optional) If the action should be able to be run against all services or just specified ones.
    :param builtins.str modify_time: (Optional) The last time action has been modified. Represented as an ISO 8601 timestamp.
    :param builtins.bool only_invocable_on_unresolved_incidents: (Optional) Whether or not the action can be invoked on unresolved incidents.
    :param builtins.str runner_id: (Optional) The Process Automation Actions runner to associate the action with.
    :param builtins.str runner_type: (Optional) The type of the runner associated with the action.
    :param builtins.str type: The type of object. The value returned will be `action`.
    """
    __args__ = dict()
...
def get_automation_actions_action_output(action_classification: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         allow_invocation_from_event_orchestration: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         allow_invocation_manually: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         creation_time: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         id: Optional[pulumi.Input[builtins.str]] = None,
                                         map_to_all_services: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         modify_time: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         only_invocable_on_unresolved_incidents: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         runner_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         runner_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
