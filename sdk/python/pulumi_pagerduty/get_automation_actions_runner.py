...
class GetAutomationActionsRunnerResult:
    ...
    def runbook_base_uri(self) -> _builtins.str:
        """
...
def get_automation_actions_runner(description: Optional[_builtins.str] = None,
                                  id: Optional[_builtins.str] = None,
                                  last_seen: Optional[_builtins.str] = None,
                                  runbook_base_uri: Optional[_builtins.str] = None,
    ...
    :param _builtins.str description: (Optional) The description of the runner.
    :param _builtins.str id: The id of the automation actions runner in the PagerDuty API.
    :param _builtins.str last_seen: (Optional) The last time runner has been seen. Represented as an ISO 8601 timestamp.
    :param _builtins.str runbook_base_uri: (Optional) The base URI of the Runbook server to connect to. Applicable to `runbook` type runners only.
    """
    __args__ = dict()
