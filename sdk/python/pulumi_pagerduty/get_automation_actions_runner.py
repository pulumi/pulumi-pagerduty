...
def get_automation_actions_runner(description: Optional[builtins.str] = None,
                                  id: Optional[builtins.str] = None,
                                  last_seen: Optional[builtins.str] = None,
                                  runbook_base_uri: Optional[builtins.str] = None,
    ...
    :param builtins.str description: (Optional) The description of the runner.
    :param builtins.str id: The id of the automation actions runner in the PagerDuty API.
    :param builtins.str last_seen: (Optional) The last time runner has been seen. Represented as an ISO 8601 timestamp.
    :param builtins.str runbook_base_uri: (Optional) The base URI of the Runbook server to connect to. Applicable to `runbook` type runners only.
    """
    __args__ = dict()
...
def get_automation_actions_runner_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         id: Optional[pulumi.Input[builtins.str]] = None,
                                         last_seen: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         runbook_base_uri: Optional[pulumi.Input[Optional[builtins.str]]] = None,
