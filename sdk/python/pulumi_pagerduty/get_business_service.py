...
def get_business_service(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The business service name to use to find a business service in the PagerDuty API.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_business_service_output(name: Optional[pulumi.Input[builtins.str]] = None,
