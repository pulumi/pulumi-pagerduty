...
def get_event_orchestration_integration(event_orchestration: Optional[builtins.str] = None,
    ...
    :param builtins.str event_orchestration: ID of the Event Orchestration to which this Integration belongs.
    :param builtins.str id: ID of the Integration associated with the Event Orchestration. Specify either `id` or `label`. If both are specified `id` takes precedence.
    :param builtins.str label: Name/description of the Integration associated with the Event Orchestration. Specify either `id` or `label`. If both are specified `id` takes precedence. The value of `label` is not unique. Potentially there might be multiple Integrations with the same `label` value associated with the Event Orchestration and retrieving data by `label` attribute will result in an error during the planning step.
    """
    __args__ = dict()
...
def get_event_orchestration_integration_output(event_orchestration: Optional[pulumi.Input[builtins.str]] = None,
