...
def get_event_orchestration_service_cache_variable(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: ID of the Cache Variable associated with the Service Event Orchestration. Specify either `id` or `name`. If both are specified `id` takes precedence.
    :param _builtins.str name: Name of the Cache Variable associated with the Service Event Orchestration. Specify either `id` or `name`. If both are specified `id` takes precedence.
    :param _builtins.str service: ID of the Service Event Orchestration to which this Cache Variable belongs.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_event_orchestration_service_cache_variable_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
