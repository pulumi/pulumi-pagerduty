...
def get_event_orchestrations(name_filter: Optional[builtins.str] = None,
    ...
    :param builtins.str name_filter: The regex name of Global Event Orchestrations to find in the PagerDuty API.
    """
    __args__ = dict()
...
def get_event_orchestrations_output(name_filter: Optional[pulumi.Input[builtins.str]] = None,
