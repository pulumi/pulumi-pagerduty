...
def get_license(description: Optional[_builtins.str] = None,
    ...
    :param _builtins.str description: Used to determine if the data config *description* is a valid substring of a valid license description assigned to the account.
    :param _builtins.str id: Used to match the data config *id* with an exact match of a valid license ID assigned to the account.
    :param _builtins.str name: Used to determine if the data config *name* is a valid substring of a valid license name assigned to the account.
    """
    __args__ = dict()
