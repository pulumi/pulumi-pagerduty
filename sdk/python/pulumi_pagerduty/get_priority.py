...
def get_priority(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the priority to find in the PagerDuty API.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_priority_output(name: Optional[pulumi.Input[builtins.str]] = None,
