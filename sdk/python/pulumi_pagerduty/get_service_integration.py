...
class GetServiceIntegrationResult:
    ...
    def integration_summary(self) -> _builtins.str:
...
def get_service_integration(integration_summary: Optional[_builtins.str] = None,
    ...
    :param _builtins.str integration_summary: The integration summary used to find the desired integration on the service.
    :param _builtins.str service_name: The service name to use to find a service in the PagerDuty API.
    """
    __args__ = dict()
