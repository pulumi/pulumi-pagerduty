...
def get_standards_resources_scores(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: List of identifiers of the resources to query.
...
def get_standards_resources_scores_output(ids: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
