...
def get_tag(label: Optional[builtins.str] = None,
    ...
    :param builtins.str label: The label of the tag to find in the PagerDuty API.
    """
    __args__ = dict()
...
def get_tag_output(label: Optional[pulumi.Input[builtins.str]] = None,
