...
def get_team(default_role: Optional[_builtins.str] = None,
    ...
    :param _builtins.str default_role: (Optional) The team is private if the value is "none", or public if it is "manager" (the default permissions for a non-member of the team are either "none", or their base role up until "manager").
    :param _builtins.str name: The name of the team to find in the PagerDuty API.
    :param _builtins.str parent: ID of the parent team. This is available to accounts with the Team Hierarchy feature enabled. Please contact your account manager for more information.
    """
    __args__ = dict()
