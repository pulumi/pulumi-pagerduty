...
def get_team_members(team_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str team_id: The ID of the team to find in the PagerDuty API.
    """
    __args__ = dict()
...
def get_team_members_output(team_id: Optional[pulumi.Input[_builtins.str]] = None,
