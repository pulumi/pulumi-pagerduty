...
def get_teams(query: Optional[builtins.str] = None,
    ...
    :param builtins.str query: Filters the result, showing only the records whose name matches the query.
    """
    __args__ = dict()
...
def get_teams_output(query: Optional[pulumi.Input[Optional[builtins.str]]] = None,
