...
class GetUserContactMethodResult:
    ...
    @_builtins.property
    @pulumi.getter
    def blacklisted(self) -> _builtins.bool:
        """
    ...
    def country_code(self) -> _builtins.int:
        """
    ...
    def send_short_email(self) -> _builtins.bool:
        """
...
def get_user_contact_method(label: Optional[_builtins.str] = None,
