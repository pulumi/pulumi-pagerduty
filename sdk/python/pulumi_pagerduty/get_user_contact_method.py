...
class GetUserContactMethodResult:
    ...
    @property
    @pulumi.getter
    def blacklisted(self) -> builtins.bool:
        """
    ...
    def country_code(self) -> builtins.int:
        """
    ...
    def send_short_email(self) -> builtins.bool:
        """
...
def get_user_contact_method(label: Optional[builtins.str] = None,
    ...
    :param builtins.str label: The label (e.g., "Work", "Mobile", "Ashley's iPhone", etc.).
    :param builtins.str type: The contact method type. May be (`email_contact_method`, `phone_contact_method`, `sms_contact_method`, `push_notification_contact_method`).
...
def get_user_contact_method_output(label: Optional[pulumi.Input[builtins.str]] = None,
