...
class GetUsersResult:
    ...
    def team_ids(self) -> Optional[Sequence[builtins.str]]:
...
def get_users(team_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] team_ids: List of team IDs. Only results related to these teams will be returned. Account must have the `teams` ability to use this parameter.
    """
    __args__ = dict()
...
def get_users_output(team_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
