...
class GetUsersResult:
    ...
    def team_ids(self) -> Optional[Sequence[_builtins.str]]:
...
def get_users(team_ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] team_ids: List of team IDs. Only results related to these teams will be returned. Account must have the `teams` ability to use this parameter.
    """
    __args__ = dict()
