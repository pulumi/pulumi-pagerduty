...
def get_vendor(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The vendor name to use to find a vendor in the PagerDuty API.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_vendor_output(name: Optional[pulumi.Input[_builtins.str]] = None,
