...
class IncidentCustomFieldArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_type: The data type of the field. Must be one of `string`, `integer`, `float`, `boolean`, `datetime`, or `url`.
        :param pulumi.Input[builtins.str] display_name: The display name of the field.
        :param pulumi.Input[builtins.str] field_type: The field type of the field. Must be one of `single_value`, `single_value_fixed`, `multi_value`, or `multi_value_fixed`.
        ...
        :param pulumi.Input[builtins.str] description: The description of the field.
...
@pulumi.type_token("pagerduty:index/incidentCustomField:IncidentCustomField")
class IncidentCustomField(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            display_name: Optional[pulumi.Input[builtins.str]] = None,
            field_type: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'IncidentCustomField':
        """
