...
class IncidentCustomFieldOptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_type: The datatype of the field option. Only `string` is allowed here at present.
        :param pulumi.Input[builtins.str] field: The ID of the field.
        :param pulumi.Input[builtins.str] value: The allowed value.
        """
...
class IncidentCustomFieldOption(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            data_type: Optional[pulumi.Input[builtins.str]] = None,
            field: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'IncidentCustomFieldOption':
        """
