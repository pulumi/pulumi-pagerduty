...
class IncidentTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the Incident Type. Usage of the suffix `_default` is prohibited. This cannot be changed once the incident type has been created.
        """
...
class _IncidentTypeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the Incident Type. Usage of the suffix `_default` is prohibited. This cannot be changed once the incident type has been created.
        :param pulumi.Input[_builtins.str] parent_type: The parent type of the Incident Type. Either name or id of the parent type can be used.
        :param pulumi.Input[_builtins.str] type: A string that determines the schema of the object.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    @_builtins.property
    @pulumi.getter(name="parentType")
    def parent_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The parent type of the Incident Type. Either name or id of the parent type can be used.
        """
        return pulumi.get(self, "parent_type")
    ...
    @parent_type.setter
    def parent_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "parent_type", value)
...
class IncidentType(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            parent_type: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'IncidentType':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="parentType")
    def parent_type(self) -> pulumi.Output[_builtins.str]:
        """
        The parent type of the Incident Type. Either name or id of the parent type can be used.
        """
        return pulumi.get(self, "parent_type")
