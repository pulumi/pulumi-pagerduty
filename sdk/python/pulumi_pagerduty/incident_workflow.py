...
class IncidentWorkflowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] is_enabled: Indicates whether the Incident Workflow is enabled or not. Disabled workflows will not be triggered, and will not count toward the account's enabled workflow limit.
        ...
        :param pulumi.Input[builtins.str] team: A team ID. If specified then workflow edit permissions will be scoped to members of this team.
        """
...
class IncidentWorkflow(pulumi.CustomResource):
    ...
    pulumi_type = "pagerduty:index/incidentWorkflow:IncidentWorkflow"
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            steps: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IncidentWorkflowStepArgs', 'IncidentWorkflowStepArgsDict']]]]] = None,
            team: Optional[pulumi.Input[builtins.str]] = None) -> 'IncidentWorkflow':
        """
    ...
    @property
    @pulumi.getter(name="isEnabled")
    def is_enabled(self) -> pulumi.Output[builtins.str]:
        """
        Indicates whether the Incident Workflow is enabled or not. Disabled workflows will not be triggered, and will not count toward the account's enabled workflow limit.
        """
        return pulumi.get(self, "is_enabled")
