...
class IncidentWorkflowTriggerArgs:
    def __init__(__self__, *,
                 subscribed_to_all_services: pulumi.Input[builtins.bool],
                 type: pulumi.Input[builtins.str],
                 workflow: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.bool] subscribed_to_all_services: Set to `true` if the trigger should be eligible for firing on all services. Only allowed to be `true` if the services list is not defined or empty.
        :param pulumi.Input[builtins.str] type: [Updating causes resource replacement] May be either `manual` or `conditional`.
        :param pulumi.Input[builtins.str] workflow: The workflow ID for the workflow to trigger.
        :param pulumi.Input[builtins.str] condition: A [PCL](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview) condition string which must be satisfied for the trigger to fire.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] services: A list of service IDs. Incidents in any of the listed services are eligible to fire this trigger.
        """
    ...
    def subscribed_to_all_services(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def subscribed_to_all_services(self, value: pulumi.Input[builtins.bool]):
    ...
    @property
    @pulumi.getter
    def workflow(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @workflow.setter
    def workflow(self, value: pulumi.Input[builtins.str]):
...
class _IncidentWorkflowTriggerState:
    def __init__(__self__, *,
                 ...
                 permissions: Optional[pulumi.Input['IncidentWorkflowTriggerPermissionsArgs']] = None,
                 services: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 subscribed_to_all_services: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="subscribedToAllServices")
    def subscribed_to_all_services(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Set to `true` if the trigger should be eligible for firing on all services. Only allowed to be `true` if the services list is not defined or empty.
        """
        return pulumi.get(self, "subscribed_to_all_services")
    ...
    @subscribed_to_all_services.setter
    def subscribed_to_all_services(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "subscribed_to_all_services", value)
...
class IncidentWorkflowTrigger(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subscribed_to_all_services: Optional[pulumi.Input[builtins.bool]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            workflow: Optional[pulumi.Input[builtins.str]] = None) -> 'IncidentWorkflowTrigger':
        """
    ...
    @property
    @pulumi.getter(name="subscribedToAllServices")
    def subscribed_to_all_services(self) -> pulumi.Output[builtins.bool]:
        """
        Set to `true` if the trigger should be eligible for firing on all services. Only allowed to be `true` if the services list is not defined or empty.
        """
        return pulumi.get(self, "subscribed_to_all_services")
    ...
    @property
    @pulumi.getter
    def workflow(self) -> pulumi.Output[builtins.str]:
        """
        The workflow ID for the workflow to trigger.
        """
        return pulumi.get(self, "workflow")
