...
class MaintenanceWindowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] end_time: The maintenance window's end time. This is when the services will start creating incidents again. This date must be in the future and after the `start_time`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] services: A list of service IDs to include in the maintenance window.
        :param pulumi.Input[builtins.str] start_time: The maintenance window's start time. This is when the services will stop creating incidents. If this date is in the past, it will be updated to be the current time.
...
class MaintenanceWindow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            end_time: Optional[pulumi.Input[builtins.str]] = None,
            services: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            start_time: Optional[pulumi.Input[builtins.str]] = None) -> 'MaintenanceWindow':
        """
