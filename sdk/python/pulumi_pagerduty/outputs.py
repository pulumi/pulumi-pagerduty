...
class AlertGroupingSettingConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_window: Optional[builtins.int] = None,
        ...
        :param builtins.int timeout: The duration in seconds within which to automatically group incoming alerts. This setting is only required and applies when `type` is set to `time`. To continue grouping alerts until the incident is resolved leave this value unset or set it to `null`.
        """
    ...
    def time_window(self) -> Optional[builtins.int]:
        """
...
class AutomationActionsActionActionDataReference(dict):
    ...
    def __init__(__self__, *,
                 invocation_command: Optional[builtins.str] = None,
                 process_automation_job_arguments: Optional[builtins.str] = None,
                 process_automation_job_id: Optional[builtins.str] = None,
                 process_automation_node_filter: Optional[builtins.str] = None,
                 script: Optional[builtins.str] = None):
        """
        :param builtins.str invocation_command: The command to execute the script with.
        :param builtins.str process_automation_job_arguments: The arguments to pass to the Process Automation job execution.
        :param builtins.str process_automation_job_id: The ID of the Process Automation job to execute.
        :param builtins.str process_automation_node_filter: The expression that filters on which nodes a Process Automation Job executes [Learn more](https://docs.rundeck.com/docs/manual/05-nodes.html#node-filtering).
        :param builtins.str script: Body of the script to be executed on the Runner. Max length is 16777215 characters.
        """
    ...
    def invocation_command(self) -> Optional[builtins.str]:
        """
    ...
    def process_automation_job_arguments(self) -> Optional[builtins.str]:
        """
    ...
    def process_automation_job_id(self) -> Optional[builtins.str]:
        """
    ...
    def process_automation_node_filter(self) -> Optional[builtins.str]:
        """
...
class EscalationPolicyRule(dict):
    ...
    def __init__(__self__, *,
                 escalation_delay_in_minutes: builtins.int,
        ...
        """
        :param builtins.int escalation_delay_in_minutes: The number of minutes before an unacknowledged incident escalates away from this rule.
        ...
        :param builtins.str id: The ID of the escalation policy.
        """
    ...
    def escalation_delay_in_minutes(self) -> builtins.int:
        """
...
class EscalationPolicyRuleEscalationRuleAssignmentStrategy(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Can be `round_robin` or `assign_to_everyone`.
        """
        if type is not None:
...
class EscalationPolicyRuleTarget(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str id: A target ID
        :param builtins.str type: Can be `user_reference` or `schedule_reference`. Defaults to `user_reference`. For multiple users as example, repeat the target.
        """
        pulumi.set(__self__, "id", id)
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class EventOrchestrationGlobalCacheVariableCondition(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str expression: A [PCL condition](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview) string.
        """
...
class EventOrchestrationGlobalCacheVariableConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ttl_seconds: Optional[builtins.int] = None):
        """
        :param builtins.str type: The [type of value](https://support.pagerduty.com/docs/event-orchestration-variables) to store into the Cache Variable. Can be one of: `recent_value`, `trigger_event_count` or `external_data`.
        :param builtins.str data_type: The type of data that will eventually be set for the Cache Variable via an API request. This field is only used when type is `external_data`
        :param builtins.str regex: A [RE2 regular expression][4] that will be matched against the field specified via the `source` argument. This field is only used when `type` is `recent_value`
        :param builtins.str source: The path to the event field where the `regex` will be applied to extract a value. You can use any valid [PCL path](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview#paths). This field is only used when `type` is `recent_value`
        :param builtins.int ttl_seconds: The number of seconds indicating how long to count incoming trigger events for. This field is only used when `type` is `trigger_event_count` or `external_data`
        """
        pulumi.set(__self__, "type", type)
    ...
    def ttl_seconds(self) -> Optional[builtins.int]:
        """
...
class EventOrchestrationGlobalCatchAllActions(dict):
    ...
    def __init__(__self__, *,
                 annotate: Optional[builtins.str] = None,
                 automation_action: Optional['outputs.EventOrchestrationGlobalCatchAllActionsAutomationAction'] = None,
                 drop_event: Optional[builtins.bool] = None,
                 escalation_policy: Optional[builtins.str] = None,
                 event_action: Optional[builtins.str] = None,
                 ...
                 route_to: Optional[builtins.str] = None,
                 severity: Optional[builtins.str] = None,
                 suppress: Optional[builtins.bool] = None,
                 suspend: Optional[builtins.int] = None,
        ...
        :param builtins.str route_to: The ID of a Set from this Global Orchestration whose rules you also want to use with events that match this rule.
        :param builtins.str severity: sets Severity of the resulting alert. Allowed values are: `info`, `error`, `warning`, `critical`
        :param builtins.bool suppress: Set whether the resulting alert is suppressed. Suppressed alerts will not trigger an incident.
        :param builtins.int suspend: The number of seconds to suspend the resulting alert before triggering. This effectively pauses incident notifications. If a `resolve` event arrives before the alert triggers then PagerDuty won't create an incident for this alert.
    ...
    @property
    @pulumi.getter
    def annotate(self) -> Optional[builtins.str]:
        """
    ...
    def drop_event(self) -> Optional[builtins.bool]:
        """
    ...
    def escalation_policy(self) -> Optional[builtins.str]:
        """
    ...
    def event_action(self) -> Optional[builtins.str]:
        """
    ...
    def route_to(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def suppress(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def suspend(self) -> Optional[builtins.int]:
        """
...
class EventOrchestrationGlobalCatchAllActionsAutomationActionHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: Name to identify the header
        :param builtins.str value: Value of this header
        """
...
class EventOrchestrationGlobalCatchAllActionsAutomationActionParameter(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: Name to identify the parameter
        :param builtins.str value: Value of this parameter
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class EventOrchestrationGlobalCatchAllActionsExtraction(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str target: The PagerDuty Common Event Format [PD-CEF](https://support.pagerduty.com/docs/pd-cef) field that will be set with the value from the `template` or based on `regex` and `source` fields.
        :param builtins.str regex: A [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) that will be matched against field specified via the `source` argument. If the regex contains one or more capture groups, their values will be extracted and appended together. If it contains no capture groups, the whole match is used. This field can be ignored for `template` based extractions.
        :param builtins.str source: The path to the event field where the `regex` will be applied to extract a value. You can use any valid [PCL path](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview#paths) like `event.summary` and you can reference previously-defined variables using a path like `variables.hostname`. This field can be ignored for `template` based extractions.
        :param builtins.str template: A string that will be used to populate the `target` field. You can reference variables or event data within your template using double curly braces. For example:
...
class EventOrchestrationGlobalCatchAllActionsIncidentCustomFieldUpdate(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str id: The custom field id
        :param builtins.str value: The value to assign to this custom field
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "value", value)
...
class EventOrchestrationGlobalCatchAllActionsVariable(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str path: Path to a field in an event, in dot-notation. This supports both PagerDuty Common Event Format [PD-CEF](https://support.pagerduty.com/docs/pd-cef) and non-CEF fields. Eg: Use `event.summary` for the `summary` CEF field. Use `raw_event.fieldname` to read from the original event `fieldname` data. You can use any valid [PCL path](https://developer.pagerduty.com/docs/ZG9jOjM1NTE0MDc0-pcl-overview#paths).
        :param builtins.str type: Only `regex` is supported
        :param builtins.str value: The Regex expression to match against. Must use valid [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) syntax.
        """
        pulumi.set(__self__, "name", name)
...
class EventOrchestrationGlobalSet(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The ID of this set of rules. Rules in other sets can route events into this set using the rule's `route_to` property.
        """
        pulumi.set(__self__, "id", id)
...
class EventOrchestrationGlobalSetRule(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool disabled: Indicates whether the rule is disabled and would therefore not be evaluated.
        :param builtins.str id: The ID of the rule within the set.
        :param builtins.str label: A description of this rule's purpose.
        """
        pulumi.set(__self__, "actions", actions)
...
class EventOrchestrationRouterCatchAllActions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str route_to: Defines where an alert will be sent if doesn't match any rules. Can either be the ID of a Service _or_ the string `"unrouted"` to send events to the Unrouted Orchestration.
        """
        pulumi.set(__self__, "route_to", route_to)
...
class EventOrchestrationRouterSet(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: ID of the `start` set. Router supports only one set and it's id has to be `start`
        """
        pulumi.set(__self__, "id", id)
        if rules is not None:
            pulumi.set(__self__, "rules", rules)
...
class EventOrchestrationRouterSetRule(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool disabled: Indicates whether the rule is disabled and would therefore not be evaluated.
        :param builtins.str id: The ID of the rule within the `start` set.
        :param builtins.str label: A description of this rule's purpose.
        """
        pulumi.set(__self__, "actions", actions)
        if conditions is not None:
...
class EventOrchestrationRouterSetRuleActionsDynamicRouteTo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source: builtins.str):
        """
        :param builtins.str lookup_by: Indicates whether the extracted value from the source is a service's name or ID. Allowed values are: `service_name`, `service_id`
        ...
        :param builtins.str regex: The regular expression, used to extract a value from the source field. Must use valid [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) syntax.
        :param builtins.str source: The path to a field in an event.
        """
...
class EventOrchestrationUnroutedCatchAllActionsVariable(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the variable
        :param builtins.str path: Path to a field in an event, in dot-notation. This supports both [PD-CEF](https://support.pagerduty.com/docs/pd-cef) and non-CEF fields. Eg: Use `event.summary` for the `summary` CEF field. Use `raw_event.fieldname` to read from the original event `fieldname` data.
        :param builtins.str type: Only `regex` is supported
        :param builtins.str value: The Regex expression to match against. Must use valid [RE2 regular expression](https://github.com/google/re2/wiki/Syntax) syntax.
        """
        pulumi.set(__self__, "name", name)
...
class EventOrchestrationUnroutedSetRuleActions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str route_to: The ID of a Set from this Unrouted Orchestration whose rules you also want to use with events that match this rule.
        :param builtins.str severity: sets Severity of the resulting alert. Allowed values are: `info`, `error`, `warning`, `critical`
...
class IncidentWorkflowStep(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action id for the workflow step, including the version. A list of actions available can be retrieved using the [PagerDuty API](https://developer.pagerduty.com/api-reference/aa192a25fac39-list-actions).
        :param builtins.str name: The name of the workflow step.
        :param builtins.str id: The ID of the incident workflow.
...
class IncidentWorkflowStepInlineStepsInput(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the input.
...
class IncidentWorkflowStepInlineStepsInputStepInput(dict):
    def __init__(__self__, *,
                 name: builtins.str,
                 value: builtins.str,
                 generated: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of the input.
        :param builtins.str value: The value of the input.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
    ...
    @property
    @pulumi.getter
    def generated(self) -> Optional[builtins.bool]:
...
class IncidentWorkflowTriggerPermissions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool restricted: If `true`, indicates that the Trigger can only be started by authorized Users. If `false` (default), any user can start this Trigger. Applicable only to `manual`-type triggers.
        :param builtins.str team_id: The ID of the Team whose members can manually start this Trigger. Required and allowed only if `restricted` is `true`.
        """
...
class JiraCloudAccountMappingRuleConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str service: [Updating can cause a resource replacement] The ID of the linked PagerDuty service.
...
class JiraCloudAccountMappingRuleConfigJira(dict):
    ...
    def __init__(__self__, *,
                 autocreate_jql: Optional[builtins.str] = None,
                 create_issue_on_incident_trigger: Optional[builtins.bool] = None,
                 ...
                 sync_notes_user: Optional[builtins.str] = None):
        """
        :param builtins.str autocreate_jql: JQL query to automatically create PagerDuty incidents when matching Jira issues are created. Leave empty to disable this feature.
        :param builtins.bool create_issue_on_incident_trigger: When enabled, automatically creates a Jira issue whenever a PagerDuty incident is triggered.
        ...
        :param builtins.str sync_notes_user: ID of the PagerDuty user for syncing notes and comments between Jira issues and PagerDuty incidents. If not provided, note synchronization is disabled.
        """
    ...
    def autocreate_jql(self) -> Optional[builtins.str]:
        """
    ...
    def create_issue_on_incident_trigger(self) -> Optional[builtins.bool]:
        """
    ...
    def sync_notes_user(self) -> Optional[builtins.str]:
        """
...
class JiraCloudAccountMappingRuleConfigJiraCustomField(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str,
                 source_incident_field: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str target_issue_field: The unique identifier key of the Jira field that will be set.
        :param builtins.str target_issue_field_name: The human-readable name of the Jira field.
        :param builtins.str type: The type of the value that will be set; one of `attribute`, `const` or `jira_value`.
        :param builtins.str source_incident_field: The PagerDuty incident field from which the value will be extracted (only applicable if `type` is `attribute`); one of `incident_number`, `incident_title`, `incident_description`, `incident_status`, `incident_created_at`, `incident_service`, `incident_escalation_policy`, `incident_impacted_services`, `incident_html_url`, `incident_assignees`, `incident_acknowledgers`, `incident_last_status_change_at`, `incident_last_status_change_by`, `incident_urgency` or `incident_priority`.
        :param builtins.str value: The value to be set for the Jira field (only applicable if `type` is `const` or `jira_value`). It must be set as a JSON string.
        """
    ...
    def source_incident_field(self) -> Optional[builtins.str]:
        """
...
class JiraCloudAccountMappingRuleConfigJiraIssueType(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str id: Unique identifier for the Jira issue type.
        :param builtins.str name: The name of the Jira issue type.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class JiraCloudAccountMappingRuleConfigJiraPriority(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str jira_id: The ID of the Jira priority.
        :param builtins.str pagerduty_id: The ID of the PagerDuty priority.
        """
...
class JiraCloudAccountMappingRuleConfigJiraProject(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str id: Unique identifier for the Jira project.
        :param builtins.str key: The short key name of the Jira project.
        :param builtins.str name: The name of the Jira project.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "name", name)
...
class JiraCloudAccountMappingRuleConfigJiraStatusMappingAcknowledged(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: Unique identifier for the Jira status.
        :param builtins.str name: Name of the Jira status.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if name is not None:
...
class ResponsePlayResponder(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 num_loops: Optional[builtins.int] = None,
                 on_call_handoff_notifications: Optional[builtins.str] = None,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str description: Description of escalation policy
        :param Sequence['ResponsePlayResponderEscalationRuleArgs'] escalation_rules: The escalation rules
        :param builtins.str id: ID of the user defined as the responder
        :param builtins.str name: Name of the escalation policy
        :param builtins.int num_loops: The number of times the escalation policy will repeat after reaching the end of its escalation.
        :param builtins.str on_call_handoff_notifications: Determines how on call handoff notifications will be sent for users on the escalation policy. Defaults to "if_has_services". Could be "if_has_services", "always
        ...
        :param builtins.str type: Should be set as `escalation_policy` for escalation policy responders.
        """
    ...
    def num_loops(self) -> Optional[builtins.int]:
        """
    ...
    def on_call_handoff_notifications(self) -> Optional[builtins.str]:
        """
...
class ResponsePlayResponderEscalationRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 escalation_delay_in_minutes: Optional[builtins.int] = None,
                 id: Optional[builtins.str] = None):
        """
        ...
        :param builtins.int escalation_delay_in_minutes: The number of minutes before an unacknowledged incident escalates away from this rule.
        :param builtins.str id: The ID of the response play.
        """
        pulumi.set(__self__, "targets", targets)
    ...
    @property
    @pulumi.getter(name="escalationDelayInMinutes")
    def escalation_delay_in_minutes(self) -> Optional[builtins.int]:
        """
        The number of minutes before an unacknowledged incident escalates away from this rule.
        """
        return pulumi.get(self, "escalation_delay_in_minutes")
...
class ResponsePlayResponderEscalationRuleTarget(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The ID of the response play.
        :param builtins.str type: Type of object of the target. Supported types are `user_reference`, `schedule_reference`.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if type is not None:
...
class ResponsePlayResponderService(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The ID of the response play.
        :param builtins.str type: A string that determines the schema of the object. If not set, the default value is "response_play".
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if type is not None:
...
class RulesetRuleActionsAnnotate(dict):
    def __init__(__self__, *,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str value: Boolean value that indicates if the alert should be suppressed before the indicated threshold values are met.
        """
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class RulesetRuleActionsExtraction(dict):
    def __init__(__self__, *,
                 ...
                 template: Optional[builtins.str] = None):
        """
        :param builtins.str regex: The conditions that need to be met for the extraction to happen. Must use valid [RE2 regular expression syntax](https://github.com/google/re2/wiki/Syntax).
               
               *- **OR** -*
        :param builtins.str source: Field where the data is being copied from. Must be a [PagerDuty Common Event Format (PD-CEF)](https://support.pagerduty.com/docs/pd-cef) field.
        :param builtins.str target: Field where the data is being copied to. Must be a [PagerDuty Common Event Format (PD-CEF)](https://support.pagerduty.com/docs/pd-cef) field.
               
               *NOTE: A rule can have multiple `extraction` objects attributed to it.*
        :param builtins.str template: A customized field message. This can also include variables extracted from the payload by using string interpolation.
        """
        if regex is not None:
            pulumi.set(__self__, "regex", regex)
        if source is not None:
...
class RulesetRuleActionsSuppress(dict):
    ...
    def __init__(__self__, *,
                 threshold_time_amount: Optional[builtins.int] = None,
                 threshold_time_unit: Optional[builtins.str] = None,
                 threshold_value: Optional[builtins.int] = None,
                 value: Optional[builtins.bool] = None):
        """
        :param builtins.int threshold_time_amount: The number value of the `threshold_time_unit` before an incident is created. Must be greater than 0.
        :param builtins.str threshold_time_unit: The `seconds`,`minutes`, or `hours` the `threshold_time_amount` should be measured.
        :param builtins.int threshold_value: The number of alerts that should be suppressed. Must be greater than 0.
        :param builtins.bool value: Boolean value that indicates if the alert should be suppressed before the indicated threshold values are met.
        """
    ...
    def threshold_time_amount(self) -> Optional[builtins.int]:
        """
    ...
    def threshold_time_unit(self) -> Optional[builtins.str]:
        """
...
class RulesetRuleActionsSuspend(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int value: Boolean value that indicates if the alert should be suppressed before the indicated threshold values are met.
        """
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class RulesetRuleConditions(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: Operator to combine sub-conditions. Can be `and` or `or`.
...
class RulesetRuleConditionsSubcondition(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: Type of operator to apply to the sub-condition. Can be `exists`,`nexists`,`equals`,`nequals`,`contains`,`ncontains`,`matches`, or `nmatches`.
...
class RulesetRuleTimeFrameScheduledWeekly(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weekdays: Optional[Sequence[builtins.int]] = None):
        """
        :param builtins.int duration: Length of time the schedule will be active in milliseconds. For example `duration = 2 * 60 * 60 * 1000` if you want your rule to apply for 2 hours, from the specified `start_time`.
        :param builtins.int start_time: A Unix timestamp in milliseconds which is combined with the `timezone` to determine the time this rule will start on each specified `weekday`. Note that the _date_ of the timestamp you specify does **not** matter, except that it lets you determine whether daylight saving time is in effect so that you use the correct UTC offset for the timezone you specify. In practice, you may want to use the `time_static` resource to generate this value, as demonstrated in the `resource.pagerduty_ruleset_rule.foo` code example at the top of this page. To generate this timestamp manually, if you want your rule to apply starting at 9:30am in the `America/New_York` timezone, use your programing language of choice to determine a Unix timestamp that represents 9:30am in that timezone, like [1554989400000](https://www.epochconverter.com/timezones?q=1554989400000&tz=America%2FNew_York).
        :param builtins.str timezone: [The name of the timezone](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) for the given schedule, which will be used to determine UTC offset including adjustment for daylight saving time. For example: `timezone = "America/Toronto"`
        :param Sequence[builtins.int] weekdays: An integer array representing which days during the week the rule executes. For example `weekdays = [1,3,7]` would execute on Monday, Wednesday and Sunday.
        """
    ...
    @property
    @pulumi.getter
    def weekdays(self) -> Optional[Sequence[builtins.int]]:
        """
...
class ScheduleFinalSchedule(dict):
    ...
    def __init__(__self__, *,
                 name: Optional[builtins.str] = None,
                 rendered_coverage_percentage: Optional[builtins.str] = None):
        """
    ...
    def rendered_coverage_percentage(self) -> Optional[builtins.str]:
...
class ScheduleLayer(dict):
    ...
    def __init__(__self__, *,
                 rotation_turn_length_seconds: builtins.int,
        ...
        """
        :param builtins.int rotation_turn_length_seconds: The duration of each on-call shift in `seconds`.
        :param builtins.str rotation_virtual_start: The effective start time of the schedule layer. This can be before the start time of the schedule.
        :param builtins.str start: The start time of the schedule layer.
        :param Sequence[builtins.str] users: The ordered list of users on this layer. The position of the user on the list determines their order in the layer.
        :param builtins.str end: The end time of the schedule layer. If not specified, the layer does not end.
        :param builtins.str id: The ID of the schedule.
        :param builtins.str name: The name of the schedule layer.
    ...
    def rotation_turn_length_seconds(self) -> builtins.int:
        """
...
class ScheduleLayerRestriction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str,
                 start_day_of_week: Optional[builtins.int] = None):
        """
        :param builtins.int duration_seconds: The duration of the restriction in `seconds`.
        :param builtins.str start_time_of_day: The start time in `HH:mm:ss` format.
        :param builtins.str type: Can be `daily_restriction` or `weekly_restriction`.
        :param builtins.int start_day_of_week: Number of the day when restriction starts. From 1 to 7 where 1 is Monday and 7 is Sunday.
        """
    ...
    def duration_seconds(self) -> builtins.int:
        """
    ...
    def start_day_of_week(self) -> Optional[builtins.int]:
        """
...
class ServiceAlertGroupingParameters(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: The type of alert grouping; one of `intelligent`, `time` or `content_based`.
        """
...
class ServiceAlertGroupingParametersConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 timeout: Optional[builtins.int] = None):
        """
        :param builtins.str aggregate: One of `any` or `all`. This setting applies only when `type` is set to `content_based`. Group alerts based on one or all of `fields` value(s).
        :param Sequence[builtins.str] fields: Alerts will be grouped together if the content of these fields match. This setting applies only when `type` is set to `content_based`.
        ...
        :param builtins.int timeout: The duration in minutes within which to automatically group incoming alerts. This setting applies only when `type` is set to `time`. To continue grouping alerts until the incident is resolved, set this value to `0`.
        """
        if aggregate is not None:
            pulumi.set(__self__, "aggregate", aggregate)
        if fields is not None:
...
class ServiceAutoPauseNotificationsParameters(dict):
    def __init__(__self__, *,
                 ...
                 timeout: Optional[builtins.int] = None):
        """
        :param builtins.bool enabled: Indicates whether alerts should be automatically suspended when identified as transient.  If not passed in, will default to 'false'.
        :param builtins.int timeout: Indicates in seconds how long alerts should be suspended before triggering. Allowed values: `120`, `180`, `300`, `600`, `900` if `enabled` is `true`. Must be omitted or set to `null` if `enabled` is `false`.
        """
...
class ServiceDependencyDependency(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: Can be `business_service`,  `service`, `business_service_reference` or `technical_service_reference`.
        """
...
class ServiceDependencyDependencyDependentService(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str id: The ID of the service dependency.
        :param builtins.str type: Can be `business_service`,  `service`, `business_service_reference` or `technical_service_reference`.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
class ServiceEventRuleActionsSuppress(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.bool] = None):
        """
        :param builtins.int threshold_time_amount: The number value of the `threshold_time_unit` before an incident is created.
        :param builtins.str threshold_time_unit: The `seconds`,`minutes`, or `hours` the `threshold_time_amount` should be measured.
        :param builtins.int threshold_value: The number of alerts that should be suppressed.
        :param builtins.bool value: Boolean value that indicates if the alert should be suppressed before the indicated threshold values are met.
        """
        if threshold_time_amount is not None:
            pulumi.set(__self__, "threshold_time_amount", threshold_time_amount)
...
class ServiceEventRuleConditionsSubconditionParameter(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str path: Path to a field in an event, in dot-notation. For Event Rules on a Service, this will have to be a [PD-CEF field](https://support.pagerduty.com/docs/pd-cef).
        """
        if path is not None:
            pulumi.set(__self__, "path", path)
        if value is not None:
...
class ServiceEventRuleTimeFrameActiveBetween(dict):
    ...
    def __init__(__self__, *,
                 ...
                 start_time: Optional[builtins.int] = None):
        """
        :param builtins.int end_time: Ending of the scheduled time when the rule should execute.  Unix timestamp in milliseconds.
        :param builtins.int start_time: Beginning of the scheduled time when the rule should execute.  Unix timestamp in milliseconds.
        """
        if end_time is not None:
            pulumi.set(__self__, "end_time", end_time)
        if start_time is not None:
...
class ServiceEventRuleTimeFrameScheduledWeekly(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weekdays: Optional[Sequence[builtins.int]] = None):
        """
        :param builtins.int duration: Length of time the schedule will be active.  Unix timestamp in milliseconds.
        :param builtins.int start_time: Time when the schedule will start. Unix timestamp in milliseconds. For example, if you have a rule with a `start_time` of `0` and a `duration` of `60,000` then that rule would be active from `00:00` to `00:01`. If the `start_time` was `3,600,000` the it would be active starting at `01:00`.
        :param builtins.str timezone: Timezone for the given schedule.
        :param Sequence[builtins.int] weekdays: An integer array representing which days during the week the rule executes. For example `weekdays = [1,3,7]` would execute on Monday, Wednesday and Sunday.
        """
        if duration is not None:
            pulumi.set(__self__, "duration", duration)
...
class ServiceEventRuleVariable(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: Type of operation to populate the variable. Usually `regex`.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if parameters is not None:
...
class ServiceIncidentUrgencyRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 urgency: Optional[builtins.str] = None):
        """
        :param builtins.str type: The type of incident urgency: `constant` or `use_support_hours` (when depending on specific support hours; see `support_hours`).
        ...
        :param builtins.str urgency: The urgency: `low` Notify responders (does not escalate), `high` (follows escalation rules) or `severity_based` Set's the urgency of the incident based on the severity set by the triggering monitoring tool.
        """
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def urgency(self) -> Optional[builtins.str]:
        """
...
class ServiceIncidentUrgencyRuleDuringSupportHours(dict):
    def __init__(__self__, *,
                 ...
                 urgency: Optional[builtins.str] = None):
        """
        :param builtins.str type: The type of object. The value returned will be `service`. Can be used for passing to a service dependency.
        :param builtins.str urgency: The urgency: `low` Notify responders (does not escalate), `high` (follows escalation rules) or `severity_based` Set's the urgency of the incident based on the severity set by the triggering monitoring tool.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class ServiceIntegrationEmailFilter(dict):
    ...
    def __init__(__self__, *,
                 body_mode: Optional[builtins.str] = None,
                 body_regex: Optional[builtins.str] = None,
                 from_email_mode: Optional[builtins.str] = None,
                 from_email_regex: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
    ...
    def body_regex(self) -> Optional[builtins.str]:
        """
    ...
    def from_email_regex(self) -> Optional[builtins.str]:
        """
        Should be a valid regex or `null`
        """
    ...
    def subject_regex(self) -> Optional[builtins.str]:
        """
        Should be a valid regex or `null`
        """
...
class ServiceIntegrationEmailParser(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: Can be `resolve` or `trigger`.
        :param builtins.int id: The ID of the service integration.
        """
        pulumi.set(__self__, "action", action)
...
class ServiceIntegrationEmailParserMatchPredicate(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Can be `any` or `all`.
        """
        pulumi.set(__self__, "type", type)
...
class ServiceIntegrationEmailParserMatchPredicatePredicate(dict):
    def __init__(__self__, *,
                 ...
                 part: Optional[builtins.str] = None,
                 predicates: Optional[Sequence['outputs.ServiceIntegrationEmailParserMatchPredicatePredicatePredicate']] = None):
        """
        :param builtins.str type: Can be `contains`, `exactly`, `regex` or `not`. If type is `not` predicate should contain child predicate with all parameters.
        :param builtins.str matcher: Predicate value or valid regex.
        :param builtins.str part: Can be `subject`, `body` or `from_addresses`.
        """
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def part(self) -> Optional[builtins.str]:
        """
...
class ServiceIntegrationEmailParserValueExtractor(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ends_before: Optional[builtins.str] = None,
                 regex: Optional[builtins.str] = None,
                 starts_after: Optional[builtins.str] = None):
        """
        :param builtins.str part: Can be `subject` or `body`.
        :param builtins.str type: Can be `between`, `entire` or `regex`.
        :param builtins.str value_name: First value extractor should have name `incident_key` other value extractors should contain custom names.
        :param builtins.str regex: If `type` has value `regex` this value should contain valid regex.
    ...
    def ends_before(self) -> Optional[builtins.str]:
    ...
    def starts_after(self) -> Optional[builtins.str]:
...
class ServiceScheduledAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 to_urgency: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        :param Sequence['ServiceScheduledActionAtArgs'] ats: A block representing when the scheduled action will occur.
        :param builtins.str to_urgency: The urgency to change to: `low` (does not escalate), or `high` (follows escalation rules).
        :param builtins.str type: The type of scheduled action. Currently, this must be set to `urgency_change`.
        """
        if ats is not None:
    ...
    def to_urgency(self) -> Optional[builtins.str]:
        """
...
class ServiceScheduledActionAt(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str name: Designates either the start or the end of the scheduled action. Can be `support_hours_start` or `support_hours_end`.
               ...
               ```
        :param builtins.str type: The type of time specification. Currently, this must be set to `named_time`.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if type is not None:
...
class ServiceSupportHours(dict):
    ...
    def __init__(__self__, *,
                 days_of_weeks: Optional[Sequence[builtins.int]] = None,
                 end_time: Optional[builtins.str] = None,
                 start_time: Optional[builtins.str] = None,
                 time_zone: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.int] days_of_weeks: Array of days of week as integers. `1` to `7`, `1` being
               Monday and `7` being Sunday.
        :param builtins.str end_time: The support hours' ending time of day.
        :param builtins.str start_time: The support hours' starting time of day.
        :param builtins.str time_zone: The time zone for the support hours.
        :param builtins.str type: The type of support hours. Can be `fixed_time_per_day`.
        """
    ...
    def days_of_weeks(self) -> Optional[Sequence[builtins.int]]:
        """
...
class SlackConnectionConfig(dict):
    def __init__(__self__, *,
                 ...
                 priorities: Optional[Sequence[builtins.str]] = None,
                 urgency: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] events: A list of strings to filter events by PagerDuty event type. `"incident.triggered"` is required. The follow event types are also possible:
               ...
               - `incident.reopened`
        :param Sequence[builtins.str] priorities: Allows you to filter events by priority. Needs to be an array of PagerDuty priority IDs. Available through get_priority data source.
        ...
        :param builtins.str urgency: Allows you to filter events by urgency. Either `high`, `low` or `null` for Any urgency. Default is `null`.
        """
    ...
    @property
    @pulumi.getter
    def priorities(self) -> Optional[Sequence[builtins.str]]:
        """
...
class UserHandoffNotificationRuleContactMethod(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str id: The ID of the contact method.
        :param builtins.str type: The type of the contact method. May be (`email_contact_method`, `email_contact_method_reference`, `phone_contact_method`, `phone_contact_method_reference`, `push_notification_contact_method`, `push_notification_contact_method_reference`, `sms_contact_method`, `sms_contact_method_reference`).
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
class WebhookSubscriptionDeliveryMethod(dict):
    ...
    def __init__(__self__, *,
                 ...
                 temporarily_disabled: Optional[builtins.bool] = None,
                 type: Optional[builtins.str] = None,
        ...
        :param builtins.bool temporarily_disabled: Whether this webhook subscription is temporarily disabled. Becomes true if the delivery method URL is repeatedly rejected by the server.
        :param builtins.str type: Indicates the type of the delivery method. Allowed and default value: `http_delivery_method`.
        :param builtins.str url: The destination URL for webhook delivery.
        """
    ...
    def temporarily_disabled(self) -> Optional[builtins.bool]:
        """
...
class WebhookSubscriptionFilter(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str type: The type of object being used as the filter. Allowed values are `account_reference`, `service_reference`, and `team_reference`.
        :param builtins.str id: The id of the object being used as the filter. This field is required for all filter types except account_reference.
        """
        pulumi.set(__self__, "type", type)
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class GetAutomationActionsActionActionDataReferenceResult(dict):
    def __init__(__self__, *,
                 invocation_command: builtins.str,
                 process_automation_job_arguments: builtins.str,
                 process_automation_job_id: builtins.str,
                 process_automation_node_filter: builtins.str,
                 script: builtins.str):
        """
        :param builtins.str invocation_command: (Optional) The command to execute the script with.
        :param builtins.str process_automation_job_arguments: (Optional) The arguments to pass to the Process Automation job execution.
        :param builtins.str process_automation_job_id: (Required for `process_automation` action_type) The ID of the Process Automation job to execute.
        :param builtins.str process_automation_node_filter: (Optional) The expression that filters on which nodes a Process Automation Job executes [Learn more](https://docs.rundeck.com/docs/manual/05-nodes.html#node-filtering).
        :param builtins.str script: (Required for `script` action_type) Body of the script to be executed on the Runner. Max length is 16777215 characters.
        """
        pulumi.set(__self__, "invocation_command", invocation_command)
        pulumi.set(__self__, "process_automation_job_arguments", process_automation_job_arguments)
        pulumi.set(__self__, "process_automation_job_id", process_automation_job_id)
...
class GetEventOrchestrationsEventOrchestrationResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the found Event Orchestration.
        """
        pulumi.set(__self__, "id", id)
...
class GetLicensesLicenseResult(dict):
    def __init__(__self__, *,
                 allocations_available: builtins.int,
                 current_value: builtins.int,
                 description: builtins.str,
                 html_url: builtins.str,
                 id: builtins.str,
                 name: builtins.str,
                 role_group: builtins.str,
                 self: builtins.str,
                 summary: builtins.str,
                 type: builtins.str,
                 valid_roles: Sequence[builtins.str]):
        """
        :param builtins.int allocations_available: Available allocations to assign to users
        :param builtins.int current_value: The number of allocations already assigned to users
        :param builtins.str description: Description of the license
        :param builtins.str id: Allows to override the default behavior for setting the `id` attribute that is required for data sources.
        :param builtins.str name: Name of the license
        :param builtins.str role_group: The role group for the license that determines the available `valid_roles`
        :param builtins.str summary: Summary of the license
        :param Sequence[builtins.str] valid_roles: List of allowed roles that may be assigned to a user with this license
        """
    ...
    def allocations_available(self) -> builtins.int:
        """
    ...
    def valid_roles(self) -> Sequence[builtins.str]:
        """
...
class GetServiceTeamResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str id: The ID of the found service.
...
class GetStandardsResourceScoresScoreResult(dict):
    def __init__(__self__, *,
                 passing: builtins.int,
                 total: builtins.int):
        """
        :param builtins.int passing: Number of standards this resource successfully complies to.
        :param builtins.int total: Number of standards associated to this resource.
        """
...
class GetStandardsResourceScoresStandardResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.bool active: Indicates whether the standard is currently active and applicable to the resource.
        :param builtins.str description: Provides a textual description of the standard.
        :param builtins.str id: Identifier of said resource.
        :param builtins.str name: The human-readable name of the standard.
        :param builtins.bool pass_: Indicates whether the resource complies to this standard.
        :param builtins.str type: The type of the standard.
        """
...
class GetStandardsResourcesScoresResourceResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_id: Unique Identifier.
        :param builtins.str resource_type: Type of the object the standards are associated to. Allowed values are `technical_services`.
...
class GetStandardsResourcesScoresResourceStandardResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool active: Indicates whether the standard is currently active and applicable to the resource.
        :param builtins.str description: Provides a textual description of the standard.
        :param builtins.str id: A unique identifier for the standard.
        :param builtins.str name: The human-readable name of the standard.
        :param builtins.bool pass_: Indicates whether the resource complies to this standard.
        :param builtins.str type: The type of the standard.
        """
...
class GetStandardsStandardResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str id: The unique identifier for the resource being included.
        ...
        :param builtins.str type: Specifies the type of resource this inclusion applies to.
        """
        pulumi.set(__self__, "active", active)
        pulumi.set(__self__, "description", description)
...
class GetTeamMembersMemberResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str id: The ID of the found user.
        :param builtins.str role: The team role of the found user.
        :param builtins.str summary: A short-form, server-generated string that provides succinct, important information about an object suitable for primary labeling of an entity in a client. In many cases, this will be identical to name, though it is not intended to be an identifier.
        :param builtins.str type: The type of object. The value returned will be `user_reference`. Can be used for passing to another object as dependency.
        """
        pulumi.set(__self__, "id", id)
...
class GetTeamsTeamResult(dict):
    def __init__(__self__, *,
                 ...
                 summary: builtins.str):
        """
        :param builtins.str description: The description of the team.
...
class GetUsersUserResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str description: The human-friendly description of the found user.
        :param builtins.str email: The email of the found user.
        :param builtins.str id: The ID of the found user.
        :param builtins.str job_title: The job title of the found user.
        :param builtins.str name: The short name of the found user.
        :param builtins.str role: The role of the found user.
        :param builtins.str time_zone: The timezone of the found user.
        """
        pulumi.set(__self__, "description", description)
