...
class Provider(pulumi.ProviderResource):
    def __init__(__self__, resource_name, opts=None, skip_credentials_validation=None, token=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            if token is None:
                token = utilities.get_env('PAGERDUTY_TOKEN')
