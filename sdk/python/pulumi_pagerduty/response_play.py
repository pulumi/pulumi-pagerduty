...
class ResponsePlayArgs:
    def __init__(__self__, *,
                 ...
                 conference_number: Optional[pulumi.Input[builtins.str]] = None,
                 conference_url: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 responders: Optional[pulumi.Input[Sequence[pulumi.Input['ResponsePlayResponderArgs']]]] = None,
                 responders_message: Optional[pulumi.Input[builtins.str]] = None,
                 runnability: Optional[pulumi.Input[builtins.str]] = None,
                 subscribers: Optional[pulumi.Input[Sequence[pulumi.Input['ResponsePlaySubscriberArgs']]]] = None,
                 subscribers_message: Optional[pulumi.Input[builtins.str]] = None,
                 team: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ResponsePlay resource.
        :param pulumi.Input[builtins.str] from_: The email of the user attributed to the request. Needs to be a valid email address of a user in the PagerDuty account.
        :param pulumi.Input[builtins.str] conference_number: The telephone number that will be set as the conference number for any incident on which this response play is run.
        :param pulumi.Input[builtins.str] conference_url: The URL that will be set as the conference URL for any incident on which this response play is run.
        :param pulumi.Input[builtins.str] description: A human-friendly description of the response play.
               If not set, a placeholder of "Managed by Pulumi" will be set.
        :param pulumi.Input[builtins.str] name: The name of the response play.
        ...
        :param pulumi.Input[builtins.str] responders_message: The message body of the notification that will be sent to this response play's set of responders. If empty, a default response request notification will be sent.
        :param pulumi.Input[builtins.str] runnability: String representing how this response play is allowed to be run. Valid options are:
        ...
        :param pulumi.Input[builtins.str] subscribers_message: The content of the notification that will be sent to all incident subscribers upon the running of this response play. Note that this includes any users who may have already been subscribed to the incident prior to the running of this response play. If empty, no notifications will be sent.
        :param pulumi.Input[builtins.str] team: The ID of the team associated with the response play.
    ...
    def conference_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def conference_number(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "conference_number", value)

    @property
    @pulumi.getter(name="conferenceUrl")
    def conference_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def conference_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def responders_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def responders_message(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "responders_message", value)

    @property
    @pulumi.getter
    def runnability(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @runnability.setter
    def runnability(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subscribers_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subscribers_message(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ResponsePlay(pulumi.CustomResource):
    ...
    pulumi_type = "pagerduty:index/responsePlay:ResponsePlay"
    ...
    def get(resource_name: str,
            ...
            subscribers_message: Optional[pulumi.Input[builtins.str]] = None,
            team: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ResponsePlay':
        """
    ...
    @property
    @pulumi.getter(name="conferenceNumber")
    def conference_number(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The telephone number that will be set as the conference number for any incident on which this response play is run.
        """
        return pulumi.get(self, "conference_number")
    ...
    @property
    @pulumi.getter(name="conferenceUrl")
    def conference_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL that will be set as the conference URL for any incident on which this response play is run.
        """
        return pulumi.get(self, "conference_url")
    ...
    @property
    @pulumi.getter(name="from")
    def from_(self) -> pulumi.Output[builtins.str]:
        """
        The email of the user attributed to the request. Needs to be a valid email address of a user in the PagerDuty account.
        """
        return pulumi.get(self, "from_")
    ...
    @property
    @pulumi.getter(name="respondersMessage")
    def responders_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The message body of the notification that will be sent to this response play's set of responders. If empty, a default response request notification will be sent.
        """
        return pulumi.get(self, "responders_message")
    ...
    @property
    @pulumi.getter
    def runnability(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        String representing how this response play is allowed to be run. Valid options are:
        """
        return pulumi.get(self, "runnability")
    ...
    @property
    @pulumi.getter(name="subscribersMessage")
    def subscribers_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The content of the notification that will be sent to all incident subscribers upon the running of this response play. Note that this includes any users who may have already been subscribed to the incident prior to the running of this response play. If empty, no notifications will be sent.
        """
        return pulumi.get(self, "subscribers_message")
