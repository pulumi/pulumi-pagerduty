...
class _RulesetState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 routing_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 team: Optional[pulumi.Input['RulesetTeamArgs']] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Ruleset resources.
        :param pulumi.Input[builtins.str] name: Name of the ruleset.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] routing_keys: Routing keys routed to this ruleset.
        :param pulumi.Input['RulesetTeamArgs'] team: Reference to the team that owns the ruleset. If none is specified, only admins have access.
        :param pulumi.Input[builtins.str] type: Type of ruleset. Currently, only sets to `global`.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
    ...
    def routing_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @routing_keys.setter
    def routing_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Ruleset(pulumi.CustomResource):
    ...
    pulumi_type = "pagerduty:index/ruleset:Ruleset"
    ...
    def get(resource_name: str,
            ...
            routing_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            team: Optional[pulumi.Input[Union['RulesetTeamArgs', 'RulesetTeamArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Ruleset':
        """
    ...
    @property
    @pulumi.getter(name="routingKeys")
    def routing_keys(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Routing keys routed to this ruleset.
        """
        return pulumi.get(self, "routing_keys")
