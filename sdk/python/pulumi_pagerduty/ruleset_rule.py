...
class RulesetRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ruleset: The ID of the ruleset that the rule belongs to.
        :param pulumi.Input['RulesetRuleActionsArgs'] actions: Actions to apply to an event if the conditions match.
        :param pulumi.Input[builtins.bool] catch_all: Indicates whether the Event Rule is the last Event Rule of the Ruleset that serves as a catch-all. It has limited functionality compared to other rules and always matches.
        ...
        :param pulumi.Input[builtins.int] position: Position/index of the rule within the ruleset.
...
class RulesetRule(pulumi.CustomResource):
    ...
    pulumi_type = "pagerduty:index/rulesetRule:RulesetRule"
    ...
    @property
    @pulumi.getter(name="catchAll")
    def catch_all(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the Event Rule is the last Event Rule of the Ruleset that serves as a catch-all. It has limited functionality compared to other rules and always matches.
        """
        return pulumi.get(self, "catch_all")
    ...
    @property
    @pulumi.getter
    def position(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Position/index of the rule within the ruleset.
        """
        return pulumi.get(self, "position")
