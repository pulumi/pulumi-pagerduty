...
class ServiceArgs:
    def __init__(__self__, *,
                 escalation_policy: pulumi.Input[builtins.str],
                 acknowledgement_timeout: Optional[pulumi.Input[builtins.str]] = None,
                 alert_creation: Optional[pulumi.Input[builtins.str]] = None,
                 alert_grouping: Optional[pulumi.Input[builtins.str]] = None,
                 alert_grouping_parameters: Optional[pulumi.Input['ServiceAlertGroupingParametersArgs']] = None,
                 alert_grouping_timeout: Optional[pulumi.Input[builtins.str]] = None,
                 auto_pause_notifications_parameters: Optional[pulumi.Input['ServiceAutoPauseNotificationsParametersArgs']] = None,
                 auto_resolve_timeout: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 incident_urgency_rule: Optional[pulumi.Input['ServiceIncidentUrgencyRuleArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 response_play: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] escalation_policy: The escalation policy used by this service.
        :param pulumi.Input[builtins.str] acknowledgement_timeout: Time in seconds that an incident changes to the Triggered State after being Acknowledged. Disabled if set to the `"null"` string.  If not passed in, will default to '"1800"'.
        :param pulumi.Input[builtins.str] alert_creation: (Deprecated) This attribute has been deprecated as all services will be migrated to use alerts and incidents. The incident only service setting will be no longer available and this attribute will be removed in an upcoming version. See knowledge base for details https://support.pagerduty.com/docs/alerts#enable-and-disable-alerts-on-a-service.
        :param pulumi.Input[builtins.str] alert_grouping: (Deprecated) Defines how alerts on this service will be automatically grouped into incidents. Note that the alert grouping features are available only on certain plans. If not set, each alert will create a separate incident; If value is set to `time`: All alerts within a specified duration will be grouped into the same incident. This duration is set in the `alert_grouping_timeout` setting (described below). Available on Standard, Enterprise, and Event Intelligence plans; If value is set to `intelligent` - Alerts will be intelligently grouped based on a machine learning model that looks at the alert summary, timing, and the history of grouped alerts. Available on Enterprise and Event Intelligence plan. This field is deprecated, use `alert_grouping_parameters.type` instead,
        ...
        :param pulumi.Input[builtins.str] auto_resolve_timeout: Time in seconds that an incident is automatically resolved if left open for that long. Disabled if set to the `"null"` string.
        :param pulumi.Input[builtins.str] description: A human-friendly description of the service.
               If not set, a placeholder of "Managed by Pulumi" will be set.
        :param pulumi.Input[builtins.str] name: The name of the service.
        :param pulumi.Input[builtins.str] response_play: (Deprecated) The response play used by this service.
        """
...
Follow the migration guide at https://registry.terraform.io/providers/PagerDuty/pagerduty/latest/docs/resources/alert_grouping_setting#migration-from-alert_grouping_parameters""")
    ...
    def escalation_policy(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def escalation_policy(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "escalation_policy", value)

    @property
    @pulumi.getter(name="acknowledgementTimeout")
    def acknowledgement_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def acknowledgement_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "acknowledgement_timeout", value)

    @property
    @pulumi.getter(name="alertCreation")
    def alert_creation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_creation(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def alert_grouping(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Deprecated) Defines how alerts on this service will be automatically grouped into incidents. Note that the alert grouping features are available only on certain plans. If not set, each alert will create a separate incident; If value is set to `time`: All alerts within a specified duration will be grouped into the same incident. This duration is set in the `alert_grouping_timeout` setting (described below). Available on Standard, Enterprise, and Event Intelligence plans; If value is set to `intelligent` - Alerts will be intelligently grouped based on a machine learning model that looks at the alert summary, timing, and the history of grouped alerts. Available on Enterprise and Event Intelligence plan. This field is deprecated, use `alert_grouping_parameters.type` instead,
        """
    ...
    def alert_grouping(self, value: Optional[pulumi.Input[builtins.str]]):
...
Follow the migration guide at https://registry.terraform.io/providers/PagerDuty/pagerduty/latest/docs/resources/alert_grouping_setting#migration-from-alert_grouping_parameters""")
    ...
    def alert_grouping_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_grouping_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def auto_resolve_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auto_resolve_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def response_play(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def response_play(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ServiceState:
    def __init__(__self__, *,
                 ...
                 incident_urgency_rule: Optional[pulumi.Input['ServiceIncidentUrgencyRuleArgs']] = None,
                 last_incident_timestamp: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 response_play: Optional[pulumi.Input[builtins.str]] = None,
                 scheduled_actions: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceScheduledActionArgs']]]] = None,
        ...
        :param pulumi.Input['ServiceAutoPauseNotificationsParametersArgs'] auto_pause_notifications_parameters: Defines how alerts on this service are automatically suspended for a period of time before triggering, when identified as likely being transient. Note that automatically pausing notifications is only available on certain plans as mentioned [here](https://support.pagerduty.com/docs/auto-pause-incident-notifications).
        :param pulumi.Input[builtins.str] auto_resolve_timeout: Time in seconds that an incident is automatically resolved if left open for that long. Disabled if set to the `"null"` string.
        :param pulumi.Input[builtins.str] created_at: Creation timestamp of the service.
        :param pulumi.Input[builtins.str] description: A human-friendly description of the service.
               If not set, a placeholder of "Managed by Pulumi" will be set.
        :param pulumi.Input[builtins.str] escalation_policy: The escalation policy used by this service.
        :param pulumi.Input[builtins.str] html_url: URL at which the entity is uniquely displayed in the Web app.
        :param pulumi.Input[builtins.str] last_incident_timestamp: Last incident timestamp of the service.
        :param pulumi.Input[builtins.str] name: The name of the service.
        :param pulumi.Input[builtins.str] response_play: (Deprecated) The response play used by this service.
...
Follow the migration guide at https://registry.terraform.io/providers/PagerDuty/pagerduty/latest/docs/resources/alert_grouping_setting#migration-from-alert_grouping_parameters""")
    ...
    def last_incident_timestamp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_incident_timestamp(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Service(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            support_hours: Optional[pulumi.Input[Union['ServiceSupportHoursArgs', 'ServiceSupportHoursArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Service':
        """
    ...
    @property
    @pulumi.getter(name="acknowledgementTimeout")
    def acknowledgement_timeout(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Time in seconds that an incident changes to the Triggered State after being Acknowledged. Disabled if set to the `"null"` string.  If not passed in, will default to '"1800"'.
        """
        return pulumi.get(self, "acknowledgement_timeout")
    ...
    @property
    @pulumi.getter(name="alertCreation")
    def alert_creation(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Deprecated) This attribute has been deprecated as all services will be migrated to use alerts and incidents. The incident only service setting will be no longer available and this attribute will be removed in an upcoming version. See knowledge base for details https://support.pagerduty.com/docs/alerts#enable-and-disable-alerts-on-a-service.
        """
        return pulumi.get(self, "alert_creation")
    ...
    @pulumi.getter(name="alertGrouping")
    @_utilities.deprecated("""Use `alert_grouping_parameters.type`""")
    def alert_grouping(self) -> pulumi.Output[builtins.str]:
        """
        (Deprecated) Defines how alerts on this service will be automatically grouped into incidents. Note that the alert grouping features are available only on certain plans. If not set, each alert will create a separate incident; If value is set to `time`: All alerts within a specified duration will be grouped into the same incident. This duration is set in the `alert_grouping_timeout` setting (described below). Available on Standard, Enterprise, and Event Intelligence plans; If value is set to `intelligent` - Alerts will be intelligently grouped based on a machine learning model that looks at the alert summary, timing, and the history of grouped alerts. Available on Enterprise and Event Intelligence plan. This field is deprecated, use `alert_grouping_parameters.type` instead,
        """
        return pulumi.get(self, "alert_grouping")
...
Follow the migration guide at https://registry.terraform.io/providers/PagerDuty/pagerduty/latest/docs/resources/alert_grouping_setting#migration-from-alert_grouping_parameters""")
    ...
    @pulumi.getter(name="alertGroupingTimeout")
    @_utilities.deprecated("""Use `alert_grouping_parameters.config.timeout`""")
    def alert_grouping_timeout(self) -> pulumi.Output[builtins.str]:
        """
        (Deprecated) The duration in minutes within which to automatically group incoming alerts. This setting applies only when `alert_grouping` is set to `time`. To continue grouping alerts until the incident is resolved, set this value to `0`. This field is deprecated, use `alert_grouping_parameters.config.timeout` instead,
        """
        return pulumi.get(self, "alert_grouping_timeout")
    ...
    @property
    @pulumi.getter(name="autoResolveTimeout")
    def auto_resolve_timeout(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Time in seconds that an incident is automatically resolved if left open for that long. Disabled if set to the `"null"` string.
        """
        return pulumi.get(self, "auto_resolve_timeout")
    ...
    @property
    @pulumi.getter(name="escalationPolicy")
    def escalation_policy(self) -> pulumi.Output[builtins.str]:
        """
        The escalation policy used by this service.
        """
        return pulumi.get(self, "escalation_policy")
    ...
    @property
    @pulumi.getter(name="lastIncidentTimestamp")
    def last_incident_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        Last incident timestamp of the service.
        """
        return pulumi.get(self, "last_incident_timestamp")
    ...
    @property
    @pulumi.getter(name="responsePlay")
    def response_play(self) -> pulumi.Output[builtins.str]:
        """
        (Deprecated) The response play used by this service.
        """
        return pulumi.get(self, "response_play")
