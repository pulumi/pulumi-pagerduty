...
class ServiceIntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] integration_email: This is the unique fully-qualified email address used for routing emails to this integration for processing.
        :param pulumi.Input[_builtins.str] integration_key: (Deprecated) This is the unique key used to route events to this integration when received via the PagerDuty Events API.
        :param pulumi.Input[_builtins.str] name: The name of the service integration.
        :param pulumi.Input[_builtins.str] type: The service type. Can be:
        ...
        :param pulumi.Input[_builtins.str] vendor: The ID of the vendor the integration should integrate with (e.g. Datadog or Amazon Cloudwatch).
        """
...
class ServiceIntegration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 email_filter_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 email_filters: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ServiceIntegrationEmailFilterArgs', 'ServiceIntegrationEmailFilterArgsDict', 'outputs.ServiceIntegrationEmailFilter']]]]] = None,
                 email_incident_creation: pulumi.Input[Optional[_builtins.str]] = None,
                 email_parsers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ServiceIntegrationEmailParserArgs', 'ServiceIntegrationEmailParserArgsDict', 'outputs.ServiceIntegrationEmailParser']]]]] = None,
                 email_parsing_fallback: pulumi.Input[Optional[_builtins.str]] = None,
                 integration_email: pulumi.Input[Optional[_builtins.str]] = None,
                 integration_key: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="emailFilterMode")
    def email_filter_mode(self) -> pulumi.Output[_builtins.str]:
        """
        Mode of Emails Filters feature ([explained in PD docs](https://support.pagerduty.com/docs/email-management-filters-and-rules#configure-a-regex-filter)). Can be `all-email`, `or-rules-email` or `and-rules-email`.
        """
        return pulumi.get(self, "email_filter_mode")
    ...
    @_builtins.property
    @pulumi.getter(name="emailIncidentCreation")
    def email_incident_creation(self) -> pulumi.Output[_builtins.str]:
        """
        Behaviour of Email Management feature ([explained in PD docs](https://support.pagerduty.com/docs/email-management-filters-and-rules#control-when-a-new-incident-or-alert-is-triggered)). Can be `on_new_email`, `on_new_email_subject`, `only_if_no_open_incidents` or `use_rules`.
        """
        return pulumi.get(self, "email_incident_creation")
    ...
    @_builtins.property
    @pulumi.getter(name="emailParsingFallback")
    def email_parsing_fallback(self) -> pulumi.Output[_builtins.str]:
        """
        Can be `open_new_incident` or `discard`.
        """
        return pulumi.get(self, "email_parsing_fallback")
    ...
    @_builtins.property
    @pulumi.getter(name="integrationEmail")
    def integration_email(self) -> pulumi.Output[_builtins.str]:
        """
        This is the unique fully-qualified email address used for routing emails to this integration for processing.
        """
        return pulumi.get(self, "integration_email")
