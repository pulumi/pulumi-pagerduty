...
class SlackConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] notification_type: Type of notification. Either `responder` or `stakeholder`.
        :param pulumi.Input[builtins.str] source_id: The ID of the source in PagerDuty. Valid sources are services or teams.
        :param pulumi.Input[builtins.str] source_type: The type of the source. Either `team_reference` or `service_reference`.
        :param pulumi.Input[builtins.str] workspace_id: The slack team (workspace) ID of the connected Slack workspace. Can also be defined by the `SLACK_CONNECTION_WORKSPACE_ID` environment variable.
        """
...
class _SlackConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] channel_id: The ID of a Slack channel in the workspace.
        :param pulumi.Input[builtins.str] channel_name: Name of the Slack channel in Slack connection.
        :param pulumi.Input[Sequence[pulumi.Input['SlackConnectionConfigArgs']]] configs: Configuration options for the Slack connection that provide options to filter events.
        :param pulumi.Input[builtins.str] notification_type: Type of notification. Either `responder` or `stakeholder`.
        :param pulumi.Input[builtins.str] source_id: The ID of the source in PagerDuty. Valid sources are services or teams.
        :param pulumi.Input[builtins.str] source_name: Name of the source (team or service) in Slack connection.
        :param pulumi.Input[builtins.str] source_type: The type of the source. Either `team_reference` or `service_reference`.
        :param pulumi.Input[builtins.str] workspace_id: The slack team (workspace) ID of the connected Slack workspace. Can also be defined by the `SLACK_CONNECTION_WORKSPACE_ID` environment variable.
        """
...
class SlackConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_name: Optional[pulumi.Input[builtins.str]] = None,
            source_type: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SlackConnection':
        """
