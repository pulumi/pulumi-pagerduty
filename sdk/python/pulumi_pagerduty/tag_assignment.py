...
class TagAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] entity_type: Type of entity in the tag assignment. Possible values can be `users`, `teams`, and `escalation_policies`.
        :param pulumi.Input[builtins.str] tag_id: The ID of the tag.
        """
...
class TagAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            entity_id: Optional[pulumi.Input[builtins.str]] = None,
            entity_type: Optional[pulumi.Input[builtins.str]] = None,
            tag_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TagAssignment':
        """
