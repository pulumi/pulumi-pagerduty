...
class TeamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_role: The team is private if the value is "none", or public if it is "manager" (the default permissions for a non-member of the team are either "none", or their base role up until "manager").
        :param pulumi.Input[builtins.str] description: A human-friendly description of the team.
               If not set, a placeholder of "Managed by Pulumi" will be set.
        :param pulumi.Input[builtins.str] name: The name of the group.
        :param pulumi.Input[builtins.str] parent: ID of the parent team. This is available to accounts with the Team Hierarchy feature enabled. Please contact your account manager for more information.
        """
...
class Team(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            html_url: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            parent: Optional[pulumi.Input[builtins.str]] = None) -> 'Team':
        """
    ...
    @property
    @pulumi.getter(name="defaultRole")
    def default_role(self) -> pulumi.Output[builtins.str]:
        """
        The team is private if the value is "none", or public if it is "manager" (the default permissions for a non-member of the team are either "none", or their base role up until "manager").
        """
        return pulumi.get(self, "default_role")
