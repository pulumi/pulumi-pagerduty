...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] teams: A list of teams the user should belong to. Please use `TeamMembership` instead.
        :param pulumi.Input[_builtins.str] time_zone: The time zone of the user. Default is account default timezone.
        """
...
class _UserState:
    def __init__(__self__, *,
                 ...
                 invitation_sent: Optional[pulumi.Input[_builtins.bool]] = None,
                 job_title: Optional[pulumi.Input[_builtins.str]] = None,
                 license: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 role: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.bool] invitation_sent: If true, the user has an outstanding invitation.
        :param pulumi.Input[_builtins.str] job_title: The user's title.
        :param pulumi.Input[_builtins.str] license: The license id assigned to the user. If provided the user's role must exist in the assigned license's `valid_roles` list. To reference purchased licenses' ids see data source `get_licenses` [data source](https://developer.pagerduty.com/api-reference/b3A6Mjc0ODIzNA-create-a-user).
        :param pulumi.Input[_builtins.str] name: The name of the user.
        :param pulumi.Input[_builtins.str] role: The user role. Can be `admin`, `limited_user`, `observer`, `owner`, `read_only_user`, `read_only_limited_user`, `restricted_access`, or `user`.
    ...
    def invitation_sent(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def invitation_sent(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class User(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[_builtins.str]] = None,
            teams: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            time_zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'User':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="invitationSent")
    def invitation_sent(self) -> pulumi.Output[_builtins.bool]:
        """
        If true, the user has an outstanding invitation.
        """
        return pulumi.get(self, "invitation_sent")
