...
class UserContactMethodArgs:
    def __init__(__self__, *,
                 ...
                 send_short_email: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a UserContactMethod resource.
        :param pulumi.Input[builtins.str] address: The "address" to deliver to: `email`, `phone number`, etc., depending on the type.
        :param pulumi.Input[builtins.str] label: The label (e.g., "Work", "Mobile", etc.).
        :param pulumi.Input[builtins.str] type: The contact method type. May be (`email_contact_method`, `phone_contact_method`, `sms_contact_method`, `push_notification_contact_method`).
        :param pulumi.Input[builtins.str] user_id: The ID of the user.
        :param pulumi.Input[builtins.int] country_code: The 1-to-3 digit country calling code. Required when using `phone_contact_method` or `sms_contact_method`.
        :param pulumi.Input[builtins.bool] send_short_email: Send an abbreviated email message instead of the standard email output.
        """
    ...
    def send_short_email(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def send_short_email(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _UserContactMethodState:
    def __init__(__self__, *,
                 ...
                 blacklisted: Optional[pulumi.Input[builtins.bool]] = None,
                 country_code: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] address: The "address" to deliver to: `email`, `phone number`, etc., depending on the type.
        :param pulumi.Input[builtins.bool] blacklisted: If true, this phone has been blacklisted by PagerDuty and no messages will be sent to it.
        :param pulumi.Input[builtins.int] country_code: The 1-to-3 digit country calling code. Required when using `phone_contact_method` or `sms_contact_method`.
        :param pulumi.Input[builtins.bool] enabled: If true, this phone is capable of receiving SMS messages.
        :param pulumi.Input[builtins.str] label: The label (e.g., "Work", "Mobile", etc.).
        :param pulumi.Input[builtins.bool] send_short_email: Send an abbreviated email message instead of the standard email output.
        :param pulumi.Input[builtins.str] type: The contact method type. May be (`email_contact_method`, `phone_contact_method`, `sms_contact_method`, `push_notification_contact_method`).
        :param pulumi.Input[builtins.str] user_id: The ID of the user.
    ...
    @property
    @pulumi.getter
    def blacklisted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @blacklisted.setter
    def blacklisted(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class UserContactMethod(pulumi.CustomResource):
    ...
    pulumi_type = "pagerduty:index/userContactMethod:UserContactMethod"
    ...
    def get(resource_name: str,
            ...
            send_short_email: Optional[pulumi.Input[builtins.bool]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserContactMethod':
        """
    ...
    @property
    @pulumi.getter
    def blacklisted(self) -> pulumi.Output[builtins.bool]:
        """
        If true, this phone has been blacklisted by PagerDuty and no messages will be sent to it.
        """
        return pulumi.get(self, "blacklisted")
    ...
    @property
    @pulumi.getter(name="countryCode")
    def country_code(self) -> pulumi.Output[builtins.int]:
        """
        The 1-to-3 digit country calling code. Required when using `phone_contact_method` or `sms_contact_method`.
        """
        return pulumi.get(self, "country_code")
    ...
    @property
    @pulumi.getter(name="sendShortEmail")
    def send_short_email(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Send an abbreviated email message instead of the standard email output.
        """
        return pulumi.get(self, "send_short_email")
