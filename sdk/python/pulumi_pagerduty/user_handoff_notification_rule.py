...
class UserHandoffNotificationRuleArgs:
    def __init__(__self__, *,
                 ...
                 notify_advance_in_minutes: pulumi.Input[builtins.int],
                 user_id: pulumi.Input[builtins.str],
                 handoff_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] notify_advance_in_minutes: The number of minutes before the handoff that the user should be notified. Must be a positive integer greater than or equal to 0.
        :param pulumi.Input[builtins.str] user_id: The ID of the user.
        :param pulumi.Input[builtins.str] handoff_type: The type of handoff to notify the user about. Possible values are `oncall`, `offcall`, `both`.
        """
    ...
    def notify_advance_in_minutes(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def notify_advance_in_minutes(self, value: pulumi.Input[builtins.int]):
    ...
    def handoff_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @handoff_type.setter
    def handoff_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _UserHandoffNotificationRuleState:
    def __init__(__self__, *,
                 ...
                 handoff_type: Optional[pulumi.Input[builtins.str]] = None,
                 notify_advance_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="notifyAdvanceInMinutes")
    def notify_advance_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of minutes before the handoff that the user should be notified. Must be a positive integer greater than or equal to 0.
        """
        return pulumi.get(self, "notify_advance_in_minutes")
    ...
    @notify_advance_in_minutes.setter
    def notify_advance_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "notify_advance_in_minutes", value)
...
class UserHandoffNotificationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            handoff_type: Optional[pulumi.Input[builtins.str]] = None,
            notify_advance_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserHandoffNotificationRule':
        """
    ...
    @property
    @pulumi.getter(name="handoffType")
    def handoff_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of handoff to notify the user about. Possible values are `oncall`, `offcall`, `both`.
        """
        return pulumi.get(self, "handoff_type")
    ...
    @property
    @pulumi.getter(name="notifyAdvanceInMinutes")
    def notify_advance_in_minutes(self) -> pulumi.Output[builtins.int]:
        """
        The number of minutes before the handoff that the user should be notified. Must be a positive integer greater than or equal to 0.
        """
        return pulumi.get(self, "notify_advance_in_minutes")
